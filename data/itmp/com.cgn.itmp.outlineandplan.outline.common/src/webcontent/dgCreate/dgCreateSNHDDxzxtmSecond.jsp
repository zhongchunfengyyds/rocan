...
<!--             <input class="nui-hidden" name="tdgglsnjhhddxedit.id"/> -->
 ...
 value="<b:write property='entity/crew'/>"
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly" value="<b:write property='entity/workorder'/>" name="delete_entity.workorder"/>
                    </td>
 					<td class="form_label"  align="center">
                       维护计划:
                    </td>
              ...
              <!-- C1-C60 -->
                <table id="circle"  style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
 					<tr>	
	                    ...
	                    <td id="c1i" colspan="1">
	                    	<input class="nui-textbox" name="tdgglsnjhhddxedit.c1"  value="<b:write property='entity/c1'/>" />
	                    </td>
	                    <td id="c2" class="form_label" align="center">
	                        C2:
	                    </td>
	                    <td id="c2i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c2"  value="<b:write property='entity/c2'/>" />
	                    </td>
	                    <td id="c3" class="form_label" align="center">
	                        C3:
	                    </td>
	                    <td id="c3i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c3"  value="<b:write property='entity/c3'/>" />
	                    </td>
                 	</tr>
                 	<tr>
	                    ...
	                    <td id="c4i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c4"  value="<b:write property='entity/c4'/>" />
	                    </td>
	                    <td id="c5" class="form_label" align="center">
	                        C5:
	                    </td>
	                    <td id="c5i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c5"  value="<b:write property='entity/c5'/>" />
	                    </td>
	                    <td id="c6" class="form_label" align="center">
                        C6:
	                    </td>
	                    <td id="c6i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c6"  value="<b:write property='entity/c6'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c7i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c7"  value="<b:write property='entity/c7'/>" />
	                    </td>
	                    <td id="c8" class="form_label" align="center">
                        C8:
	                    </td>
	                    <td id="c8i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c8"  value="<b:write property='entity/c8'/>" />
	                    </td>
	                    <td id="c9" class="form_label" align="center">
	                        C9:
	                    </td>
	                    <td id="c9i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c9"  value="<b:write property='entity/c9'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c10i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c10"  value="<b:write property='entity/c10'/>" />
	                    </td>
	                    <td id="c11" class="form_label" align="center">
	                        C11:
	                    </td>
	                    <td id="c11i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c11"  value="<b:write property='entity/c11'/>" />
	                    </td>
	                    <td id="c12" class="form_label" align="center">
                        C12:
	                    </td>
	                    <td id="c12i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c12"  value="<b:write property='entity/c12'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c13i" colspan="1">
	                       <input class="nui-textbox" name="tdgglsnjhhddxedit.c13"  value="<b:write property='entity/c13'/>" />
	                    </td>
	                    <td id="c14" class="form_label" align="center">
                        C14:
	                    </td>
	                    <td id="c14i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c14"  value="<b:write property='entity/c14'/>" />
	                    </td>
	                    <td id="c15" class="form_label" align="center">
	                        C15:
	                    </td>
	                    <td id="c15i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c15"  value="<b:write property='entity/c15'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c16i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c16"  value="<b:write property='entity/c16'/>" />
	                    </td>
	                    <td id="c17" class="form_label" align="center">
	                        C17:
	                    </td>
	                    <td id="c17i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c17"  value="<b:write property='entity/c17'/>" />
	                    </td>
	                	<td id="c18" class="form_label" align="center">
	                     C18:
	                    </td>
	                    <td id="c18i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c18"  value="<b:write property='entity/c18'/>" />
	                    </td>
                	</tr>
                	<tr>
                      ...
                      C19:
	                    ...
	                    <td id="c19i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c19"  value="<b:write property='entity/c19'/>" />
	                    </td>
	                    <td id="c20" class="form_label" align="center">
                       C20:
	                    </td>
	                    <td id="c20i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c20"  value="<b:write property='entity/c20'/>" />
	                    </td>
	                    <td id="c21" class="form_label" align="center">
	                       C21:
	                    </td>
	                    <td id="c21i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c21"  value="<b:write property='entity/c21'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c22i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c22"  value="<b:write property='entity/c22'/>" />
	                    </td>
	                    <td id="c23" class="form_label" align="center">
	                        C23:
	                    </td>
	                    <td id="c23i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c23"  value="<b:write property='entity/c23'/>" />
	                    </td>
	                    <td id="c24" class="form_label" align="center">
                        C24:
	                    </td>
	                    <td id="c24i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c24"  value="<b:write property='entity/c24'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c25i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c25"  value="<b:write property='entity/c25'/>" />
	                    </td>
	                    <td id="c26" class="form_label" align="center">
                        C26:
	                    </td>
	                    <td id="c26i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c26"  value="<b:write property='entity/c26'/>" />
	                    </td>
	                    <td id="c27" class="form_label" align="center">
	                        C27:
	                    </td>
	                    <td id="c27i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c27"  value="<b:write property='entity/c27'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c28i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c28"  value="<b:write property='entity/c28'/>" />
	                    </td>
	                    <td id="c29" class="form_label" align="center">
	                        C29:
	                    </td>
	                    <td id="c29i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c29"  value="<b:write property='entity/c29'/>" />
	                    </td>
	                    <td id="c30" class="form_label" align="center">
                        C30:
	                    </td>
	                    <td id="c30i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c30"  value="<b:write property='entity/c30'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c31i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c31"  value="<b:write property='entity/c31'/>" />
	                    </td>
	                    <td id="c32" class="form_label" align="center">
                        C32:
	                    </td>
	                    <td id="c32i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c32"  value="<b:write property='entity/c32'/>" />
	                    </td>
	                    <td id="c33" class="form_label" align="center">
	                        C33:
	                    </td>
	                    <td id="c33i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c33"  value="<b:write property='entity/c33'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c34i" colspan="1">
	                       <input class="nui-textbox" name="tdgglsnjhhddxedit.c34"  value="<b:write property='entity/c34'/>" />
	                    </td>
	                    <td id="c35" class="form_label" align="center">
	                        C35:
	                    </td>
	                    <td id="c35i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c35"  value="<b:write property='entity/c35'/>" />
	                    </td>
	                     <td id="c36" class="form_label" align="center">
                        C36:
	                    </td>
	                    <td id="c36i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c36"  value="<b:write property='entity/c36'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c37i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c37"  value="<b:write property='entity/c37'/>" />
	                    </td>
	                    <td id="c38" class="form_label" align="center">
                        C38:
	                    </td>
	                    <td id="c38i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c38"  value="<b:write property='entity/c38'/>" />
	                    </td>
	                    <td id="c39" class="form_label" align="center">
	                        C39:
	                    </td>
	                    <td id="c39i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c39"  value="<b:write property='entity/c39'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c40i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c40"  value="<b:write property='entity/c40'/>" />
	                    </td>
	                    <td id="c41" class="form_label" align="center">
	                        C41:
	                    </td>
	                    <td id="c41i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c41"  value="<b:write property='entity/c41'/>" />
	                    </td>
	                    <td id="c42" class="form_label" align="center">
                        C42:
	                    </td>
	                    <td id="c42i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c42"  value="<b:write property='entity/c42'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c43i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c43"  value="<b:write property='entity/c43'/>" />
	                    </td>
	                    <td id="c44" class="form_label" align="center">
                        C44:
	                    </td>
	                    <td id="c44i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c44"  value="<b:write property='entity/c44'/>" />
	                    </td>
	                    <td id="c45" class="form_label" align="center">
	                        C45:
	                    </td>
	                    <td id="c45i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c45"  value="<b:write property='entity/c45'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c46i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c46"  value="<b:write property='entity/c46'/>" />
	                    </td>
	                    <td id="c47" class="form_label" align="center">
	                        C47:
	                    </td>
	                    <td id="c47i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c47"  value="<b:write property='entity/c47'/>" />
	                    </td>
	                    <td id="c48" class="form_label" align="center">
                        C48:
	                    </td>
	                    <td id="c48i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c48"  value="<b:write property='entity/c48'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c49i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c49"  value="<b:write property='entity/c49'/>" />
	                    </td>
	                    <td id="c50" class="form_label" align="center">
                        C50:
	                    </td>
	                    <td id="c50i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c50"  value="<b:write property='entity/c50'/>" />
	                    </td>
	                    <td id="c51" class="form_label" align="center">
	                        C51:
	                    </td>
	                    <td id="c51i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c51"  value="<b:write property='entity/c51'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c52i" colspan="1">
	                       <input class="nui-textbox" name="tdgglsnjhhddxedit.c52"  value="<b:write property='entity/c52'/>" />
	                    </td>
	                    <td id="c53" class="form_label" align="center">
	                        C53:
	                    </td>
	                    <td id="c53i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c53"  value="<b:write property='entity/c53'/>" />
	                    </td>
	                    <td id="c54" class="form_label" align="center">
                        C54:
	                    </td>
	                    <td id="c54i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c54"  value="<b:write property='entity/c54'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c55i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c55"  value="<b:write property='entity/c55'/>" />
	                    </td>
	                    <td id="c56" class="form_label" align="center">
                        C56:
	                    </td>
	                    <td id="c56i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c56"  value="<b:write property='entity/c56'/>" />
	                    </td>
	                    <td id="c57" class="form_label" align="center">
	                        C57:
	                    </td>
	                    <td id="c57i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c57"  value="<b:write property='entity/c57'/>" />
	                    </td>
                	</tr>
                	<tr>
	                    ...
	                    <td id="c58i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c58"  value="<b:write property='entity/c58'/>" />
	                    </td>
	                    <td id="c59" class="form_label" align="center">
	                        C59:
	                    </td>
	                    <td id="c59i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c59"  value="<b:write property='entity/c59'/>" />
	                    </td>
	                    <td id="c60" class="form_label" align="center">
                        C60:
	                    </td>
	                    <td id="c60i" colspan="1">
	                        <input class="nui-textbox" name="tdgglsnjhhddxedit.c60"  value="<b:write property='entity/c60'/>" />
	                    </td>
                	</tr>
                 </table>
        ...
        <script type="text/javascript">
            ...
            function onOk() {
	            ...
	            var jsondata = nui.encode({"processInstId":data.processInstId,"entityType":"com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit","workItemId":data.workItemId,"data":data.tdgglsnjhhddxedit,"spyj":data.spyj,"entity":"com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.OverhaulEntity","ident":"十年计划(核岛)_大修"});
