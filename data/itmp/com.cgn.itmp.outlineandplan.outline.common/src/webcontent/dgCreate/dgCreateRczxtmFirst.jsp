...
<div class="nui-hidden" name="entityType"  id="entityType"></div>
   <input class="nui-hidden" name="processInstId" value="<b:write property='processInstId'/>"/> 
            ...
            <!-- hidden域 -->
<!--             <input class="nui-hidden" name="delete_entity.id"/> -->
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                      ...
                      name="delete_entity.crew"  valueField="id"   url="com.cgn.itmp.basecommon.DictionaryOperation.getJzDicInfoByjdid.biz.ext?jdid=<b:write property='entity/base'/>"/>
                    </td>
                    <td class="form_label"  align="center">
                        项目类型:
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="1">
                    	<input id="btnEdit1" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'1');" name="delete_entity.referencefigureno"  value="<b:write property='entity/referencefigureno'/>"/>
                    </td>
                </tr>
            ...
            <table id="zytab" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="delete_entity.method"  value="<b:write property='entity/method'/>" />
                    </td>
                </tr>
                <tr>
                    <td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                    	<input id="btnEdit2" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'2');" name="delete_entity.program"  value="<b:write property='entity/program'/>"/>
                    </td>
                    <td class="form_label"  align="center">
                专用工具:
            		</td>
            		<td colspan="1">
            			<input id="btnEdit3" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'3');" name="delete_entity.tool"  value="<b:write property='entity/tool'/>"/>
	            	</td>
	                <td class="form_label"  align="center">
		                专用检查计划:
		            </td>
