...
- Description:
    ...
    <body style="width:98%;height:95%;">
            ...
            <div id="form1" class="nui-form" align="center" style="height:100%">
                ...
                <table id="table1" class="table" style="height:100%">
                    <tr>
                        ...
                        <td colspan="3">
                            <input id='baseid' style="display: none" class="nui-textbox" name="criteria/_expr[1]/jd"/>
                            <input class="nui-hidden" name="criteria/_expr[1]/_op" value="like">
                            <input id='crewid' style="display: none" class="nui-textbox" name="criteria/_expr[2]/jz"/>
        ...
        <div class="nui-panel" title="数据列表" style="width:100%;height:83%;" showToolbar="false" showFooter="false" >
            <div class="nui-fit">
                <div 
                        id="datagrid1"
