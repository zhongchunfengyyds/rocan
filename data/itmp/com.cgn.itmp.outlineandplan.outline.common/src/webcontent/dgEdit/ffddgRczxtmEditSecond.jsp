    ...
    <body>
        ...
        <div id="overhauldataform" style="padding-top:5px;">
         ...
         <input id="mapnoid" class="nui-hidden" name="preData.mapnoid" value="<b:write property='oldEntity/mapnoid'/>" />
          <input id="idcopy" class="nui-hidden" name="nextData.proccessInstId" value="<b:write property='entity/proccessInstId'/>" />
      ...
      //驳回
		...
		function onSubmit(){
	            ...
	            jsonData.modelName = '规范非法定总纲_日常';
	            jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.outline.common.NonStaturory.NonStaturoryEdit';
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity";
