    ...
    <body>
             ...
             <!-- 人员及原因信息 -->
              ...
              <tr>
              	...
              	<tr>
                    ...
                    <td colspan="5">
                        <input id="xgyy" value="<%=editdataParms.get("xgyy")==null?"":editdataParms.get("xgyy") %>" name="nextData.xgyy"  requiredErrorText="请输入修改原因" class="nui-textarea" style="width: 100%;"/>
                    </td>
                </tr>
                 <tr id="spyjId">
                    <td class="form_label"  align="center">
      ...
      //驳回
		...
		function onSubmit(){
	            ...
	            jsonData.modelName = '规范法定大纲_大修';
	            jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulEdit';
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulEntity";
