...
<%--             <input id="id" class="nui-hidden" name="preData.id" value="<b:write property='dataParms/id'/>" /> --%>
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<tr>
                    ...
                    <td>
                         <input id="protype" readonly="readonly" value="<%=dataParms.get("protype")==null?"":dataParms.get("protype") %>" class="nui-textbox"   name="preData.protype"/>
                    </td>
                    <td>
                    </td>
         			<td class="form_label"  align="center">
         		...
         		<tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" value="<%=editdataParms.get("period")==null?"":editdataParms.get("period") %>" name="nextData.period"/>
                    </td>
                    <td class="form_label"  align="center">
                        设备编号/功能位置:
                    </td>
                    <td colspan="1">
                        <input id="equipmentno" value="<%=dataParms.get("equipmentno")==null?"":dataParms.get("equipmentno") %>" class="nui-textbox" name="preData.equipmentno"/>
                    </td>
                    
                    <td colspan="1">
                        <input value="<%=editdataParms.get("equipmentno")==null?"":editdataParms.get("equipmentno") %>" class="nui-textbox" name="nextData.equipmentno"/>
                    </td>
				...
				<tr>
                    ...
                    <td colspan="1">
                        <input id="inspectplan" dictTypeId="option" class="nui-dictcombobox" value="<%=dataParms.get("inspectplan")==null?"":dataParms.get("inspectplan") %>" class="nui-textbox" name="preData.inspectplan"/>
                    </td>
                     <td colspan="1">
                        <input dictTypeId="option" class="nui-dictcombobox" value="<%=editdataParms.get("inspectplan")==null?"":editdataParms.get("inspectplan") %>" name="nextData.inspectplan"/>
                    </td>
                    </tr>
        ...
        <script type="text/javascript">
	      ...
	      $('#ccryId').hide();
            ...
            function setHiddenField(){
	            ...
	            nui.get('spyj').setReadOnly(false); 
			     nui.get('spyj').addCls(false);         
      ...
      //驳回
		...
		function onSubmit(){
	            ...
	            jsonData.modelName = '十年计划(常规岛及BOP)_大修';
	            jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.tenyearplan.ConventionalIslandOverhaulEdit.OverhaulEdit';
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.ConventionalIslandOverhaul.OverhaulEntity";
