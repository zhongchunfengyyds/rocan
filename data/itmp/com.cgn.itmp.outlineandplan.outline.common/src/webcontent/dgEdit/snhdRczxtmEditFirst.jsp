...
<%--             <input id="id" class="nui-hidden" name="preData.id" value="<b:write property='dataParms/id'/>" /> --%>
         ...
         <input id="idcopy" class="nui-hidden" name="nextData.relid" value="<b:write property='entity/relid'/>" />
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<tr>
                    ...
                    <td>
                         <input id="protype" readonly="readonly" value="<%=dataParms.get("protype")==null?"":dataParms.get("protype") %>" class="nui-dictcombobox"  dictTypeId="protype"  name="preData.protype"/>
                    </td>
                    <td>
                    </td>
         			<td class="form_label"  align="center">
                    ...
                    <td>
                        <input id="parts" value="<%=dataParms.get("parts")==null?"":dataParms.get("parts") %>" class="nui-textbox" name="preData.parts"/>
                    </td>
                    <td>
                    </td>
         		</tr>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input value="<%=editdataParms.get("itemno")==null?"":editdataParms.get("itemno") %>" class="nui-textbox" name="nextData.itemno"/>
                    </td>
                    <td class="form_label"  align="center">
                        任务清单:
                    </td>
                    <td colspan="1">
                        <input id="mintenanceproject" value="<%=dataParms.get("mintenanceproject")==null?"":dataParms.get("mintenanceproject") %>" class="nui-textbox" name="preData.mintenanceproject"/>
                    </td>
                    <td colspan="1">
                        <input id="mintenanceproject" value="<%=editdataParms.get("mintenanceproject")==null?"":editdataParms.get("mintenanceproject") %>" class="nui-textbox" name="nextData.mintenanceproject"/>
                    </td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="workorder" value="<%=dataParms.get("workorder")==null?"":dataParms.get("workorder") %>" class="nui-textbox" name="preData.workorder"/>
                    </td>
                    <td colspan="1">
                        <input value="<%=editdataParms.get("workorder")==null?"":editdataParms.get("workorder") %>" class="nui-textbox" name="nextData.workorder"/>
                    </td>
                    <td class="form_label"  align="center">
                        维护计划:
                    </td>
                    <td colspan="1" name="preData.mintenanceplan">
                        <input id="mintenanceplan" value="<%=dataParms.get("mintenanceplan")==null?"":dataParms.get("mintenanceplan") %>" class="nui-textbox" name="preData.mintenanceplan"/>
                    </td>   
                    <td colspan="1">
                        <input value="<%=editdataParms.get("mintenanceplan")==null?"":editdataParms.get("mintenanceplan") %>" class="nui-textbox" name="nextData.mintenanceplan"/>
                    </td> 
         		</tr>
         		...
         		<tr>
                    ...
                    <td colspan="1">
                        <input id="period" value="<%=dataParms.get("period")==null?"":dataParms.get("period") %>" class="nui-textbox" name="preData.period"/>
                    </td>
                    <td colspan="1">
                        <input id="period" value="<%=editdataParms.get("period")==null?"":editdataParms.get("period") %>" class="nui-textbox" name="nextData.period"/>
                    </td>
         		</tr>
         		...
         		<tr>
                    ...
                    <td colspan="1" name="preData.site">
                        <input id="site" value="<%=dataParms.get("site")==null?"":dataParms.get("site") %>" class="nui-textbox" name="preData.site"/>
                    </td>   
                    <td colspan="1">
                        <input class="nui-textbox" value="<%=editdataParms.get("site")==null?"":editdataParms.get("site") %>" name="nextData.site"/>
                    </td> 
                    <td class="form_label"  align="center">
                    </td>
                    <td colspan="1">
         		...
         		<tr>
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" value="<%=editdataParms.get("inspectionscope")==null?"":editdataParms.get("inspectionscope") %>" style="width: 100%" name="nextData.inspectionscope"/>
                    </td>
         		</tr>
             ...
             <!-- 人员及原因信息 -->
              ...
              <tr>
              	...
              	<tr>
                    ...
                    <td colspan="5">
                        <input id="reason" value="<%=editdataParms.get("xgyy")==null?"":editdataParms.get("xgyy") %>"  required="true" requiredErrorText="请输入修改原因" class="nui-textarea" style="width: 100%;"/>
                    </td>
                </tr>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		...
		function onSubmit(){
	            ...
	            var jsonData = {};
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit";
		        ...
		        function(action){
		           if(action=="ok"){
		        	 nui.get("#btnSubmit").setEnabled(false);
					    ...
					    json.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit";
