...
<%--
- Author(s): wangyx
- Date: 2019-11-12 14:40:43
- Description:
    --%>
    <head>
        <title>
            TInInternaldocuments查询 内部文件
        </title>
				...
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center"
						...
						<input class="nui-hidden" name="criteria/_entity"
							value="com.cgn.itmp.knowledgebase.Regulation.TInInternaldocuments">
						<!-- 排序字段 -->
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[1]/filenumber"/>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[2]/papersname"/>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[3]/professionalfield"/>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[4]/centralizeddepartment"/>
	...
	<div style="width: 100%; height: 95%;border-top:0px solid #0084d2 ;" showToolbar="false"
		...
		<div class="nui-toolbar" style="border-bottom: 0; padding: 5px 0px;">
            ...
            <div class="nui-fit">
                <div 
                        id="datagrid1"
                        dataField="tininternaldocumentss"
                        class="nui-datagrid"
                        style="width:100%;height:100%;"
                        url="com.cgn.itmp.knowledgebase.tininternaldocumentsbiz.queryTInInternaldocumentss.biz.ext"
                    ...
                    <div property="columns">
                        ...
                        <div field="filenumber" headerAlign="center" allowSort="true" >
                            文件号
                        </div>
                        <div field="papersname" headerAlign="center" allowSort="true" renderer="renderPapersname">
                            文件名称
                        </div>
                        <div field="professionalfield" headerAlign="center" allowSort="true" >
                            专业领域
                        </div>
                        <div field="centralizeddepartment" headerAlign="center" allowSort="true" >
                            归口部门
                        </div>
        ...
        <script type="text/javascript">
			...
			function show(uid){
				...
				nui.open({
					showMaxButton : true,
                    url: "/itmp/knowledgebase/knowledgebase/internaldocuments/TInInternaldocumentsForm.jsp",
                    title: "查看记录", width: 600, height: 230,
                    onload: function () {//弹出页面加载完成
                    var iframe = this.getIFrameEl();
                    var data = {pageType:"show",record:{tininternaldocuments:record}};
            ...
            function add() {
                nui.open({
                	showMaxButton : true,
                    url: "/itmp/knowledgebase/knowledgebase/internaldocuments/TInInternaldocumentsForm.jsp",
                    title: "新增记录", width: 600, height: 230,
                    onload: function () {//弹出页面加载完成
                    var iframe = this.getIFrameEl();
            ...
            function edit() {
                ...
                if (row) {
                    ...
                    showMaxButton : true,
                        ...
                        onload: function () {
                            var iframe = this.getIFrameEl();
                            var data = {pageType:"edit",record:{tininternaldocuments:row}};
                            //直接从页面获取，不用去后台获取
                            iframe.contentWindow.setFormData(data);
                            },
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({
											data : rows,
											entity : "com.cgn.itmp.knowledgebase.Regulation.TInInternaldocuments",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
										});
 									...
 									function batchAdd(){
										 ...
										 showMaxButton : true,
							                    ...
							                    onload: function () {//弹出页面加载完成
								                    ...
								                    var data = {
								                    	pageType:"knowledge",
								                    	tempFileName:"internaldocuments.xlsx",
								                    	tempLoadName :"内部文件新增模板",
								                    	entitfName:"com.cgn.itmp.knowledgebase.Regulation.TInInternaldocuments"
								                    };//传入页面的json数据
...
function output() {
	...
	nui.open({
				...
				onload : function() {//弹出页面加载完成
					var iframe = this.getIFrameEl();
					var data = {
						entityName : "com.cgn.itmp.knowledgebase.Regulation.TInInternaldocuments",
						queryParam : json, //查询数据
						queryKey : 'criteria', //查询实体名
						query : [ 'filenumber', 'papersname', 'professionalfield','centralizeddepartment','isdel','jd'], //按顺序放置
						...
						mode:"ftp",
						defaultCheck : ['filenumber', 'papersname', 'professionalfield','centralizeddepartment','edition']
					};//传入页面的json数据
					iframe.contentWindow.setFormData(data);
				},
				ondestroy : function(action) {//弹出页面关闭前
								...
								.open({
								   showMaxButton : true,
									...
									onload : function() {//弹出页面加载完成
										...
										var data = {
											pageType : "recyclebin",
											urlName : "com.cgn.itmp.knowledgebase.tininternaldocumentsbiz.queryTInInternaldocumentss.biz.ext",//回收
											entityVal : "com.cgn.itmp.knowledgebase.Regulation.TInInternaldocuments",
	 ...
	 elemIF.style.display = "none";
							...
							function btnQuery() {
								...
								if (gjz == "") {
									...
									var data = {
										matchFied : "isdel,filenumber,papersname,professionalfield,centralizeddepartment",
										dicFied : "filenumber@FILENUMBER,papersname@PAPERSNAME,professionalfield@PROFESSIONALFIELD,centralizeddepartment@CENTRALIZEDDEPARTMENT",
										wordVal : $("#cond").val(),
