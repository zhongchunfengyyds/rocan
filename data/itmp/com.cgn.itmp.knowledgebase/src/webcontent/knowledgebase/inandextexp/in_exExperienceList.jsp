...
<body style="background-color:#f1f1f1;width: 98%; height: 97%;">
				...
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center"
						...
						<input class="nui-hidden" name="criteria/_entity"
							value="com.cgn.itmp.knowledgebase.knowledgebase.in_exExperience">
						<!-- 排序字段 -->
						...
						<table id="table1" class="table" style="height: 100%">
							<tr>
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[3]/filesource" /> <input
							...
							<tr>
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[4]/enclosure" /> <input
							...
							<tr>
								...
								<td colspan="3"><input class="nui-textbox"
									name="criteria/_expr[5]/remarks" /> <input class="nui-hidden"
							...
							<tr style="display: none">
								<td>
									<input class="nui-textbox" name="criteria/_expr[6]/isdel" value="0" />
									<input class="nui-hidden" name="criteria/_expr[6]/_op" value="=">
									<input class="nui-textbox" id="jd" name="criteria/_expr[7]/jd" value="" />
									<input class="nui-hidden" name="criteria/_expr[7]/_op" value="=">
									<input class="nui-textbox" id="funname" name="criteria/_expr[8]/funname" value="" />
									<input class="nui-hidden" name="criteria/_expr[8]/_op" value="=">
									<input class="nui-textbox" id="filesource" name="criteria/_expr[9]/filesource" value="" />
	...
	<div style="width: 100%;" showToolbar="false"
		showFooter="false">
			...
			<table style="width: 100%;">
				<tr>
					<td style="width: 100%;">
						...
						<button class="btn btn-default" type="button" id="doUpload" onclick="doUpload()" id="doUpload">
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="in_exexperiences" class="nui-datagrid"
				style="width: 100%; height: 100%;"
				url="com.cgn.itmp.knowledgebase.in_exexperiencebiz.queryin_exExperiences.biz.ext"
...
<!-- 					<div field="base" headerAlign="center" allowSort="true">基地</div> -->
					<div field="filesource" headerAlign="center" allowSort="true">
						文件来源</div>
					<div field="filename" headerAlign="center" allowSort="true" renderer="renderFileName">
						文件名称</div>
					<div field="summary_note" headerAlign="center" allowSort="true">
						摘要/说明</div>
					...
					<div field="remarks" headerAlign="center" allowSort="true">
						备注</div>
					<div field="funname" headerAlign="center" visible="false" allowSort="true">
						功能名称</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		if(pageflow == '国际国内会议材料'){
			pageflow = '来访出访资料 ';
		}
		formData["criteria/_expr[8]/funname"] = pageflow;
		grid.load(formData);
		
		nui.get("funname").setValue(pageflow);
		nui.get("filesource").setValue(pageflow);
		
		 //按钮权限控制
	    accessControlButton('<%=userRoleCodeList %>',9);
		...
		function renderFileName(e){
			return '<a style="cursor: pointer" onclick=show("'+e.record._uid+'")>'+e.record.filename+'</a>';
		}
		...
		function show(uid){
				...
				nui.open({
					showMaxButton : true,
                    url : "/itmp/knowledgebase/knowledgebase/inandextexp/in_exExperienceForm.jsp",
                    title: "查看记录", width: 600, height: 275,
						...
						.confirm(
								...
								function(action) {
									if (action == "ok") {
									 var json = nui.encode({
												data : rows,
												entity : "com.cgn.itmp.knowledgebase.knowledgebase.in_exExperience",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
											});
...
function output() {
	...
	nui.open({
				...
				onload : function() {//弹出页面加载完成
					var iframe = this.getIFrameEl();
					var data = {
						entityName : "com.cgn.itmp.knowledgebase.knowledgebase.in_exExperience",
						queryParam : json, //查询数据
						queryKey : 'criteria', //查询实体名
						query : [ 'filename','summary_note','filecode','enclosure','remarks','isdel', 'jd','funname','filesource'], //按顺序放置
						filterField : ['uuid', 'isdel','fj', 'jd', 'inserttime','orderno','fileid','fildid','filepath','funname','createtime','addtime','processInstId','processStatus','deletetime','deleteperson'],
						expTitle : pageflow,
						dicFieds : "",
						jdFieds : "jd",
						...
						mode:"ftp",
						defaultCheck : ['filesource', 'filename','filecode' ,'summary_note','remarks']
					};//传入页面的json数据
					iframe.contentWindow.setFormData(data);
				},
				ondestroy : function(action) {//弹出页面关闭前
			...
			nui
					...
					showMaxButton : true,
						...
						onload : function() {//弹出页面加载完成
							...
							var data = {
								pageType : "recyclebin",
								urlName : "com.cgn.itmp.knowledgebase.in_exexperiencebiz.queryin_exExperiences.biz.ext",//回收
								entityVal : "com.cgn.itmp.knowledgebase.knowledgebase.in_exExperience",
								...
								pageflowName: pageflow,//通用页面添加标识
								columnscode : [ {
									type : "indexcolumn"
								}, {
									type : "checkcolumn"
		...
		function btnQuery() {
			...
			if (gjz == "") {
				...
				var data = {
					matchFied : "filename,summary_note,filecode,enclosure,remarks,isdel",
			...
			nui
					.open({
						...
						onload : function() {//弹出页面加载完成
							...
							var data = {
								pageType : "knowledge",
								tempFileName : "in_exExperienceList.xlsx",
								tempLoadName : "知识库内外部经验",
								entitfName : "com.cgn.itmp.knowledgebase.knowledgebase.in_exExperience"
							};//传入页面的json数据
