				...
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center"
						...
						<input class="nui-hidden" name="criteria/_entity"
							value="com.cgn.itmp.knowledgebase.Regulation.TInSpecification">
						<!-- 排序字段 -->
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[2]/edition"/>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[3]/chapternumandname"/>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[4]/clausenumandname"/>
	...
	<div style="width: 100%; height: 95%;border-top:0px solid #0084d2 ;" showToolbar="false"
		...
		<div class="nui-toolbar" style="border-bottom: 0; padding: 5px 0px;">
            ...
            <div class="nui-fit">
                <div 
                        id="datagrid1"
                        dataField="tinspecifications"
                        class="nui-datagrid"
                        style="width:100%;height:100%;"
                        url="com.cgn.itmp.knowledgebase.tinspecificationbiz.queryTInSpecifications.biz.ext"
                    ...
                    <div property="columns">
                        ...
                        <div field="chapternumandname" headerAlign="center" allowSort="true" >
                            章节编号和名称
                        </div>
                        <div field="clausenumandname" headerAlign="center" allowSort="true" >
                            条款编号和名称
                        </div>
                        <div field="relatedclauses" headerAlign="center" allowSort="true" >
                            关联条款
                        </div>
        ...
        <script type="text/javascript">
			...
			function show(uid){
				...
				nui.open({
					showMaxButton : true,
                    url: "/itmp/knowledgebase/knowledgebase/specification/TInSpecificationForm.jsp",
                    title: "查看记录", width: 600, height: 190,
                    onload: function () {//弹出页面加载完成
                    var iframe = this.getIFrameEl();
                    var data = {pageType:"show",record:{tinspecification:record}};
            ...
            function edit() {
                ...
                if (row) {
                    ...
                    showMaxButton : true,
                        ...
                        onload: function () {
                            var iframe = this.getIFrameEl();
                            var data = {pageType:"edit",record:{tinspecification:row}};
                            //直接从页面获取，不用去后台获取
                            iframe.contentWindow.setFormData(data);
                            },
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({
												data : rows,
												entity : "com.cgn.itmp.knowledgebase.Regulation.TInSpecification",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
											});
...
function output() {
	...
	nui.open({
				...
				onload : function() {//弹出页面加载完成
					var iframe = this.getIFrameEl();
					var data = {
						entityName : "com.cgn.itmp.knowledgebase.Regulation.TInSpecification",
						queryParam : json, //查询数据
						queryKey : 'criteria', //查询实体名
						query : [ 'name', 'edition', 'chapternumandname','clausenumandname','isdel','jd'], //按顺序放置
						filterField : [ 'uuid', 'isdel', 'jd','adduser' ,'fileid','createtime','addtime','processInstId','processStatus','deletetime','deleteperson'],
						expTitle : "规范",
						dicFieds : "",
						jdFieds : "jd",
						order : "addtime@desc",
						...
						mode:"ftp",
						defaultCheck : ['name','edition', 'chapternumandname', 'clausenumandname','relatedclauses']
					};//传入页面的json数据
					iframe.contentWindow.setFormData(data);
				},
				ondestroy : function(action) {//弹出页面关闭前
                                ...
                                function batchAdd(){
										 ...
										 showMaxButton : true,
							                    ...
							                    onload: function () {//弹出页面加载完成
								                    ...
								                    var data = {
								                    	pageType:"knowledge",
								                    	tempFileName:"specification.xlsx",
								                    	tempLoadName :"规范新增模板",
								                    	entitfName:"com.cgn.itmp.knowledgebase.Regulation.TInSpecification"
								                    };//传入页面的json数据
								...
								.open({
								   showMaxButton : true,
									...
									onload : function() {//弹出页面加载完成
										...
										var data = {
											pageType : "recyclebin",
											urlName : "com.cgn.itmp.knowledgebase.tinspecificationbiz.queryTInSpecifications.biz.ext",//回收
											entityVal : "com.cgn.itmp.knowledgebase.Regulation.TInSpecification",
											...
											columnscode : [{
												...
												field : 'chapternumandname',
												header : '章节编号和名称',
												width : 100,
												headerAlign : "center",
												allowSort : true
											}, {
												field : "clausenumandname",
												header : '条款编号和名称',
												width : 100,
												headerAlign : "center",
												allowSort : true
											},{
												field : 'relatedclauses',
												header : '关联条款',
												width : 100,
												headerAlign : "center",
												allowSort : true
								...
								function selectionChanged() {
								   ...
								   showMaxButton : true,
				                    ...
				                    onload: function () {//弹出页面加载完成
				                    	var iframe = this.getIFrameEl();
					                    var data = {//CHAPTERNUMANDNAME 
					                    	page:"CHAPTERNUMANDNAME",
								...
								if (gjz == "") {
									...
									var data = {
										matchFied : "isdel,name,edition,chapternumandname,clausenumandname",
										dicFied : "name@NAME,edition@EDITION,chapternumandname@CHAPTERNUMANDNAME,clausenumandname@CLAUSENUMANDNAME",
										wordVal : $("#cond").val(),
