 ...
 * $log$
 */
public class TInStatuteService extends DASDaoSupport implements
		ITInStatuteService {

	/**
	 * 
	 */
	public TInStatuteService() {
		// TODO 自动生成的构造函数存根
	}
	...
	public void addOrEdit(DataObject data) {
		...
		DataObject temp  = DataObjectUtil.convertDataObject(data, "com.cgn.itmp.knowledgebase.Regulation.TInStatute", false);																		
