 ...
 * $log$
 */
public class TInSpercificationService extends DASDaoSupport implements
		ITInSpecificationService {

	/**
	 * 
	 */
	public TInSpercificationService() {
		// TODO 自动生成的构造函数存根
	}
	...
	public void addOrEdit(DataObject data) {
		...
		DataObject temp  = DataObjectUtil.convertDataObject(data, "com.cgn.itmp.knowledgebase.Regulation.TInSpecification", false);																		
