...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entity" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit"/>
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.Currency"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.DailyCurrencyAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(常规岛及BOP)_日常执行条目_新增通用"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(常规岛及BOP)_日常执行条目_新增通用"/>
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" value="RCTY" dictTypeId="CGDRC"
                       name="data.type"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" required="true" id="checkprojectname" readonly="readonly" requiredErrorText="请输入检查项目名称"
            ...
            <td colspan="1">
                <input class="nui-textbox"required="true" requiredErrorText="请输入维护项目" name="data.rwqd"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="data.lct"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="data.jcbw"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)" style="width: 100%" name="data.bz"/>
            </td>
        </tr>
    </table>
  <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
   ...
   <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,true,true)" required="true" requiredErrorText="请输入新增原因" style="width: 100%"
                       name="data.reason"/>
            </td>
        </tr>
    </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
		...
		if(isadmin == 'true'){
			data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.Currency';
		}
