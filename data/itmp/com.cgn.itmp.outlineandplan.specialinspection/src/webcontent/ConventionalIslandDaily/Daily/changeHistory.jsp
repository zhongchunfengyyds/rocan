  ...
  <body style="width:98%;height:95%;margin:0 auto;">
        <div class="nui-panel" title="查询"  style="width:100%;height: 25%;" showToolbar="false" showFooter="true">
            <div id="form1" class="nui-form" align="center" style="height:100%">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.outlineandplan.outline.common.curriculumVitae.zyjccgdrc">
                <!-- 排序字段 -->
    ...
    <div class="nui-fit">
        <div
            ...
            <div property="columns">
                ...
                <div field="content" headerAlign="center" id="xgnr" renderer="xgnr" allowSort="true">
                    修改内容
                </div>
...
<script type="text/javascript">
    ...
    function view() {
        ...
        var urlStr = '';
        var entity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit";
        if ((row.type == '新增' || row.type == '修改') && row.content.indexOf("通用") != -1) {
    		...
    		var modelFlag = "";
    		if(row.content.indexOf('通用') != -1){modelFlag = "25";}
    		if(row.content.indexOf('压力管道') != -1){modelFlag = "26";}
    		urlStr = "com.cgn.itmp.basecommon.planComplateFlow.flow?flag=1&processInstId="+processInstId+"&showPage="+showPage+"&planFlag=1&modelFlag="+modelFlag+"&transferEntity=com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit";
    		if (row) {
        		 nui.open({
        		 	showMaxButton : true,
			        url: urlStr,
    		...
    		if(row.content.indexOf('通用') != -1){modelFlag = "25";}
    		if(row.content.indexOf('压力管道') != -1){modelFlag = "26";}
    		urlStr = "com.cgn.itmp.basecommon.planComplateFlow.flow?flag=1&processInstId="+processInstId+"&showPage="+showPage+"&planFlag=2&modelFlag="+modelFlag+"&transferEntity=com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit";
    		if (row) {
        		 nui.open({
        		 	showMaxButton : true,
			        url: urlStr,
    ...
    function output() {
        ...
        nui.open({
            ...
            onload: function () {//弹出页面加载完成
                var iframe = this.getIFrameEl();
                var data = {
                    entityName: "com.cgn.itmp.outlineandplan.outline.common.curriculumVitae.zyjccgdrc",
                    queryParam: json,								    //查询数据
                    queryKey: 'criteria',                              //查询实体名
                    expTitle: "专用检查计划常规岛日常变更履历",
