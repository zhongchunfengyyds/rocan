...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox"  readonly="readonly" value="<b:write property='entity/jd'/>"
                       ...
                       name="delete_entity.jd" valueField="id"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-combobox"  readonly="readonly" dataField="jsonObject" value="<b:write property='entity/jz'/>" id="jz"
                       textField="name"
                       url="" name="delete_entity.jz" valueField="id"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox"  readonly="readonly" id="type" value="RCGD" dictTypeId="CGDRC" value="<b:write property='entity/type'/>" name="delete_entity.type"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input id="xt" class="nui-dictcombobox"  readonly="readonly" required="true" dictTypeId="protype" value="<b:write property='entity/xt'/>" name="delete_entity.xt"/>
            </td>
            <td class="form_label" align="center">
                检查项目名称:
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function doWriteBackRealData() {
        ...
        var json = "{sourceEntity:'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit'," +
            "targetEntity:'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.PressurePipe'," +
