...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" value="<%=dataParms.get("tasklist")==null?"":dataParms.get("tasklist") %>"
                       id="tasklist" readonly="readonly" name="preData.tasklist"/>
            </td>
            <td colspan="1">
...
<script type="text/javascript">
    ...
    function onSubmit() {
        ...
        jsonData.modelName = '专用检查计划(核岛)_大修';
        jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaulEdit.NuclearIslandEdit';
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaul.Valve";
