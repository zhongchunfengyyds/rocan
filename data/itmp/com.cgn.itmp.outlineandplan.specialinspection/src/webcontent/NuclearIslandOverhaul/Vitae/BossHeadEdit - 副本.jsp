...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" id="type" value="HFBOSS"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="type" readonly="readonly"
                       value="<%=dataParms.get("systemdevice")==null?"":dataParms.get("systemdevice") %>"
                       name="preData.systemdevice"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("systemdevice")==null?"":editdataParms.get("systemdevice") %>"
