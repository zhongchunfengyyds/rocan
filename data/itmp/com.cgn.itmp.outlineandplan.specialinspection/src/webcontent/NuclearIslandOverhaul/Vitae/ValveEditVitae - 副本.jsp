...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="system"
                       value="<%=dataParms.get("system")==null?"":dataParms.get("system") %>" readonly="readonly"
                       name="preData.system"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("system")==null?"":editdataParms.get("system") %>"
                       name="nextData.system"/>
            </td>
            <td class="form_label" align="center">
                设备/部件:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gnwz" value="<%=dataParms.get("gnwz")==null?"":dataParms.get("gnwz") %>"
                       name="preData.gnwz"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gxnumber"
                       value="<%=dataParms.get("gxnumber")==null?"":dataParms.get("gxnumber") %>" readonly="readonly"
            ...
            <td colspan="1">
                <input class="nui-textbox" id="roomnumber"
                       value="<%=dataParms.get("roomnumber")==null?"":dataParms.get("roomnumber") %>"
                       readonly="readonly" name="preData.roomnumber"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" readonly="readonly" id="ckt_dzhnumber"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" value="<%=dataParms.get("jcmethod")==null?"":dataParms.get("jcmethod") %>"
                       id="jcmethod" readonly="readonly" name="preData.jcmethod"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gfcycle" readonly="readonly"
                       value="<%=dataParms.get("gfcycle")==null?"":dataParms.get("gfcycle") %>" name="preData.gfcycle"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("gfcycle")==null?"":editdataParms.get("gfcycle") %>"
                       name="nextData.gfcycle"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="zxunit" readonly="readonly"
                       value="<%=dataParms.get("zxunit")==null?"":dataParms.get("zxunit") %>" name="preData.zxunit"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("zxunit")==null?"":editdataParms.get("zxunit") %>"
                       name="nextData.zxunit"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
<!--          <td colspan="5"> -->
<!--                         <input class="nui-combobox" dataField="resultList.EmployeeSource"  onvaluechanged="onchangePerson"id="jhry"  name="jhry"  textField="empname" style="width:50%" url="com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY"  required="true" requiredErrorText="请选择校核人员"  valueField="empid"/> -->
<!--                     </td> -->
<!--         <td colspan="2"> -->
