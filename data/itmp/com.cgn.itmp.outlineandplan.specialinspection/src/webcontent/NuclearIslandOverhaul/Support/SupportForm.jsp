...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaul.Support"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.OverhaulZCZJAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(核岛部件)_大修执行条目_新增支撑支架"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(核岛部件)_大修执行条目_新增支撑支架"/>
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.bracenumber"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)" style="width: 100%" name="data.ckt_dzhnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" style="width: 100%" onvalidation="hasIllegalChar(e,4000,false,true)" name="data.remarks"/>
            </td>
        </tr>
    </table>
    ...
    <table id="circle" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td id="c1i" colspan="1">
                <div name="data.c1" id="combobox1i" class="nui-combobox" style="width:100px;" 
            ...
            <td id="c2i" colspan="1">
                <div name="data.c2" id="combobox2i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c3i" colspan="1">
                <div name="data.c3" id="combobox3i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c4i" colspan="1">
                <div name="data.c4" id="combobox4i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c5i" colspan="1">
                <div name="data.c5" id="combobox5i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c6i" colspan="1">
                <div name="data.c6" id="combobox6i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c7i" colspan="1">
                <div name="data.c7" id="combobox7i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c8i" colspan="1">
                <div name="data.c8" id="combobox8i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c9i" colspan="1">
                <div name="data.c9" id="combobox9i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c10i" colspan="1">
                <div name="data.c10" id="combobox10i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c11i" colspan="1">
                <div name="data.c11" id="combobox11i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c12i" colspan="1">
                <div name="data.c12" id="combobox12i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c13i" colspan="1">
                <div name="data.c13" id="combobox13i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c14i" colspan="1">
                <div name="data.c14" id="combobox14i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c15i" colspan="1">
                <div name="data.c15" id="combobox15i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c16i" colspan="1">
                <div name="data.c16" id="combobox16i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c17i" colspan="1">
                <div name="data.c17" id="combobox17i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c18i" colspan="1">
                <div name="data.c18" id="combobox18i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c19i" colspan="1">
                <div name="data.c19" id="combobox19i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c20i" colspan="1">
                <div name="data.c20" id="combobox20i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c21i" colspan="1">
                <div name="data.c21" id="combobox21i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c22i" colspan="1">
                <div name="data.c22" id="combobox22i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c23i" colspan="1">
                <div name="data.c23" id="combobox23i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c24i" colspan="1">
                <div name="data.c24" id="combobox24i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c25i" colspan="1">
                <div name="data.c25" id="combobox25i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c26i" colspan="1">
                <div name="data.c26" id="combobox26i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c27i" colspan="1">
                <div name="data.c27" id="combobox27i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c28i" colspan="1">
                <div name="data.c28" id="combobox28i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c29i" colspan="1">
                <div name="data.c29" id="combobox29i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c30i" colspan="1">
                <div name="data.c30" id="combobox30i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c31i" colspan="1">
                <div name="data.c31" id="combobox31i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c32i" colspan="1">
                <div name="data.c32" id="combobox32i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c33i" colspan="1">
                <div name="data.c33" id="combobox33i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c34i" colspan="1">
                <div name="data.c34" id="combobox34i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c35i" colspan="1">
                <div name="data.c35" id="combobox35i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c36i" colspan="1">
                <div name="data.c36" id="combobox36i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c37i" colspan="1">
                <div name="data.c37" id="combobox37i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c38i" colspan="1">
                <div name="data.c38" id="combobox38i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c39i" colspan="1">
                <div name="data.c39" id="combobox39i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c40i" colspan="1">
                <div name="data.c40" id="combobox40i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c41i" colspan="1">
                <div name="data.c41" id="combobox41i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c42i" colspan="1">
                <div name="data.c42" id="combobox42i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c43i" colspan="1">
                <div name="data.c43" id="combobox43i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c44i" colspan="1">
                <div name="data.c44" id="combobox44i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c45i" colspan="1">
                <div name="data.c45" id="combobox45i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c46i" colspan="1">
                <div name="data.c46" id="combobox46i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c47i" colspan="1">
                <div name="data.c47" id="combobox47i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c48i" colspan="1">
                <div name="data.c48" id="combobox48i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c49i" colspan="1">
                <div name="data.c49" id="combobox49i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c50i" colspan="1">
                <div name="data.c50" id="combobox50i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c51i" colspan="1">
                <div name="data.c51" id="combobox51i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c52i" colspan="1">
                <div name="data.c52" id="combobox52i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c53i" colspan="1">
                <div name="data.c53" id="combobox53i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c54i" colspan="1">
                <div name="data.c54" id="combobox54i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c55i" colspan="1">
                <div name="data.c55" id="combobox55i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c56i" colspan="1">
                <div name="data.c56" id="combobox56i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c57i" colspan="1">
                <div name="data.c57" id="combobox57i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c58i" colspan="1">
                <div name="data.c58" id="combobox58i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c59i" colspan="1">
                <div name="data.c59" id="combobox59i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c60i" colspan="1">
                <div name="data.c60" id="combobox60i" class="nui-combobox" style="width:100px;" 
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input id="reason" class="nui-textarea" onvalidation="hasIllegalChar(e,1000,true,true)" required="true" requiredErrorText="请输入新增原因" style="width: 100%"
                       name="data.reason"/>
            </td>
        </tr>
    </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
        ...
        //编辑
        if (pageType == "edit") {
            urlStr = "com.cgn.itmp.outlineandplan.specialinspection.tdggltzyjcjhhdzcbiz.updateTDgglTzyjcjhhdzc.biz.ext";
        }
        form.validate();
        ...
        if(isadmin == 'true'){
            data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaulEdit.SupportEdit';
        }
