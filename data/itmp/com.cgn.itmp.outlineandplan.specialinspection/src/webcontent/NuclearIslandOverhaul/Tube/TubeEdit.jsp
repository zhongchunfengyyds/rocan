...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox" url="com.cgn.itmp.basecommon.DictionaryOperation.getJdDicInfo.biz.ext"
                       textField="name" onvaluechanged="reloadJz" dataField="jsonObject" id="jd"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.sbnumber"/>
            </td>
            <td class="form_label" align="center">
                列:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="columnsint" readonly="readonly" name="preData.columnsint"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.columnsint"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="row" readonly="readonly" name="preData.row"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.row"/>
            </td>
            <td class="form_label" align="center">
                检查类型:
            </td>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" dictTypeId="JCLX" name="nextData.checktype"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="jccycle" readonly="readonly" name="preData.jccycle"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.jccycle"/>
            </td>
            <td class="form_label" align="center">
                备注:
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(核岛部件)_大修执行条目_修改传热管";
        data.processInstDesc = "专用检查计划(核岛部件)_大修执行条目_修改传热管";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.OverhaulCRGEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaulEdit.NuclearIslandEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaul.Tube";
