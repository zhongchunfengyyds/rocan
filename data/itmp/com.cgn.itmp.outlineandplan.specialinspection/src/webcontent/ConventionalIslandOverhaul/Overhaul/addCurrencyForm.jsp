...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entity" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.OverhaulEdit"/>
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.Currency"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.OverhaulCurrencyAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(常规岛及BOP)_大修执行条目_新增通用"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(常规岛及BOP)_大修执行条目_新增通用"/>
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox" readonly="readonly" dataField="jsonObject" id="jz" textField="name"
                       url="" name="data.jz" valueField="id"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" value="RCTY" dictTypeId="CGDRC" name="data.type"/>
            </td>
        </tr>
        <tr>
        	<td class="form_label" align="center">
            ...
            <td colspan="1">
            	<input id="protype" class="nui-dictcombobox"  readonly="readonly" required="true" dictTypeId="protype" name="data.xt"/>
            </td>
            <td class="form_label" align="center">
                检查项目名称:
            </td>
            <td colspan="1">
                <input class="nui-textbox" required="true" id="checkprojectname" readonly="readonly"
                       requiredErrorText="请输入检查项目名称"
                       name="data.checkprojectname"/>
            </td>
            <td class="form_label" align="center">
                维护项目:
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,true,true)"  required="true" requiredErrorText="请输入维护项目" name="data.rwqd"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"  onvalidation="hasIllegalChar(e,500,false,true)" name="data.gl"/>
            </td>
            <td class="form_label" align="center">
                管线号:
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.gxh"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.zysb"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.cz"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.gczj"/>
            </td>
            <td class="form_label" align="center">
                外径(mm):
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.wj"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.mybh"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.jk"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.ck"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)" style="width: 100%" name="data.lct"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,2000,false,true)" style="width: 100%" name="data.jcbw"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="data.bz"/>
            </td>
        </tr>
    </table>
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,100,true,true)" required="true" requiredErrorText="请输入新增原因" style="width: 100%"
                       name="data.reason"/>
            </td>
        </tr>
    </table>
...
<!--             <td colspan="5"> -->
<!--                 <input class="nui-combobox" dataField="resultList.EmployeeSource"  onvaluechanged="onchangePerson"id="jhry"  name="data.jhry"  textField="empname" style="width:100%" url=""  required="true" requiredErrorText="请选择校核人员"  valueField="empid"/> -->
<!--             </td> -->
 <td colspan="5">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
        ...
        if(isadmin == 'true'){
            data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.Currency';
        }
...
nui.get('userToken').setValue("<%=TokenUtil.getTokenString(request.getSession())%>");
		...
		nui.get('protype').setValue(json.data.xt);
