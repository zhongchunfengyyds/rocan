...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="zysb" value="<%=dataParms.get("utsl")==null?"":dataParms.get("utsl") %>"
                       readonly="readonly" name="preData.utsl"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox"  dictTypeId="FAC" value="<%=dataParms.get("fac")==null?"":dataParms.get("fac") %>"
                       readonly="readonly" name="preData.fac"/>
            </td>
            <td colspan="1">
                <input class="nui-dictcombobox"  dictTypeId="FAC" value="<%=editdataParms.get("fac")==null?"":editdataParms.get("fac") %>"
                       name="nextData.fac"/>
            </td>
            <td class="form_label" align="center">
                测厚部位:
            ...
            <td colspan="1">
                <input class="nui-textbox" id="jcbw" readonly="readonly"
...
<script type="text/javascript">
    ...
    function onSubmit() {
        ...
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.PressurePipe";
