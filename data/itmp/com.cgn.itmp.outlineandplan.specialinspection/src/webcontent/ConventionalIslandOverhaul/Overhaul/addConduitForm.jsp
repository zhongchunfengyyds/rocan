...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.PressurePipe"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.OverhaulConduitAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(常规岛及BOP)_大修执行条目_新增压力管道"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(常规岛及BOP)_大修执行条目_新增压力管道"/>
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" value="RCGD" dictTypeId="CGDRC" name="data.type"/>
            </td>
        </tr>
        <tr>
        	<td class="form_label" align="center">
...
<td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" dictTypeId="FAC"  name="data.fac"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,2000,false,true)" name="data.jcbw"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.jcsl"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.utbw"/>
            </td>
            <td class="form_label" align="center">
                UT数量:
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="data.utsl"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
        ...
        if(isadmin == 'true'){
            data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.PressurePipe';
        }
