...
<div id="dataform1" style="padding-top:5px;">
    <!-- hidden域 -->
    <input class="nui-hidden" name="tdggltzyjcjhty.<%=TokenUtil.TOKEN_STRING_NAME%>" id="userToken">
    <input class="nui-hidden" name="tdggltzyjcjhty.uuid"/>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox" dataField="jsonObject" id="jdid"
                       name="tdggltzyjcjhty.jd" onvaluechanged="reloadJz"
            ...
            <td colspan="1">
                <input class="nui-combobox" dataField="jsonObject" id="jzid" textField="name"
                       ...
                       name="tdggltzyjcjhty.jz" value="<%=dataParms.get("jz")==null?"":dataParms.get("jz") %>"
                       valueField="id"/>
            </td>
            <td>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="checkprojectname"
                       ...
                       readonly="readonly" name="tdggltzyjcjhty.checkprojectname"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="rwqd" value="<%=dataParms.get("rwqd")==null?"":dataParms.get("rwqd") %>"
                       readonly="readonly" name="tdggltzyjcjhty.rwqd"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gl" value="<%=dataParms.get("gl")==null?"":dataParms.get("gl") %>"
                       readonly="readonly" name="tdggltzyjcjhty.gl"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" dictTypeId="protype" id="xt" value="<%=dataParms.get("xt")==null?"":dataParms.get("xt") %>"
                       readonly="readonly" name="tdggltzyjcjhty.xt"/>
            </td>
            <td colspan="1">
            </td>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gxh" value="<%=dataParms.get("gxh")==null?"":dataParms.get("gxh") %>"
                       readonly="readonly" name="tdggltzyjcjhty.gxh"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="zysb" value="<%=dataParms.get("zysb")==null?"":dataParms.get("zysb") %>"
                       readonly="readonly" name="tdggltzyjcjhty.zysb"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="cz" value="<%=dataParms.get("cz")==null?"":dataParms.get("cz") %>"
                       readonly="readonly" name="tdggltzyjcjhty.cz"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gczj" value="<%=dataParms.get("gczj")==null?"":dataParms.get("gczj") %>"
                       readonly="readonly" name="tdggltzyjcjhty.gczj"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="wj" readonly="readonly"
                       value="<%=dataParms.get("wj")==null?"":dataParms.get("wj") %>" name="tdggltzyjcjhty.wj"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" id="lct" value="<%=dataParms.get("lct")==null?"":dataParms.get("lct") %>"
                       style="width: 100%" name="tdggltzyjcjhty.lct"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" id="jcbw" value="<%=dataParms.get("jcbw")==null?"":dataParms.get("jcbw") %>"
                       readonly="readonly" style="width: 100%" name="tdggltzyjcjhty.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" style="width: 100%"
        ...
        <tr>
            ...
            <td id="c2i" colspan="1">
                <input id="c2" value="<%=dataParms.get("c2")==null?"":dataParms.get("c2") %>" class="nui-textbox"
                       name="tdggltzyjcjhty.c2"/>
            </td>
            <td id="c2ii" colspan="1">
                <input id="combobox2i" value="<%=editdataParms.get("c2")==null?"":editdataParms.get("c1") %>"
                       class="nui-textbox"/>
            </td>
        </tr>
        <tr>
