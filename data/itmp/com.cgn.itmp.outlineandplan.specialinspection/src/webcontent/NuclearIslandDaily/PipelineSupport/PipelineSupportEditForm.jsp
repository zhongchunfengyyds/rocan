...
<td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox"  onvalidation="hasIllegalChar(e,1000,false,true)"  name="nextData.tasklist"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  name="nextData.hfnumber"/>
            </td>
            <td class="form_label" align="center">
                数量:
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.number"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  name="nextData.roomnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
    ...
    <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
          ...
          <tr>
            ...
            <td colspan="2">
                <input id="creator" name="nextData.creator" style="width: 100%"class="nui-textbox" value="<%=username %>"/>
            </td>
            <td class="form_label"  align="center">
                修改日期:
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
 ...
 nui.get("jd").setValue(json.preData.base);
    ...
    function saveData(finishFirstActivityId){
        ...
        data.processInstName = "专用检查计划(核岛部件)_日常执行条目_修改焊缝管道";
        data.processInstDesc = "专用检查计划(核岛部件)_日常执行条目_修改焊缝管道";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyHFGDZCEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.PipelineSupport";
