...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.BossHead"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.DailyHFBOSSAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(核岛部件)_日常执行条目_新增焊缝BOSS"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(核岛部件)_日常执行条目_新增焊缝BOSS"/>
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" dictTypeId="BW" name="data.bw"/>
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep){
		...
		if(isadmin == 'true'){
			data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.BossHead';
		}
