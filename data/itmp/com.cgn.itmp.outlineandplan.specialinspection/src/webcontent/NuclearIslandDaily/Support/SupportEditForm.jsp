...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="bracenumber" readonly="readonly" name="preData.bracenumber"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.bracenumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.gxnumber"/>
            </td>
            <td class="form_label" align="center">
                PM编码:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  id="jcprocedure" readonly="readonly" name="preData.jcprocedure"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" id="ckt_dzhnumber" readonly="readonly" style="width: 100%"
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input id="reason" required="true" onvalidation="hasIllegalChar(e,1000,true,true)"  name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea"
                       style="width: 100%;"/>
            </td>
        </tr>
    </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(核岛部件)_日常执行条目_修改支撑支架";
        data.processInstDesc = "专用检查计划(核岛部件)_日常执行条目_修改支撑支架";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyZCZJEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Support";
