 ...
 <script type="text/javascript" src="<%= request.getContextPath() %>/coframe/tools/widget/jquery.ui.min.js"></script>
    ...
    <body>
        ...
        <div id="dataform1" style="padding-top:5px;">
            <!-- hidden域 -->
            <input class="nui-hidden" name="tdggltzyjcjhrcgd.uuid"/>
	...
	<tr>
            	<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                      ...
                      name="tdggltzyjcjhrcgd.base" onvaluechanged="reloadJz"
                    ...
                    <td colspan="1">
                      ...
                      url=""
                      name="tdggltzyjcjhrcgd.crew" value="<%=dataParms.get("crew")==null?"":dataParms.get("crew") %>"  valueField="id"/>
                    </td>   
                    <td>
                    </td>
         		</tr>  
         		<tr>
                   <td class="form_label"   align="center">
                      ...
                      <td colspan="1">
                        <input class="nui-dictcombobox" id="type" value="<%=dataParms.get("type")==null?"":dataParms.get("type") %>"  dictTypeId="ZYJCJH"    name="tdggltzyjcjhrcgd.type"/>
                    </td>
                      <td>
                    </td>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="tasklist" value="<%=dataParms.get("tasklist")==null?"":dataParms.get("tasklist") %>"  name="tdggltzyjcjhrcgd.tasklist"/>
                    </td>
                     <td colspan="1">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" id="checkprojectname" value="<%=dataParms.get("checkprojectname")==null?"":dataParms.get("checkprojectname") %>" name="tdggltzyjcjhrcgd.checkprojectname"/>
                    </td>
                      <td colspan="1">
                    ...
                    <td colspan="1"  >
                        <input class="nui-textbox"id="itemnumber"readonly="readonly"value="<%=dataParms.get("itemnumber")==null?"":dataParms.get("itemnumber") %>" name="tdggltzyjcjhrcgd.itemnumber"/>
                    </td>
                    <td colspan="1"  >
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="system"readonly="readonly"value="<%=dataParms.get("system")==null?"":dataParms.get("system") %>" name="tdggltzyjcjhrcgd.system"/>
                    </td>
                     <td colspan="1">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="equipment"readonly="readonly"value="<%=dataParms.get("equipment")==null?"":dataParms.get("equipment") %>" name="tdggltzyjcjhrcgd.equipment"/>
                    </td>
                    <td colspan="1">
                ...
                <tr>
                    ...
                    <td colspan="1"  >
                        <input class="nui-textbox"id="hfnumber"readonly="readonly" value="<%=dataParms.get("hfnumber")==null?"":dataParms.get("hfnumber") %>"name="tdggltzyjcjhrcgd.hfnumber"/>
                    </td>
                     <td colspan="1"  >
                    ...
                    <td colspan="1">
                        <input class="nui-spinner"id="number"readonly="readonly"value="<%=dataParms.get("cumber")==null?"":dataParms.get("cumber") %>"  maxValue="10000" name="tdggltzyjcjhrcgd.number"/>
                    </td>
                     <td colspan="1">
                        <input class="nui-spinner"  maxValue="10000" value="<%=editdataParms.get("cumber")==null?"":editdataParms.get("cumber") %>" name="tdgg.number"/>
                    </td>
                 </tr>
                <tr>
                    <td class="form_label"   align="center">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="gxnumber"readonly="readonly"value="<%=dataParms.get("gxnumber")==null?"":dataParms.get("gxnumber") %>" name="tdggltzyjcjhrcgd.gxnumber"/>
                    </td>
                     <td colspan="1">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="roomnumber"readonly="readonly" value="<%=dataParms.get("roomnumber")==null?"":dataParms.get("roomnumber") %>" name="tdggltzyjcjhrcgd.roomnumber"/>
                    </td>
                     <td colspan="1">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="jcmethod"readonly="readonly" value="<%=dataParms.get("jcmethod")==null?"":dataParms.get("jcmethod") %>" name="tdggltzyjcjhrcgd.jcmethod"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"id="jcprocedure"readonly="readonly"value="<%=dataParms.get("jcprocedure")==null?"":dataParms.get("jcprocedure") %>" name="tdggltzyjcjhrcgd.jcprocedure"/>
                    </td>
                     <td colspan="1">
                ...
                <tr>
                  <td class="form_label"   align="center">
                    ...
                    <td colspan="1">
                        <input class="nui-textarea"id="ckt_dzhnumber"readonly="readonly"value="<%=dataParms.get("ckt_dzhnumber")==null?"":dataParms.get("ckt_dzhnumber") %>" style="width: 100%"  name="tdggltzyjcjhrcgd.ckt_dzhnumber"/>
                    </td>
                    <td colspan="1">
                        <input class="nui-textarea"value="<%=editdataParms.get("ckt_dzhnumber")==null?"":editdataParms.get("ckt_dzhnumber") %>" style="width: 100%"  name="tdgg.ckt_dzhnumber"/>
                    </td>
                    ...
                    <td colspan="1">
                        <input class="nui-textarea"id="remarks"readonly="readonly"value="<%=dataParms.get("remarks")==null?"":dataParms.get("remarks") %>" style="width: 100%" name="tdggltzyjcjhrcgd.remarks"/>
                    </td>
                     <td colspan="1">
          ...
          <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
             	<tr>
					...
					<td id="c1991i" colspan="1">
						<input id="c1991" value="<%=dataParms.get("c1991")==null?"":dataParms.get("c1991") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1991"/>
					</td>
					...
					<td id="c1992i" colspan="1">
						<input id="c1992" value="<%=dataParms.get("c1992")==null?"":dataParms.get("c1992") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1992"/>
					</td>
             ...
             <tr>
				...
				<td id="c1993i" colspan="1">
					<input id="c1993" value="<%=dataParms.get("c1993")==null?"":dataParms.get("c1993") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1993"/>
				</td>
				...
				<td id="c1994i" colspan="1">
					<input id="c1994" value="<%=dataParms.get("c1994")==null?"":dataParms.get("c1994") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1994"/>
				</td>
			...
			<tr>
				...
				<td id="c1995i" colspan="1">
					<input id="c1995" value="<%=dataParms.get("c1995")==null?"":dataParms.get("c1995") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1995"/>
				</td>
				...
				<td id="c1996i" colspan="1">
					<input id="c1996" value="<%=dataParms.get("c1996")==null?"":dataParms.get("c1996") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1996"/>
				</td>
			...
			<tr>
				...
				<td id="c1997i" colspan="1">
					<input id="c1997" value="<%=dataParms.get("c1997")==null?"":dataParms.get("c1997") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1997"/>
				</td>
				...
				<td id="c1998i" colspan="1">
					<input id="c1998" value="<%=dataParms.get("c1998")==null?"":dataParms.get("c1998") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1998"/>
				</td>
			...
			<tr>
				...
				<td id="c1999i" colspan="1">
					<input id="c1999" value="<%=dataParms.get("c1999")==null?"":dataParms.get("c1999") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c1999"/>
				</td>
				...
				<td id="c2000i" colspan="1">
					<input id="c2000" value="<%=dataParms.get("c2000")==null?"":dataParms.get("c2000") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2000"/>
				</td>
			...
			<tr>
				...
				<td id="c2001i" colspan="1">
					<input id="c2001" value="<%=dataParms.get("c2001")==null?"":dataParms.get("c2001") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2001"/>
				</td>
				...
				<td id="c2002i" colspan="1">
					<input id="c2002" value="<%=dataParms.get("c2002")==null?"":dataParms.get("c2002") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2002"/>
				</td>
			...
			<tr>
				...
				<td id="c2003i" colspan="1">
					<input id="c2003" value="<%=dataParms.get("c2003")==null?"":dataParms.get("c2003") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2003"/>
				</td>
				...
				<td id="c2004i" colspan="1">
					<input id="c2004" value="<%=dataParms.get("c2004")==null?"":dataParms.get("c2004") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2004"/>
				</td>
			...
			<tr>
				...
				<td id="c2005i" colspan="1">
					<input id="c2005" value="<%=dataParms.get("c2005")==null?"":dataParms.get("c2005") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2005"/>
				</td>
				...
				<td id="c2006i" colspan="1">
					<input id="c2006" value="<%=dataParms.get("c2006")==null?"":dataParms.get("c2006") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2006"/>
				</td>
			...
			<tr>
				...
				<td id="c2007i" colspan="1">
					<input id="c2007" value="<%=dataParms.get("c2007")==null?"":dataParms.get("c2007") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2007"/>
				</td>
				...
				<td id="c2008i" colspan="1">
					<input id="c2008" value="<%=dataParms.get("c2008")==null?"":dataParms.get("c2008") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2008"/>
				</td>
			...
			<tr>
				...
				<td id="c2009i" colspan="1">
					<input id="c2009" value="<%=dataParms.get("c2009")==null?"":dataParms.get("c2009") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2009"/>
				</td>
				...
				<td id="c2010i" colspan="1">
					<input id="c2010" value="<%=dataParms.get("c2010")==null?"":dataParms.get("c2010") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2010"/>
				</td>
			...
			<tr>
				...
				<td id="c2011i" colspan="1">
					<input id="c2011" value="<%=dataParms.get("c2011")==null?"":dataParms.get("c2011") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2011"/>
				</td>
				...
				<td id="c2012i" colspan="1">
					<input id="c2012" value="<%=dataParms.get("c2012")==null?"":dataParms.get("c2012") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2012"/>
				</td>
			...
			<tr>
				...
				<td id="c2013i" colspan="1">
					<input id="c2013" value="<%=dataParms.get("c2013")==null?"":dataParms.get("c2013") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2013"/>
				</td>
				...
				<td id="c2014i" colspan="1">
					<input id="c2014" value="<%=dataParms.get("c2014")==null?"":dataParms.get("c2014") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2014"/>
				</td>
			...
			<tr>
				...
				<td id="c2015i" colspan="1">
					<input id="c2015" value="<%=dataParms.get("c2015")==null?"":dataParms.get("c2015") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2015"/>
				</td>
				...
				<td id="c2016i" colspan="1">
					<input id="c2016" value="<%=dataParms.get("c2016")==null?"":dataParms.get("c2016") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2016"/>
				</td>
			...
			<tr>
				...
				<td id="c2017i" colspan="1">
					<input id="c2017" value="<%=dataParms.get("c2017")==null?"":dataParms.get("c2017") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2017"/>
				</td>
				...
				<td id="c2018i" colspan="1">
					<input id="c2018" value="<%=dataParms.get("c2018")==null?"":dataParms.get("c2018") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2018"/>
				</td>
			...
			<tr>
				...
				<td id="c2019i" colspan="1">
					<input id="c2019" value="<%=dataParms.get("c2019")==null?"":dataParms.get("c2019") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2019"/>
				</td>
				...
				<td id="c2020i" colspan="1">
					<input id="c2020" value="<%=dataParms.get("c2020")==null?"":dataParms.get("c2020") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2020"/>
				</td>
			...
			<tr>
				...
				<td id="c2021i" colspan="1">
					<input id="c2021" value="<%=dataParms.get("c2021")==null?"":dataParms.get("c2021") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2021"/>
				</td>
				...
				<td id="c2022i" colspan="1">
					<input id="c2022" value="<%=dataParms.get("c2022")==null?"":dataParms.get("c2022") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2022"/>
				</td>
			...
			<tr>
				...
				<td id="c2023i" colspan="1">
					<input id="c2023" value="<%=dataParms.get("c2023")==null?"":dataParms.get("c2023") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2023"/>
				</td>
				...
				<td id="c2024i" colspan="1">
					<input id="c2024" value="<%=dataParms.get("c2024")==null?"":dataParms.get("c2024") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2024"/>
				</td>
			...
			<tr>
				...
				<td id="c2025i" colspan="1">
					<input id="c2025" value="<%=dataParms.get("c2025")==null?"":dataParms.get("c2025") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2025"/>
				</td>
				...
				<td id="c2026i" colspan="1">
					<input id="c2026" value="<%=dataParms.get("c2026")==null?"":dataParms.get("c2026") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2026"/>
				</td>
			...
			<tr>
				...
				<td id="c2027i" colspan="1">
					<input id="c2027" value="<%=dataParms.get("c2027")==null?"":dataParms.get("c2027") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2027"/>
				</td>
				...
				<td id="c2028i" colspan="1">
					<input id="c2028" value="<%=dataParms.get("c2028")==null?"":dataParms.get("c2028") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2028"/>
				</td>
			...
			<tr>
				...
				<td id="c2029i" colspan="1">
					<input id="c2029" value="<%=dataParms.get("c2029")==null?"":dataParms.get("c2029") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2029"/>
				</td>
				...
				<td id="c2030i" colspan="1">
					<input id="c2030" value="<%=dataParms.get("c2030")==null?"":dataParms.get("c2030") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2030"/>
				</td>
			...
			<tr>
				...
				<td id="c2031i" colspan="1">
					<input id="c2031" value="<%=dataParms.get("c2031")==null?"":dataParms.get("c2031") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2031"/>
				</td>
				...
				<td id="c2032i" colspan="1">
					<input id="c2032" value="<%=dataParms.get("c2032")==null?"":dataParms.get("c2032") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2032"/>
				</td>
			...
			<tr>
				...
				<td id="c2033i" colspan="1">
					<input id="c2033" value="<%=dataParms.get("c2033")==null?"":dataParms.get("c2033") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2033"/>
				</td>
				...
				<td id="c2034i" colspan="1">
					<input id="c2034" value="<%=dataParms.get("c2034")==null?"":dataParms.get("c2034") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2034"/>
				</td>
			...
			<tr>
				...
				<td id="c2035i" colspan="1">
					<input id="c2035" value="<%=dataParms.get("c2035")==null?"":dataParms.get("c2035") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2035"/>
				</td>
				...
				<td id="c2036i" colspan="1">
					<input id="c2036" value="<%=dataParms.get("c2036")==null?"":dataParms.get("c2036") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2036"/>
				</td>
			...
			<tr>
				...
				<td id="c2037i" colspan="1">
					<input id="c2037" value="<%=dataParms.get("c2037")==null?"":dataParms.get("c2037") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2037"/>
				</td>
				...
				<td id="c2038i" colspan="1">
					<input id="c2038" value="<%=dataParms.get("c2038")==null?"":dataParms.get("c2038") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2038"/>
				</td>
			...
			<tr>
				...
				<td id="c2039i" colspan="1">
					<input id="c2039" value="<%=dataParms.get("c2039")==null?"":dataParms.get("c2039") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2039"/>
				</td>
				...
				<td id="c2040i" colspan="1">
					<input id="c2040" value="<%=dataParms.get("c2040")==null?"":dataParms.get("c2040") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2040"/>
				</td>
			...
			<tr>
				...
				<td id="c2041i" colspan="1">
					<input id="c2041" value="<%=dataParms.get("c2041")==null?"":dataParms.get("c2041") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2041"/>
				</td>
				...
				<td id="c2042i" colspan="1">
					<input id="c2042" value="<%=dataParms.get("c2042")==null?"":dataParms.get("c2042") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2042"/>
				</td>
			...
			<tr>
				...
				<td id="c2043i" colspan="1">
					<input id="c2043" value="<%=dataParms.get("c2043")==null?"":dataParms.get("c2043") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2043"/>
				</td>
				...
				<td id="c2044i" colspan="1">
					<input id="c2044" value="<%=dataParms.get("c2044")==null?"":dataParms.get("c2044") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2044"/>
				</td>
			...
			<tr>
				...
				<td id="c2045i" colspan="1">
					<input id="c2045" value="<%=dataParms.get("c2045")==null?"":dataParms.get("c2045") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2045"/>
				</td>
				...
				<td id="c2046i" colspan="1">
					<input id="c2046" value="<%=dataParms.get("c2046")==null?"":dataParms.get("c2046") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2046"/>
				</td>
			...
			<tr>
				...
				<td id="c2047i" colspan="1">
					<input id="c2047" value="<%=dataParms.get("c2047")==null?"":dataParms.get("c2047") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2047"/>
				</td>
				...
				<td id="c2048i" colspan="1">
					<input id="c2048" value="<%=dataParms.get("c2048")==null?"":dataParms.get("c2048") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2048"/>
				</td>
			...
			<tr>
				...
				<td id="c2049i" colspan="1">
					<input id="c2049" value="<%=dataParms.get("c2049")==null?"":dataParms.get("c2049") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2049"/>
				</td>
				...
				<td id="c2050i" colspan="1">
					<input id="c2050" value="<%=dataParms.get("c2050")==null?"":dataParms.get("c2050") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2050"/>
				</td>
			...
			<tr>
				...
				<td id="c2051i" colspan="1">
					<input id="c2051" value="<%=dataParms.get("c2051")==null?"":dataParms.get("c2051") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2051"/>
				</td>
				...
				<td id="c2052i" colspan="1">
					<input id="c2052" value="<%=dataParms.get("c2052")==null?"":dataParms.get("c2052") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2052"/>
				</td>
			...
			<tr>
				...
				<td id="c2053i" colspan="1">
					<input id="c2053" value="<%=dataParms.get("c2053")==null?"":dataParms.get("c2053") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2053"/>
				</td>
				...
				<td id="c2054i" colspan="1">
					<input id="c2054" value="<%=dataParms.get("c2054")==null?"":dataParms.get("c2054") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2054"/>
				</td>
			...
			<tr>
				...
				<td id="c2055i" colspan="1">
					<input id="c2055" value="<%=dataParms.get("c2055")==null?"":dataParms.get("c2055") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2055"/>
				</td>
				...
				<td id="c2056i" colspan="1">
					<input id="c2056" value="<%=dataParms.get("c2056")==null?"":dataParms.get("c2056") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2056"/>
				</td>
			...
			<tr>
				...
				<td id="c2057i" colspan="1">
					<input id="c2057" value="<%=dataParms.get("c2057")==null?"":dataParms.get("c2057") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2057"/>
				</td>
				...
				<td id="c2058i" colspan="1">
					<input id="c2058" value="<%=dataParms.get("c2058")==null?"":dataParms.get("c2058") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2058"/>
				</td>
			...
			<tr>
				...
				<td id="c2059i" colspan="1">
					<input id="c2059" value="<%=dataParms.get("c2059")==null?"":dataParms.get("c2059") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2059"/>
				</td>
				...
				<td id="c2060i" colspan="1">
					<input id="c2060" value="<%=dataParms.get("c2060")==null?"":dataParms.get("c2060") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2060"/>
				</td>
			...
			<tr>
				...
				<td id="c2061i" colspan="1">
					<input id="c2061" value="<%=dataParms.get("c2061")==null?"":dataParms.get("c2061") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2061"/>
				</td>
				...
				<td id="c2062i" colspan="1">
					<input id="c2062" value="<%=dataParms.get("c2062")==null?"":dataParms.get("c2062") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2062"/>
				</td>
			...
			<tr>
				...
				<td id="c2063i" colspan="1">
					<input id="c2063" value="<%=dataParms.get("c2063")==null?"":dataParms.get("c2063") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2063"/>
				</td>
				...
				<td id="c2064i" colspan="1">
					<input id="c2064" value="<%=dataParms.get("c2064")==null?"":dataParms.get("c2064") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2064"/>
				</td>
			...
			<tr>
				...
				<td id="c2065i" colspan="1">
					<input id="c2065" value="<%=dataParms.get("c2065")==null?"":dataParms.get("c2065") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2065"/>
				</td>
				...
				<td id="c2066i" colspan="1">
					<input id="c2066" value="<%=dataParms.get("c2066")==null?"":dataParms.get("c2066") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2066"/>
				</td>
			...
			<tr>
				...
				<td id="c2067i" colspan="1">
					<input id="c2067" value="<%=dataParms.get("c2067")==null?"":dataParms.get("c2067") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2067"/>
				</td>
				...
				<td id="c2068i" colspan="1">
					<input id="c2068" value="<%=dataParms.get("c2068")==null?"":dataParms.get("c2068") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2068"/>
				</td>
			...
			<tr>
				...
				<td id="c2069i" colspan="1">
					<input id="c2069" value="<%=dataParms.get("c2069")==null?"":dataParms.get("c2069") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2069"/>
				</td>
				...
				<td id="c2070i" colspan="1">
					<input id="c2070" value="<%=dataParms.get("c2070")==null?"":dataParms.get("c2070") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2070"/>
				</td>
			...
			<tr>
				...
				<td id="c2071i" colspan="1">
					<input id="c2071" value="<%=dataParms.get("c2071")==null?"":dataParms.get("c2071") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2071"/>
				</td>
				...
				<td id="c2072i" colspan="1">
					<input id="c2072" value="<%=dataParms.get("c2072")==null?"":dataParms.get("c2072") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2072"/>
				</td>
			...
			<tr>
				...
				<td id="c2073i" colspan="1">
					<input id="c2073" value="<%=dataParms.get("c2073")==null?"":dataParms.get("c2073") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2073"/>
				</td>
				...
				<td id="c2074i" colspan="1">
					<input id="c2074" value="<%=dataParms.get("c2074")==null?"":dataParms.get("c2074") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2074"/>
				</td>
			...
			<tr>
				...
				<td id="c2075i" colspan="1">
					<input id="c2075" value="<%=dataParms.get("c2075")==null?"":dataParms.get("c2075") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2075"/>
				</td>
				...
				<td id="c2076i" colspan="1">
					<input id="c2076" value="<%=dataParms.get("c2076")==null?"":dataParms.get("c2076") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2076"/>
				</td>
			...
			<tr>
				...
				<td id="c2077i" colspan="1">
					<input id="c2077" value="<%=dataParms.get("c2077")==null?"":dataParms.get("c2077") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2077"/>
				</td>
				...
				<td id="c2078i" colspan="1">
					<input id="c2078" value="<%=dataParms.get("c2078")==null?"":dataParms.get("c2078") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2078"/>
				</td>
			...
			<tr>
				...
				<td id="c2079i" colspan="1">
					<input id="c2079" value="<%=dataParms.get("c2079")==null?"":dataParms.get("c2079") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2079"/>
				</td>
				...
				<td id="c2080i" colspan="1">
					<input id="c2080" value="<%=dataParms.get("c2080")==null?"":dataParms.get("c2080") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2080"/>
				</td>
			...
			<tr>
				...
				<td id="c2081i" colspan="1">
					<input id="c2081" value="<%=dataParms.get("c2081")==null?"":dataParms.get("c2081") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2081"/>
				</td>
				...
				<td id="c2082i" colspan="1">
					<input id="c2082" value="<%=dataParms.get("c2082")==null?"":dataParms.get("c2082") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2082"/>
				</td>
			...
			<tr>
				...
				<td id="c2083i" colspan="1">
					<input id="c2083" value="<%=dataParms.get("c2083")==null?"":dataParms.get("c2083") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2083"/>
				</td>
				...
				<td id="c2084i" colspan="1">
					<input id="c2084" value="<%=dataParms.get("c2084")==null?"":dataParms.get("c2084") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2084"/>
				</td>
			...
			<tr>
				...
				<td id="c2085i" colspan="1">
					<input id="c2085" value="<%=dataParms.get("c2085")==null?"":dataParms.get("c2085") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2085"/>
				</td>
				...
				<td id="c2086i" colspan="1">
					<input id="c2086" value="<%=dataParms.get("c2086")==null?"":dataParms.get("c2086") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2086"/>
				</td>
			...
			<tr>
				...
				<td id="c2087i" colspan="1">
					<input id="c2087" value="<%=dataParms.get("c2087")==null?"":dataParms.get("c2087") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2087"/>
				</td>
				...
				<td id="c2088i" colspan="1">
					<input id="c2088" value="<%=dataParms.get("c2088")==null?"":dataParms.get("c2088") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2088"/>
				</td>
			...
			<tr>
				...
				<td id="c2089i" colspan="1">
					<input id="c2089" value="<%=dataParms.get("c2089")==null?"":dataParms.get("c2089") %>" class="nui-textbox" name="tdggltzyjcjhrcgd.c2089"/>
				</td>
                ...
                <tr>
                    ...
                    <td colspan="6">
                        <input id="reason" value="<%=editdataParms.get("reason")==null?"":editdataParms.get("reason") %>" class="nui-textarea" required="true" requiredErrorText="请输入修改原因" style="width: 100%" name="tdggltzyjcjhrcgd.reason"/>
                    </td>
                </tr>
            </table>
            </div>  
