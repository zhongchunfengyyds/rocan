            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="org" renderer="orgRenderer" headerAlign="center" allowSort="true" >
                            组织
                        </div>
                        <div field="wd" renderer="wdRenderer" headerAlign="center" allowSort="true" >
                            维度
                        </div>
                        <div field="year" headerAlign="center" allowSort="true" >
                            年度
                        </div>
                        <div field="month" headerAlign="center" allowSort="true" >
                            月份
                        </div>
                        <div field="fj" renderer="setFile" headerAlign="center" allowSort="true" >
                            附件
                        </div>
                        <div field="d" headerAlign="center" allowSort="true" >
                            大
                        </div>
                        <div field="h" headerAlign="center" allowSort="true" >
                            红
                        </div>
                        <div field="n" headerAlign="center" allowSort="true" >
                            宁
                        </div>
                        <div field="y" headerAlign="center" allowSort="true" >
                            阳
                        </div>
                        <div field="t" headerAlign="center" allowSort="true" >
                            台
                        </div>
                        <div field="f" headerAlign="center" allowSort="true" >
                            防
                        </div>
			...
			//恢复
			  function hf(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tqcjsglzhzsgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.ComprehensiveIndexMgt.hfdeleteTQcjsglZhzsgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.ComprehensiveIndexMgt.deleteTQcjsglZhzsgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
