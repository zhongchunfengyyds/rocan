            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.prosource"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="insystem" class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.insystem"/>
                    </td>
                    <td class="form_label"  align="center">
                        设备名称:
                    </td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="inspectionscope" onvalidation="hasIllegalChar(e,1000,false,true)" class="nui-textbox" name="nextData.inspectionscope"/>
                    </td>
                    <td class="form_label"  align="center">
                        接近方式:
                    </td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="method" class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.method"/>
                    </td>
                    <td class="form_label"  align="center">
                         执行单位:
                    </td>
                    ...
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.executionunit"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="rsemcycle" class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.rsemcycle"/>
                    </td>
                    <td class="form_label"  align="center">
                         检查周期(SAP):
                    </td>
                    ...
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.sapcycle"/>
                    </td>
         		</tr>
         		<tr>
                    <td class="form_label"  align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		  ...
		  nui.get("#btnSave").setEnabled(false);
				...
				data.processInstName = "规范非法定总纲_大修执行条目_修改";
				data.processInstDesc = "规范非法定总纲_大修执行条目_修改";
				data.processDefName = "com.cgn.itmp.outlineandplan.outline.editGfffdDxzxtm";
				data.middleEntity = "com.cgn.itmp.outlineandplan.outline.common.NonStaturory.NonStaturoryEdit";
         		data.realEntity = "com.cgn.itmp.outlineandplan.outline.NonStaturoryOverhaul.OverhaulEntity";
