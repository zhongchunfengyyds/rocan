            ...
            <td class="form_label"  align="center">
              ...
              <tr>
              	...
              	<tr>
					...
					<tr>
				<td class="form_label" width="20%">审批意见:</td>
				<td colspan="1"><input class="nui-textbox"
					value="<b:write property='manualActivity1/advise'/>" style="width: 400px"
					allowInput="false" /></td>
					
					<td class="form_label" width="20%">审批时间:</td>
				<td colspan="1"><input id="date2" class="nui-datepicker"
					style="width: 200px;" format="yyyy-MM-dd H:mm"
					value="<b:write property='manualActivity1/approvedtime'/>" showTime="true" readonly="readonly"/>
				</td>
...
<!--                  		<input  required="true" property="editor" id="jhry"  name="jhry"  class="nui-textboxlist" dataField="list" required="true" style="width:350px"  -->
...
<!--                     </td> -->
                    ...
                    <td colspan="2">
    				<input  required="true" property="editor" id="ccry"  name="ccry"  class="nui-textboxlist" dataField="list"  style="width:350px" 
                 ...
                 <tr>
                        <td style="text-align:center;" colspan="4">
                            ...
                            <span style="display:inline-block;width:25px;">
                  			...
                  			<a class="nui-button"  onclick="onSave()" id="btnSave">
                                	保存
                            </a>          
                             <span style="display:inline-block;width:25px;">
                            </span>
	...
	nui.open({showMaxButton : true,
	    ...
	    ondestroy: function (action) {
	        if (action == "ok") {
	            ...
	            if (data) {
	            	btnEditid.setValue(data.uuid);
	                if(type == '1'){
	                	btnEdit.setValue(data.cktlmc);
	                	btnEdit.setText(data.cktlmc);
