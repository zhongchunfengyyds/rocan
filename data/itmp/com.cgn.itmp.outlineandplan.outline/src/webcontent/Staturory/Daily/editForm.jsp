        ...
        <div id="overhauldataform" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td>
                        <input id="btnEdit1" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'1');" name="nextData.referencefigureno"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="olditemno" class="nui-textbox" name="preData.itemno"/>
                    </td>
                    <td colspan="1">
           ...
           <tr id="bjbw">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input id="btnEdit2" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'2');" name="nextData.program"/>
                    </td>
                </tr>
                <tr>
                	<td class="form_label"  align="center">
           ...
           <table id="sytab" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
             ...
             <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
             	<tr>
					...
					<td id="n1991ii" colspan="1">
						<div name="nextData.n1991" id="combobox1991i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
					...
					<td id="n1992ii" colspan="1">
						<div name="nextData.n1992" id="combobox1992i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
							 url=""  multiSelect="true"  
							 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
							 <div property="columns">
             ...
             <tr>
				...
				<td id="n1993ii" colspan="1">
					<div name="nextData.n1993" id="combobox1993i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n1994ii" colspan="1">
					<div name="nextData.n1994" id="combobox1994i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n1995ii" colspan="1">
					<div name="nextData.n1995" id="combobox1995i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n1996ii" colspan="1">
					<div name="nextData.n1996" id="combobox1996i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n1997ii" colspan="1">
					<div name="nextData.n1997" id="combobox1997i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n1998ii" colspan="1">
					<div name="nextData.n1998" id="combobox1998i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n1999ii" colspan="1">
					<div name="nextData.n1999" id="combobox1999i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2000ii" colspan="1">
					<div name="nextData.n2000" id="combobox2000i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2001ii" colspan="1">
					<div name="nextData.n2001" id="combobox2001i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2002ii" colspan="1">
					<div name="nextData.n2002" id="combobox2002i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2003ii" colspan="1">
					<div name="nextData.n2003" id="combobox2003i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2004ii" colspan="1">
					<div name="nextData.n2004" id="combobox2004i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2005ii" colspan="1">
					<div name="nextData.n2005" id="combobox2005i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2006ii" colspan="1">
					<div name="nextData.n2006" id="combobox2006i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2007ii" colspan="1">
					<div name="nextData.n2007" id="combobox2007i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2008ii" colspan="1">
					<div name="nextData.n2008" id="combobox2008i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2009ii" colspan="1">
					<div name="nextData.n2009" id="combobox2009i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2010ii" colspan="1">
					<div name="nextData.n2010" id="combobox2010i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2011ii" colspan="1">
					<div name="nextData.n2011" id="combobox2011i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2012ii" colspan="1">
					<div name="nextData.n2012" id="combobox2012i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2013ii" colspan="1">
					<div name="nextData.n2013" id="combobox2013i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2014ii" colspan="1">
					<div name="nextData.n2014" id="combobox2014i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2015ii" colspan="1">
					<div name="nextData.n2015" id="combobox2015i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2016ii" colspan="1">
					<div name="nextData.n2016" id="combobox2016i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2017ii" colspan="1">
					<div name="nextData.n2017" id="combobox2017i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2018ii" colspan="1">
					<div name="nextData.n2018" id="combobox2018i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2019ii" colspan="1">
					<div name="nextData.n2019" id="combobox2019i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2020ii" colspan="1">
					<div name="nextData.n2020" id="combobox2020i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2021ii" colspan="1">
					<div name="nextData.n2021" id="combobox2021i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2022ii" colspan="1">
					<div name="nextData.n2022" id="combobox2022i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2023ii" colspan="1">
					<div name="nextData.n2023" id="combobox2023i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2024ii" colspan="1">
					<div name="nextData.n2024" id="combobox2024i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2025ii" colspan="1">
					<div name="nextData.n2025" id="combobox2025i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2026ii" colspan="1">
					<div name="nextData.n2026" id="combobox2026i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2027ii" colspan="1">
					<div name="nextData.n2027" id="combobox2027i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2028ii" colspan="1">
					<div name="nextData.n2028" id="combobox2028i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2029ii" colspan="1">
					<div name="nextData.n2029" id="combobox2029i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2030ii" colspan="1">
					<div name="nextData.n2030" id="combobox2030i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2031ii" colspan="1">
					<div name="nextData.n2031" id="combobox2031i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2032ii" colspan="1">
					<div name="nextData.n2032" id="combobox2032i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2033ii" colspan="1">
					<div name="nextData.n2033" id="combobox2033i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2034ii" colspan="1">
					<div name="nextData.n2034" id="combobox2034i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2035ii" colspan="1">
					<div name="nextData.n2035" id="combobox2035i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2036ii" colspan="1">
					<div name="nextData.n2036" id="combobox2036i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2037ii" colspan="1">
					<div name="nextData.n2037" id="combobox2037i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2038ii" colspan="1">
					<div name="nextData.n2038" id="combobox2038i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2039ii" colspan="1">
					<div name="nextData.n2039" id="combobox2039i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2040ii" colspan="1">
					<div name="nextData.n2040" id="combobox2040i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2041ii" colspan="1">
					<div name="nextData.n2041" id="combobox2041i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2042ii" colspan="1">
					<div name="nextData.n2042" id="combobox2042i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2043ii" colspan="1">
					<div name="nextData.n2043" id="combobox2043i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2044ii" colspan="1">
					<div name="nextData.n2044" id="combobox2044i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2045ii" colspan="1">
					<div name="nextData.n2045" id="combobox2045i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2046ii" colspan="1">
					<div name="nextData.n2046" id="combobox2046i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2047ii" colspan="1">
					<div name="nextData.n2047" id="combobox2047i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2048ii" colspan="1">
					<div name="nextData.n2048" id="combobox2048i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2049ii" colspan="1">
					<div name="nextData.n2049" id="combobox2049i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2050ii" colspan="1">
					<div name="nextData.n2050" id="combobox2050i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2051ii" colspan="1">
					<div name="nextData.n2051" id="combobox2051i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2052ii" colspan="1">
					<div name="nextData.n2052" id="combobox2052i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2053ii" colspan="1">
					<div name="nextData.n2053" id="combobox2053i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2054ii" colspan="1">
					<div name="nextData.n2054" id="combobox2054i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2055ii" colspan="1">
					<div name="nextData.n2055" id="combobox2055i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2056ii" colspan="1">
					<div name="nextData.n2056" id="combobox2056i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2057ii" colspan="1">
					<div name="nextData.n2057" id="combobox2057i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2058ii" colspan="1">
					<div name="nextData.n2058" id="combobox2058i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2059ii" colspan="1">
					<div name="nextData.n2059" id="combobox2059i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2060ii" colspan="1">
					<div name="nextData.n2060" id="combobox2060i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2061ii" colspan="1">
					<div name="nextData.n2061" id="combobox2061i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2062ii" colspan="1">
					<div name="nextData.n2062" id="combobox2062i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2063ii" colspan="1">
					<div name="nextData.n2063" id="combobox2063i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2064ii" colspan="1">
					<div name="nextData.n2064" id="combobox2064i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2065ii" colspan="1">
					<div name="nextData.n2065" id="combobox2065i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2066ii" colspan="1">
					<div name="nextData.n2066" id="combobox2066i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2067ii" colspan="1">
					<div name="nextData.n2067" id="combobox2067i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2068ii" colspan="1">
					<div name="nextData.n2068" id="combobox2068i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2069ii" colspan="1">
					<div name="nextData.n2069" id="combobox2069i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2070ii" colspan="1">
					<div name="nextData.n2070" id="combobox2070i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2071ii" colspan="1">
					<div name="nextData.n2071" id="combobox2071i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2072ii" colspan="1">
					<div name="nextData.n2072" id="combobox2072i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2073ii" colspan="1">
					<div name="nextData.n2073" id="combobox2073i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2074ii" colspan="1">
					<div name="nextData.n2074" id="combobox2074i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2075ii" colspan="1">
					<div name="nextData.n2075" id="combobox2075i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2076ii" colspan="1">
					<div name="nextData.n2076" id="combobox2076i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2077ii" colspan="1">
					<div name="nextData.n2077" id="combobox2077i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2078ii" colspan="1">
					<div name="nextData.n2078" id="combobox2078i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2079ii" colspan="1">
					<div name="nextData.n2079" id="combobox2079i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2080ii" colspan="1">
					<div name="nextData.n2080" id="combobox2080i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2081ii" colspan="1">
					<div name="nextData.n2081" id="combobox2081i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2082ii" colspan="1">
					<div name="nextData.n2082" id="combobox2082i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2083ii" colspan="1">
					<div name="nextData.n2083" id="combobox2083i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2084ii" colspan="1">
					<div name="nextData.n2084" id="combobox2084i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2085ii" colspan="1">
					<div name="nextData.n2085" id="combobox2085i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2086ii" colspan="1">
					<div name="nextData.n2086" id="combobox2086i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2087ii" colspan="1">
					<div name="nextData.n2087" id="combobox2087i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
				...
				<td id="n2088ii" colspan="1">
					<div name="nextData.n2088" id="combobox2088i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
			...
			<tr>
				...
				<td id="n2089ii" colspan="1">
					<div name="nextData.n2089" id="combobox2089i" class="nui-combobox" style="width:100px;"   textField="name" valueField="id" 
						 url=""  multiSelect="true"  
						 showClose="true" oncloseclick="onCloseClick" dataField="jsonObject" >     
						 <div property="columns">
             ...
             <!-- 人员及原因信息 -->
              ...
              <tr>
              	...
              	<tr>
                    ...
                    <td colspan="5">
                        <input id="reason" onvalidation="hasIllegalChar(e,400,false,true)"  required="true"  name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea" style="width: 100%;"/>
                    </td>
                </tr>
                </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		  ...
		  nui.get("#btnSave").setEnabled(false);
				...
				data.processInstName = "规范法定大纲_日常执行条目_修改";
				data.processInstDesc = "规范法定大纲_日常执行条目_修改";
				data.processDefName = "com.cgn.itmp.outlineandplan.outline.editGffdRczxtm";
				data.middleEntity = "com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulEdit";
				data.realEntity = "com.cgn.itmp.outlineandplan.outline.StaturoryDaily.DailyEntity";
                ...
                $.ajax({
                    ...
                    success:function(text){
                        ...
                        if(returnJson.exception == null){
                        	if("" != finishFirstActivityId){
                            nui.confirm("条目已修改并提交成功，请确定是否同步变更十年计划","系统提示",
			                    function(action){
			                        if(action=="ok"){
