 ...
 * <ul>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getEquipmentnumber <em>Equipmentnumber</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getDeviceversion <em>Deviceversion</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getCommissiontime <em>Commissiontime</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFreezereplacetime <em>Freezereplacetime</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFreezereplacereason <em>Freezereplacereason</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getEnteringperson <em>Enteringperson</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getEnteringtime <em>Enteringtime</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFj <em>Fj</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getOperating <em>Operating</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFileRealName <em>FileRealName</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFpath <em>Fpath</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.EquipmenthistoryinfoImpl#getFildid <em>Fildid</em>}</li>
 * </ul>
 * </p>
 *
...
public class EquipmenthistoryinfoImpl extends ExtendedDataObjectImpl implements Equipmenthistoryinfo {
	...
	public final static int INDEX_FILEREALNAME = 10;
	public final static int INDEX_FPATH = 11;
	public final static int INDEX_FILDID = 12;
	...
	/**
	 * Returns the value of the '<em><b>FileRealName</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>FileRealName</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>FileRealName</em>' attribute.
	 * @see #setFileRealName(java.lang.String)
	 */
	public String getFileRealName() {
		return DataUtil.toString(super.getByIndex(INDEX_FILEREALNAME, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getFileRealName <em>FileRealName</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>FileRealName</em>' attribute.
	 * @see #getFileRealName()
	 */
	public void setFileRealName(String fileRealName) {
		super.setByIndex(INDEX_FILEREALNAME, fileRealName);
	}

	/**
	 * Returns the value of the '<em><b>Fpath</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Fpath</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Fpath</em>' attribute.
	 * @see #setFpath(java.lang.String)
	 */
	public String getFpath() {
		return DataUtil.toString(super.getByIndex(INDEX_FPATH, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getFpath <em>Fpath</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Fpath</em>' attribute.
	 * @see #getFpath()
	 */
	public void setFpath(String fpath) {
		super.setByIndex(INDEX_FPATH, fpath);
	}
