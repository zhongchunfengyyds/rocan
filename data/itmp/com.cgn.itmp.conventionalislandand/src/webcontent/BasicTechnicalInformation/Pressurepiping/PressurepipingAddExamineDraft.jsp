    ...
    <body>
            ...
            <input class="nui-hidden" id="equiaxialgraphfileid" name="pressurepiping.equiaxialgraphfileid"/>
                <table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
                    <tr>
                        ...
                        <td colspan="1">
                             <input class="nui-dictcombobox"  emptyText="请选择管类" requiredErrorText="系统不能为空" dictTypeId="YLGL" name="pressurepiping.tubetype" style="width: 100%"/>
                        </td>
        ...
        <!-- <fieldset style="border:solid 1px #aaa;position:relative;margin:5px 2px 0px 2px;"> -->
            <legend>
               ...
               <!--  <div title="汽水管件信息" id="form_qsgjxx" style="width:100%;">
                    <div class="nui-toolbar" style="border-bottom:0;padding:0px;"> -->
                   <div id="form_qsgjxx" style="width:100%;">
                    	<div>
                    ...
                    <!-- <div class="nui-fit"> -->
                    <div id="grid_0" class="nui-datagrid" style="width:100%;height:150px;" sortField="pipesegmentno" sortOrder="asc" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="false" multiSelect="true" editNextOnEnterKey="true" allowCellValid="true"
            ...
            <legend>
               <a id="qt" onclick="qt()">-其他信息</a>
                   ...
                   <div id="other"> 
                    ...
                    <div id="grid_1" class="nui-datagrid" style="width:50%;height:150px;float:left" sortField="weldnumber" sortOrder="asc" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="false" multiSelect="true" editNextOnEnterKey="true" oncellvalidation="onCellValidation" allowCellValid="true">
                        <div property="columns">
<!--                             <div type="checkcolumn"> -->
<!--                             </div> -->
                    ...
                    <div id="grid_2" class="nui-datagrid" style="width:50%;height:150px;float:left" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="false" multiSelect="true" editNextOnEnterKey="true" oncellvalidation="onCellValidation" allowCellValid="true">
                        <div property="columns">
<!--                             <div type="checkcolumn"> -->
<!--                             </div> -->
							 <div type="indexcolumn">
            ...
            <legend>
                ...
                <div title="设备历史信息" id="form_sbls" style="width:100%;">
                    <div>
                        <table style="width:100%;">
                            <tr>
                                <td style="width:10%;">
                    ...
                    <div id="grid_3" class="nui-datagrid" style="width:100%;height:150px;float:left" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="false" multiSelect="true" editNextOnEnterKey="true" onCellBeginEdit="onCellBeginEdit">
                        <div property="columns">
<!--                             <div type="checkcolumn"> -->
<!--                             </div> -->
							 <div type="indexcolumn">
...
//             }
			...
			var grid0 = nui.get("grid_0");
               ...
               if(form.isValid()==false){
                ...
                var urlStr = "com.cgn.itmp.conventionalislandand.pressurepipingbiz.endaddworkBoiler.biz.ext";
