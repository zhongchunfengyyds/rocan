            ...
            <input class="nui-hidden" id="fildid" name="pressurepiping.equipmenthistoryinfos.fildid"/>
                <table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
                    <tr>
                        ...
                        <td colspan="1">
                            <input id="system" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请选择系统" requiredErrorText="系统不能为空" class="nui-dictcombobox" dictTypeId="YLGDXT" style="width:100%" name="pressurepiping.system"/>
                        </td>
                        <td class="form_label">
                            管类:
                        </td>
                        <td colspan="1">
                             <input class="nui-dictcombobox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请选择管类" requiredErrorText="系统不能为空" dictTypeId="YLGL" name="pressurepiping.tubetype" style="width: 100%"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <input class="nui-textbox" emptyText="请输入流程图图号"  required="true" onvalidation="hasIllegalChar(e,255,true,true)" requiredErrorText="图号不能为空"  style="width: 100%" name="pressurepiping.flowchartno"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                    ...
                    <tr>
                        ...
                        <input class="nui-textbox" emptyText="请输入流程图版本" onvalidation="hasIllegalChar(e,255,false,true)"  style="width: 100%" required="true" requiredErrorText="版本不能为空" name="pressurepiping.flowchartversion"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                    ...
                    <tr>
                        ...
                        <td class="form_label" rowspan="2">
					             图号:
					                  ...
					                  <td colspan="2" rowspan="2">
				                             <input class="nui-textbox" emptyText="请输入等轴图图号" required="true" onvalidation="hasIllegalChar(e,255,true,true)" requiredErrorText="图号不能为空" style="width: 100%" name="pressurepiping.equiaxialgraphno"/>
                    				  </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                        	<input id="date2" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" class="nui-datepicker" name="pressurepiping.inspectiondate" format="yyyy-MM-dd"/>
...
<!--                                     <a class="nui-button " onclick="gridReload('grid_0')" tooltip="刷新"> -->
<!--                                         刷新&nbsp; -->
<!--                                     </a> -->
                                </td>
                            </tr>
...
<!--                                     <a class="nui-button " onclick="gridReload('grid_1')"  tooltip="刷新"> -->
<!--                                         		刷新&nbsp; -->
<!--                                     </a> -->
                                </td>
                                <td style="width:10%;">
...
<!--                                     <a class="nui-button " onclick="gridReload('grid_2')"  tooltip="刷新"> -->
<!--                                         刷新&nbsp; -->
<!--                                     </a> -->
                                </td>
                            </tr>
                        ...
                        <div property="columns">
                           ...
                           <div field="jd" allowSort="true" align="left" headerAlign="center" width="" visible="false">
                            ...
                            <div field="weldnumber" allowSort="true" align="left" headerAlign="center" width="">
                                焊缝编号
                                <input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,true,true)" name="weldnumber"  requiredErrorText="焊缝编号不能为空"  property="editor" required="true" visible="true"/>
                            </div>
...
<!--                                      <a class="nui-button " onclick="gridReload('grid_3')" tooltip="刷新"> -->
<!--                                         		刷新&nbsp; -->
<!--                                     </a> -->
                                </td>
                            </tr>
                    ...
                    <div 
                        ...
                        <div property="columns">
                            ...
                            <div field="deviceversion" allowSort="true" align="left" headerAlign="center" width="">
                                设备版本
                                <input class="nui-textbox" enabled="true" name="deviceversion" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true"/>
                            </div>
...
<!--             </fieldset> -->
			...
			<td class="form_label">校核人员</td>
					 <td colspan="3">
                        <input  class="nui-buttonedit" readonly="readonly" onclick="onButtonSelectPerson" id="jhry"  name="pressurepiping.jhry"  textField="empname" style="width:100%" url=""  required="true" requiredErrorText="请选择校核人员"  valueField="empid"/>
                    </td>
				</tr>
				<tr  class="changeReasons">
				<td class="form_label" colspan="1"
					style="width: 16% !important; text-align: center">选择抄送人员:</td>
				<td colspan="3"><input property="editor" name="pressurepiping.ccry" id="ccry" multi="true"
...
//             }
           ...
           /*  pipename1=data.pipenumber; */
               ...
               if(form.isValid()==false){
		        ...
		        allInfo.processInstName = "基础技术信息_压力管道_修改";
		        allInfo.processInstDesc = "基础技术信息_压力管道_修改";
