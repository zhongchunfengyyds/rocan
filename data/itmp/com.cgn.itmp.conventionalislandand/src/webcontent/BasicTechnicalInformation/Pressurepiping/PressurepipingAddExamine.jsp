            ...
            <input class="nui-hidden" id="fildid" name="pressurepiping.equipmenthistoryinfos.fildid"/>
                <table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" id="gdbh" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请输入管道编号" requiredErrorText="管道编号不能为空" style="width: 100%" name="pressurepiping.pipenumber"/>
                        </td>
                        <td class="form_label">
                            管道名称:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请输入管道名称" requiredErrorText="管道名称不能为空" style="width: 100%" name="pressurepiping.pipename"/>
                        </td>
                        <td class="form_label">
                            FAC定级:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请输入FAC定级" requiredErrorText="FAC定级不能为空" style="width: 100%" name="pressurepiping.faclevel"/>
                        </td>
                        <td class="form_label">
                            管道GC级别:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请输入管道GC级别"  requiredErrorText="管道GC级别不能为空" style="width: 100%" name="pressurepiping.pipegclevel"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.nominaldiameter"/>
                        </td>
                        <td class="form_label">
                            外径mm:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.externaldiameter"/>
                        </td>
                        <td class="form_label">
                            壁厚mm:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.wallthickness"/>
                        </td>
                        <td class="form_label">
                            版本号:
                        </td>
                        ...
                        <input class="nui-textbox" emptyText="请输入流程图图号" onvalidation="hasIllegalChar(e,255,true,true)" onvalidation="hasIllegalChar(e,255,true,true)"  required="true" requiredErrorText="图号不能为空"  style="width: 100%" name="pressurepiping.flowchartno"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipelinestartingpoint"/>
                        </td>
                        <td class="form_label">
                            管道终点:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipelineendingpoint"/>
                        </td>
                        <td class="form_label">
                            设计压力MPa:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.designpressure"/>
                        </td>
                        <td class="form_label">
                            工作压力MPa:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.workpressure"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.designtemperature"/>
                        </td>
                        <td class="form_label">
                            工作温度:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.worktemperature"/>
                        </td>
                        <td class="form_label">
                            输送介质:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.conveyingmedium"/>
                        </td>
                        <td class="form_label">
                            管道材质:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipematerial"/>
                        </td>
                        <td class="form_label" rowspan="2">
                        ...
                        <input class="nui-textbox" emptyText="请输入流程图版本" onvalidation="hasIllegalChar(e,255,true,true)" style="width: 100%" required="true" requiredErrorText="版本不能为空" name="pressurepiping.flowchartversion"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipematerialcode"/>
                        </td>
                        <td class="form_label">
                            管道上主设备:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipemainequipment"/>
                        </td>
                        <td class="form_label">
                            管道功能:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipefunction"/>
                        </td>
                        <td class="form_label">
                            流速度kg/s:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.flowspeed"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.materialscontainingcr"/>
                        </td>
                        <td class="form_label">
                            化学PH(25%):
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.chemicalph"/>
                        </td>
                        <td class="form_label">
                            焊口数量:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.weldingjointsnumber"/>
                        </td>
                        <td class="form_label">
                            三通数量:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.threewayquantity"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.bigandsmallheadsnumber"/>
                        </td>
                        <td class="form_label">
                            弯头数量:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.elbownumber"/>
                        </td>
                        <td class="form_label">
                            管道长度:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.pipelinelength"/>
                        </td>
                        <td class="form_label">
                            有无保温:
                        </td>
                        <td colspan="1">
                            <input class="nui-dictcombobox" dictTypeId="option" onvalidation="hasIllegalChar(e,255,false,true)" style="width: 100%" name="pressurepiping.heatpreservation"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="form_label">
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.valvecondition"/>
                        </td>
                        <td class="form_label">
                            孔板情况:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.orificecondition"/>
                        </td>
                        <td class="form_label">
                            RCM内容:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.rcmcontent"/>
                        </td>
                        <td class="form_label">
                            RCM推荐周期:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.rcmrecommendedperiod"/>
                        </td>
                        <td class="form_label" rowspan="2">
					             图号:
					                  </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.safetylevel"/>
                        </td>
                        <td class="form_label">
                            设计单位:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.designunit"/>
                        </td>
                        <td class="form_label">
                            安装单位:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.installationunit"/>
                        </td>
                        <td class="form_label">
                            安装竣工日期:
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurepiping.inspectioninstitution"/>
                        </td>
                        <td class="form_label">
                            检验日期:
                        </td>
        ...
        <!-- <fieldset style="border:solid 1px #aaa;position:relative;margin:5px 2px 0px 2px;"> -->
            <legend>
                ...
                <div title="汽水管件信息" id="form_qsgjxx">
                    ...
                    <!-- <div class="nui-fit"> -->
                    <div id="grid_0" class="nui-datagrid" style="width:100%;height:150px;" sortField="pipesegmentno" sortOrder="asc" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" allowCellValid="true"
					oncellvalidation="onCellValidation">
                        <div property="columns">
                            ...
                            <div field="pipesegmentno" allowSort="true" align="left" headerAlign="center" width="">
                                管段编号
                                <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" requiredErrorText="管段编号不能为空" name="pipesegmentno" property="editor"/>
                            </div>
                            <div field="pipefittingpositionno" allowSort="true" align="left" headerAlign="center" width="">
                                管件位置号
                                <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)"  requiredErrorText="管件位置号不能为空" name="pipefittingpositionno" property="editor"/>
                            </div>
                            <div field="pipetype" allowSort="true" align="left" headerAlign="center" width="">
                                管件类型
                                <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" requiredErrorText="管件类型不能为空" name="pipetype" property="editor"/>
                            </div>
                            <div field="fittingnumber" allowSort="true" align="left" headerAlign="center" width="">
                                管件编号
                                <input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" requiredErrorText="管件编号不能为空" name="fittingnumber" property="editor"/>
                            </div>
                            <div field="pipeouterdiameter" allowSort="true" align="left" headerAlign="center" width="">
                                管件外径mm
                                <input class="nui-textbox" name="pipeouterdiameter" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="pipewallthickness" allowSort="true" align="left" headerAlign="center" width="">
                                管件壁厚mm
                                <input class="nui-textbox" name="pipewallthickness" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="pipelength" allowSort="true" align="left" headerAlign="center" width="">
                                管件长度mm
                                <input class="nui-textbox" name="pipelength" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="pipematerial" allowSort="true" align="left" headerAlign="center" width="">
                                管件材质
                                <input class="nui-textbox" name="pipematerial" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="materialstandard" allowSort="true" align="left" headerAlign="center" width="">
                                材质标准
                                <input class="nui-textbox" name="materialstandard" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="dimensionaltolerance" allowSort="true" align="left" headerAlign="center" width="">
                                尺寸公差
                                <input class="nui-textbox" name="dimensionaltolerance" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="manufacturingform" allowSort="true" align="left" headerAlign="center" width="">
                                制造形式
                                <input class="nui-textbox" name="manufacturingform" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="elbowradius" allowSort="true" align="left" headerAlign="center" width="">
                                弯头半径
                                <input class="nui-textbox" name="elbowradius" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="elbowangle" allowSort="true" align="left" headerAlign="center" width="">
                                弯头角度
                                <input class="nui-textbox" name="elbowangle" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="branchangle" allowSort="true" align="left" headerAlign="center" width="">
                                支管角度
                                <input class="nui-textbox" name="branchangle" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="branchpipenumber" allowSort="true" align="left" headerAlign="center" width="">
                                支管管道号
                                <input class="nui-textbox" name="branchpipenumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="furnacelotnumber" allowSort="true" align="left" headerAlign="center" width="">
                                炉批号
                                <input class="nui-textbox" name="furnacelotnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="materialcontainscr" allowSort="true" align="left" headerAlign="center" width="">
                                材料含Cr%
                                <input class="nui-textbox" name="materialcontainscr" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                            <div field="remarks" allowSort="true" align="left" headerAlign="center" width="">
                                备注
                                <input class="nui-textbox" name="remarks" onvalidation="hasIllegalChar(e,255,false,true)" property="editor"/>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <legend>
               <a id="qt" onclick="qt()">-其他信息</a>
                   ...
                   <div id="other"> 
                    ...
                    <div id="grid_1" class="nui-datagrid" style="width:50%;height:150px;float:left" sortField="weldnumber" sortOrder="asc" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" oncellvalidation="onCellValidation" allowCellValid="true">
                        <div property="columns">
                            <div type="checkcolumn">
                            </div>
                            <div field="jd" allowSort="true" align="left" headerAlign="center" width="" visible="false">
                            ...
                            <div field="weldnumber" allowSort="true" align="left" headerAlign="center" width="">
                                焊缝编号
                                <input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,true,true)" name="weldnumber" property="editor" requiredErrorText="焊缝编号不能为空" required="true" visible="true"/>
                            </div>
                            <div field="characteristicparameter" allowSort="true" align="left" headerAlign="center" width="">
                                特性参数
                                <input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,true,true)" name="characteristicparameter" requiredErrorText="特性参数不能为空" property="editor" required="true" visible="true"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="grid_2" class="nui-datagrid" style="width:50%;height:150px;float:left" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" oncellvalidation="onCellValidation" allowCellValid="true">
                        <div property="columns">
                            ...
                            <div field="element" allowSort="true" align="left" headerAlign="center" width="">
                                元素
                                <input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,true,true)" name="element" property="editor" requiredErrorText="元素不能为空" required="true" visible="true"/>
                            </div>
                            <div field="contents" allowSort="true" align="left" headerAlign="center" width="">
                                含量
                                <input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,true,true)" name="contents" property="editor" requiredErrorText="含量不能为空" required="true" visible="true"/>
                            </div>
                        </div>
                    </div>
 			</div>
                    ...
                    <div id="grid_3" class="nui-datagrid" style="width:100%;height:150px;" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" onCellBeginEdit="onCellBeginEdit">
                        <div property="columns">
                            ...
                            <div field="enteringperson" allowSort="true" align="left" headerAlign="center" width="">
                                录入人
                                <input class="nui-textbox" enabled="true" name="enteringperson" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true"/>
                            </div>
...
<!--                                  <input type="file" id="fj" name="file" multiple onchange="uploadFile(event,id)" /> 	 --%>
        ...
        <script type="text/javascript">
			...
			function getPressurepiping(){
				...
				$.ajax({
				url : "com.cgn.itmp.conventionalislandand.pressurepipingbiz.getPressurepipingWork.biz.ext",//该方法可复用
				type : 'POST',
				data : json,
				async :false,
				cache : false,
...
//             }
			...
			function onSubmit(){
				...
				var urlStr = "com.cgn.itmp.conventionalislandand.pressurepipingbiz.updateEntity.biz.ext";
	    		form.validate();
...
//                 data.base=jdid;
//                 data.crew=jzid;
                data.pressurepiping.processInstId=processInstId;
