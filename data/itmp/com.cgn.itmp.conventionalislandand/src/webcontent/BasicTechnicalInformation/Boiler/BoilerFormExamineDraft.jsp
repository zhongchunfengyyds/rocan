    	...
    	<div id="form1">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                    <input class="nui-combobox" name="boiler.jz"  readonly="readonly" url=""
                        dataField="jsonObject" id="jz" textField="name" valueField="id" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        设备类型:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly"  name="boiler.equipmenttype" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.equipmentname" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        系统:
                    </td>
                    <td colspan="1">
                        <input id="system"  readonly="readonly" 
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly" name="boiler.equipmentnumber" style="width:100%"/>
                    </td>
            </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly"  name="boiler.equipmentmodel" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        锅炉登记卡:
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.mainmaterial" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        主体厚度(mm):
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly" name="boiler.mainbodythickness" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.installationunit" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        测厚布点图:
                    </td>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.propertyunit" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.useunit" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        组织机构代码:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.organizationcode" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        邮政编码:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.postalcode" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.ratedoutput" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        额定压力（Mpa）:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.ratedpressure" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        额定温度（℃）:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.ratedtemperature" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.workingpressure" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        出口温度（℃）:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.outlettemperature" style="width:100%"/>
                    </td>
                    <td class="form_label">
                        回流温度（℃）:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox"  readonly="readonly" name="boiler.refluxtemperature" style="width:100%"/>
                    </td>
             	</tr>
                <tr>       
                    <td class="form_label">
                    ...
                    <td colspan="5">
                        <input class="nui-textarea"  readonly="readonly" name="boiler.remarks" style="width:100%"/>
                    </td>
                    <input value="0" class="nui-hidden" name="boiler.isdel" />
                    <input class="nui-hidden" id="relationid" />
                </tr>
     ...
     <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
       ...
       function setEna(){
		...
		function fileHref(){
			...
			var fileRealName = nui.get('equipmentdiagramname').value;//eommfile
			var fileId = nui.get('equipmentdiagramfileid').value;//eommfileid
		...
		function load(fileId,fileRealName) {
            ...
            nui.get("#equipmentdiagramname").setEnabled(false);
            nui.get("#thicknessmeasurementpointlayoutname").setEnabled(false);
			...
			function getBoiler(){
				...
				success : function(text) {
					...
					form.setData(temple);
					if(modelFlag=="1"){
						nui.get("sqr").setValue(boiler.applicant);
						nui.get("sqsj").setValue(boiler.applicanttime.split(".")[0]);
					}else{
						nui.get("relationid").setValue(boiler.relationid);
						nui.get("sqr").setValue(boiler.applicant);
						nui.get("sqsj").setValue(boiler.applicanttime.split(".")[0]);
					}
				}
			...
			function onSubmit(){
	            ...
	            var urlStr = "com.cgn.itmp.conventionalislandand.boilerbiz.endaddworkBoiler.biz.ext";
	            if(modelFlag=="1"){
 					data.boiler.isdel="0";
// 					urlStr = "com.cgn.itmp.basecommon.Common.updateEntity.biz.ext";
					data.entityType="com.cgn.itmp.inspectcomponentmanage.conventionalislandand.boiler.Boiler";
					data.data=data.boiler;
				}else{
					urlStr = "com.cgn.itmp.conventionalislandand.boilerbiz.endworkBoiler.biz.ext";
					data.boiler.isdel="0";
					data.boiler.relationid=nui.get("relationid").value;
	            	data.data=data.boiler;
				}
	    		...
	    		$.ajax({
                    ...
                    function setFormData(data){
						...
						nui.get("fileName1").setText(json.boiler.fileRealName1);
						nui.get("fileName2").setText(json.boiler.fileRealName2);
