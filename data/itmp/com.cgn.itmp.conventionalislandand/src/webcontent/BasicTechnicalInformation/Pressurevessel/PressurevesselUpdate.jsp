...
<script type="text/javascript" src="<%=request.getContextPath()%>/coframe/tools/widget/jquery.form.min.js"></script>
	...
	<body>
		<div id="dataform1" style="padding-top:5px;">
			...
			<input class="nui-hidden" name="pressurevessel.isdel"/>
				...
				<div id="form0">
					<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
						<tr>
							...
							<td colspan="1"  style="width:150px;">
								<input id="jd" class="nui-combobox" name="pressurevessel.jd" url="com.cgn.itmp.basecommon.DictionaryOperation.getJdDicInfo.biz.ext"
								 textField="name" required="true" emptyText="请选择电站" requiredErrorText="电站不能为空" readonly="readonly" dataField="jsonObject"
							...
							<td colspan="1"  style="width:150px;">
								<input class="nui-combobox" name="pressurevessel.jz" emptyText="请选择机组" emptyText="请选择机组" required="true"
								 requiredErrorText="机组不能为空" dataField="jsonObject" id="jz" textField="name" url="" valueField="id" style="width: 100%" />
							</td>
							<td class="form_label" style="width:80px;">
								系统:
							</td>
							<td colspan="1" style="width:150px;">
								<input id="system" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请选择系统" requiredErrorText="系统不能为空" class="nui-dictcombobox" dictTypeId="YLRQXT" style="width:100%" name="pressurevessel.system" />
							</td>
							<td class="form_label" rowspan="3" style="width:80px;">
								设备图:
							</td>
							<td class="form_label" style="width:80px;">
											上传图纸:
								        ...
								        <div class="progress-item"></div>
											...
											<input class="nui-textbox" style="width:100%" requiredErrorText="设备图不能为空" id="equipmentdrawnumbername" name="pressurevessel.equipmentdrawnumber" />
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" id="ssbbh" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入设备编号" requiredErrorText="设备编号不能为空" style="width:100%"
								 name="pressurevessel.equipmentnumber" style="width:100%" />
							</td>
							<td class="form_label">
								设备名称:
							</td>
							<td colspan="1">
								<input class="nui-textbox" required="true" onvalidation="hasIllegalChar(e,255,true,true)" emptyText="请输入设备名称" requiredErrorText="设备名称不能为空" style="width:100%"
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.versionnumber" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入版本号"
								 requiredErrorText="版本号不能为空" style="width:100%" />
							</td>
							<td class="form_label">
											图号:
										</td>
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.containercategories" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入容器类别"
								 requiredErrorText="容器类别不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								容器品种:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.containervariety" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入容器品种"
								 requiredErrorText="容器品种不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								所在车间分厂:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.workshopbranch" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入所在车间分厂"
								 requiredErrorText="所在车间分厂不能为空" style="width:100%" />
							</td>
							<td class="form_label">
											版本:
										</td>
										<td colspan="1">
											<input class="nui-textbox" style="width: 100%" onvalidation="hasIllegalChar(e,255,false,true)" name="pressurevessel.equipmentdrawversion" />
										</td>
						</tr>
					</table>
				</div>
				...
				<div id="form1">
					<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.containerinnerdiameter" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入容器内径"
								 requiredErrorText="容器内径不能为空" style="width:100%" />
							</td>
							<td class="form_label" colspan="2" style="width:140px;">
								容器容积:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.containervolume" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入容器容积"
								 requiredErrorText="容器容积不能为空" style="width:100%" />
							</td>
							<td class="form_label" colspan="2" style="width:140px;">
								容器高(长):
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.containerheight" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入容器高(长)"
								 requiredErrorText="容器高(长)不能为空" style="width:100%" />
							</td>
							<td class="form_label" colspan="2" style="width:140px;">
								结构型式:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.structuretype" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入结构型式"
								 requiredErrorText="结构型式不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.headtype" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入封头型式" requiredErrorText="封头型式不能为空"
								 style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								支座型式:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.supportform" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入支座型式"
								 requiredErrorText="支座型式不能为空" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								壳体重量:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.shellweight" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								内件重量:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.innerweight" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label" colspan="2">
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.fillingweight" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								有无保温绝热:
							</td>
							<td colspan="1">
								<input class="nui-combobox" name="pressurevessel.whetherthermalinsulation" required="true" valueField="id"
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.finishedworkingpressure" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								工作压力(管程):
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.tubeprocessworkingpressure" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label" colspan="2">
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.oxygenmeasurementmethod" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								罐车牌号:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.tanknumber" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								罐车结构型式:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.tankerstructure" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								罐车底盘号码:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.tankcarchassisnumber" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodymaterialcylinder" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入筒体"
								 requiredErrorText="筒体不能为空" style="width:100%" />
							</td>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodythicknesscylinder" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入筒体"
								 requiredErrorText="筒体不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="4">
								工作介质:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.workingmediumshell" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="4">
								设计压力(Mpa):
							</td>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designpressureshellside" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodymaterialhead" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入封头"
								 requiredErrorText="封头不能为空" style="width:100%" />
							</td>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodythicknesshead" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入封头"
								 requiredErrorText="封头不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								管程:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.workingmediumtube" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								管程:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designpressuretube" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodymateriallining" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label">
								内衬:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodythicknesslining" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.workingmediumjacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label">
								夹套:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designpressurejacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label">
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodymaterialjacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label">
								夹套:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.bodythicknessjacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designtemperatureshellside" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="3">
								工作温度(℃):
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.worktemperatureshellside" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="3">
								腐蚀裕量:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.corrosionmargincylinder" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入筒体"
								 requiredErrorText="筒体不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designtemperaturetube" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								管程:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.worktemperaturetube" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								封头:
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.corrosionmarginhead" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入封头"
								 requiredErrorText="封头不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.designtemperaturejacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label">
								夹套:
							</td>
							<td colspan="1">
								<input class="nui-textbox" name="pressurevessel.worktemperaturejacket" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
							</td>
						</tr>
		...
		<!-- <fieldset style="border:solid 1px #aaa;position:relative;margin:5px 2px 0px 2px;"> -->
			...
			<div title="壳体纵焊缝">
				...
				<div id="grid_0" class="nui-datagrid" style="width:100%;height:150px;" sortField="slweldnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.longitudinalwelds" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true" oncellvalidation="onCellValidation" allowCellValid="true">
					<div property="columns">
						...
						<div field="slweldnumber" allowSort="true" align="left"  headerAlign="center" width="">
							壳体纵焊缝编号
							<input class="nui-textbox" name="slweldnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="slweldparameters" allowSort="true" align="left" headerAlign="center" width="">
							壳体纵焊缝特性参数
							<input class="nui-textbox" name="slweldparameters" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
					</div>
				</div>
			</div>
			...
			<div title="壳体环焊缝">
				...
				<div id="grid_1" class="nui-datagrid" style="width:100%;height:150px;" sortField="sgweldnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.shellgirthwelds" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
			...
			<div title="连接管道">
				...
				<div id="grid_2" class="nui-datagrid" style="width:100%;height:150px;" sortField="connectpipenumber" sortOrder="asc"  showPager="false" sortMode="client"
				 dataField="pressurevessel.connectingpipes" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="connectpipenumber" allowSort="true" align="left" headerAlign="center" width="">
							连接管道编号
							<input class="nui-textbox" onvalidation="hasIllegalChar(e,255,false,true)" enabled="true" name="connectpipenumber" property="editor" required="false" visible="true" />
						</div>
						<div field="connectpipeparameter" allowSort="true" align="left" headerAlign="center" width="">
							连接管道特性参数
							<input class="nui-textbox" onvalidation="hasIllegalChar(e,255,false,true)" enabled="true" name="connectpipeparameter" property="editor" required="false" visible="true" />
						</div>
					</div>
				</div>
			</div>
...
<!-- 		<fieldset style="border:solid 1px #aaa;position:relative;margin:5px 2px 0px 2px;"> -->
			...
			<div title="安全阀">
				...
				<div id="grid_3" class="nui-datagrid" style="width:100%;height:150px;" sortField="svnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.safetyvalves" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="svnumber" allowSort="true" align="left" headerAlign="center" width="">
							安全阀编号
							<input class="nui-textbox" name="svnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svmodel" allowSort="true" align="left" headerAlign="center" width="">
							安全阀型号
							<input class="nui-textbox" name="svmodel" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svinstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							安全阀安装位置
							<input class="nui-textbox" name="svinstallationlocation" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svsettingpressure" allowSort="true" align="left" headerAlign="center" width="">
							安全阀整定压力
							<input class="nui-textbox" name="svsettingpressure" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svnominalpressure" allowSort="true" align="left" headerAlign="center" width="">
							安全阀公称压力
							<input class="nui-textbox" name="svnominalpressure" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svopeningpressure" allowSort="true" align="left" headerAlign="center" width="">
							安全阀开启压力
							<input class="nui-textbox" name="svopeningpressure" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svsealingpressure" allowSort="true" align="left" headerAlign="center" width="">
							安全阀密封压力
							<input class="nui-textbox" name="svsealingpressure" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svnominaldiameter" allowSort="true" align="left" headerAlign="center" width="">
							安全阀公称通径
							<input class="nui-textbox" name="svnominaldiameter" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svquantity" allowSort="true" align="left" headerAlign="center" width="">
							安全阀数量
							<input class="nui-textbox" name="svquantity" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="svmanufacturer" allowSort="true" align="left" headerAlign="center" width="">
							安全阀制造厂家
							<input class="nui-textbox" name="svmanufacturer" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
					</div>
				</div>
			</div>
			<div title="压力表">
				...
				<div id="grid_4" class="nui-datagrid" style="width:100%;height:150px;" sortField="pgnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.pressuregauges" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="pgnumber" allowSort="true" align="left" headerAlign="center" width="">
							压力表编号
							<input class="nui-textbox" name="pgnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pgmodel" allowSort="true" align="left" headerAlign="center" width="">
							压力表型号
							<input class="nui-textbox" name="pgmodel" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pggerange" allowSort="true" align="left" headerAlign="center" width="">
							压力表量程
							<input class="nui-textbox" name="pggerange" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pginstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							压力表安装位置
							<input class="nui-textbox" name="pginstallationlocation" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pgaccuracy" allowSort="true" align="left" headerAlign="center" width="">
							压力表精度(误差)
							<input class="nui-textbox" name="pgaccuracy" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pgquantity" allowSort="true" align="left" headerAlign="center" width="">
							压力表数量
							<input class="nui-textbox" name="pgquantity" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="pgmanufacturer" allowSort="true" align="left" headerAlign="center" width="">
							压力表制造厂家
							<input class="nui-textbox" name="pgmanufacturer" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
					</div>
				</div>
			</div>
			...
			<div title="液位计">
				...
				<div id="grid_5" class="nui-datagrid" style="width:100%;height:150px;" sortField="lgnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.levelgauges" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="lgnumber" allowSort="true" align="left" headerAlign="center" width="">
							液位计编号
							<input class="nui-textbox" name="lgnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="lgmodel" allowSort="true" align="left" headerAlign="center" width="">
							液位计型号
							<input class="nui-textbox" name="lgmodel" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="lggerange" allowSort="true" align="left" headerAlign="center" width="">
							液位计量程
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="lggerange" property="editor" required="false" visible="true" />
						</div>
						<div field="lginstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							液位计安装位置
							<input class="nui-textbox" name="lginstallationlocation" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="lgaccuracy" allowSort="true" align="left" headerAlign="center" width="">
							液位计精度(误差)
							<input class="nui-textbox" name="lgaccuracy" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="lgquantity" allowSort="true" align="left" headerAlign="center" width="">
							液位计数量
							<input class="nui-textbox" name="lgquantity" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
						<div field="lgmanufacturer" allowSort="true" align="left" headerAlign="center" width="">
							液位计制造厂家
							<input class="nui-textbox" name="lgmanufacturer" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" />
						</div>
					</div>
				</div>
			</div>
			...
			<div title="测温仪表">
				...
				<div id="grid_6" class="nui-datagrid" style="width:100%;height:150px;" sortField="tinumber" sortOrder="asc" showPager="false" sortMode="client"
				 dataField="pressurevessel.temperatureinstruments" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="tinumber" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表编号
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="tinumber" property="editor" required="false" visible="true" />
						</div>
						<div field="timodel" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表型号
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="timodel" property="editor" required="false" visible="true" />
						</div>
						<div field="tigerange" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表量程
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="tigerange" property="editor" required="false" visible="true" />
						</div>
						<div field="tiinstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表安装位置
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="tiinstallationlocation" property="editor" required="false"
							 visible="true" />
						</div>
						<div field="tiaccuracy" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表精度(误差)
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="tiaccuracy" property="editor" required="false" visible="true" />
						</div>
						<div field="tiquantity" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表数量
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="tiquantity" property="editor" required="false" visible="true" />
						</div>
						<div field="timanufacturer" allowSort="true" align="left" headerAlign="center" width="">
							测温仪表制造厂家
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="timanufacturer" property="editor" required="false" visible="true" />
						</div>
					</div>
				</div>
			</div>
			...
			<div title="爆破片">
				...
				<div id="grid_7" class="nui-datagrid" style="width:100%;height:150px;" sortField="rdnumber" sortOrder="asc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.rupturediscs" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="rdinstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							爆破片安装位置
							<input class="nui-textbox" onvalidation="hasIllegalChar(e,255,false,true)" enabled="true" name="rdinstallationlocation" property="editor" required="false"
							 visible="true" />
						</div>
			...
			<input class="nui-hidden" name="uuid"/>
				<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="registrationdate" style="width:100%" />
						</td>
						<td class="form_label">
							设备注册代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="updatedateday" style="width:100%" />
						</td>
						<td class="form_label">
							产权单位及代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker"  format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="manufacturedate" style="width:100%" />
						</td>
						<td class="form_label">
							设计单位及代码:
						</td>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="designdate" style="width:100%" />
						</td>
						<td class="form_label">
							设计规范:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="installationdate" style="width:100%" />
						</td>
						<td class="form_label">
							投用日期:
						</td>
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="usedate" style="width:100%" />
						</td>
						<td class="form_label">
							监督单位及代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="inspectiondate" style="width:100%" />
						</td>
						<td class="form_label">
							检验类别:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="nextinspectiondate" style="width:100%" />
						</td>
						<td class="form_label">
							事故类别:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="accidentdate" style="width:100%" />
						</td>
						<td class="form_label">
							事故处理:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" showClose="true" oncloseclick="this.setValue(null);" allowInput="false" name="equipmentchangedate" style="width:100%" />
						</td>
						<td class="form_label">
							变更承担单位:
						</td>
...
<!-- 		<fieldset style="border:solid 1px #aaa;position:relative;margin:5px 2px 0px 2px;"> -->
			...
			<div title="设备历史信息" id="form5">
				...
				<div id="grid_8" class="nui-datagrid" style="width:100%;height:150px;" sortField="enteringtime" sortOrder="desc" showPager="false" sortMode="client" 
				 dataField="pressurevessel.equipmenthistoryinfos" allowCellEdit="true" allowCellSelect="true" multiSelect="true"
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
...
<table id="form_sh">
			...
			<td class="form_label">校核人员</td>
					 <td colspan="3">
                        <input  class="nui-buttonedit" readonly="readonly" onclick="onButtonSelectPerson" id="jhry"  name="pressurevessel.jhry"  textField="empname" style="width:100%" url=""  required="true" requiredErrorText="请选择校核人员"  valueField="empid"/>
                    </td>
				</tr>
...
//             }
			...
			function saveData(finishFirstActivityId) {
		        ...
		        allInfo.processInstName = "基础技术信息_压力容器_修改";
		        allInfo.processInstDesc = "基础技术信息_压力容器_修改";
				...
				$.ajax({
					...
					success: function(text) {
						...
						if (returnJson.exception == null) {
							...
							nui.get("#adminSave").setEnabled(true);//置灰色
