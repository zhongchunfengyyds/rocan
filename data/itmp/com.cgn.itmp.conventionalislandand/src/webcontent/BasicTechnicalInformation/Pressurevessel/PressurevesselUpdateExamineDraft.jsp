				...
				<div id="form0">
					<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
						<tr>
							...
							<td colspan="1">
								<input class="nui-combobox" name="pressurevessel.jz" readonly="readonly" emptyText="请选择机组" emptyText="请选择机组" 
							...
							<td colspan="1">
								...
								class="nui-dictcombobox" dictTypeId="YLRQXT" style="width:100%" name="pressurevessel.system" />
							</td>
								...
								<table style="height:100px;width: 100%" align="left">
									<tr>
					                  ...
					                  <td colspan="1" id="sbt">
											...
											<input class="nui-textbox" style="width:100%"  readonly="readonly" id="equipmentdrawnumbername" name="pressurevessel.equipmentdrawnumber" />
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" id="ssbbh"  readonly="readonly"  emptyText="请输入设备编号" requiredErrorText="设备编号不能为空" style="width:100%"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly"  emptyText="请输入设备名称" requiredErrorText="设备名称不能为空" style="width:100%"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.versionnumber"  emptyText="请输入版本号"
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.containercategories"  emptyText="请输入容器类别"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.containervariety"  emptyText="请输入容器品种"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.workshopbranch"  emptyText="请输入所在车间分厂"
				...
				<div id="form1">
					<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.containerinnerdiameter"  emptyText="请输入容器内径"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.containervolume"  emptyText="请输入容器容积"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.containerheight"  emptyText="请输入容器高(长)"
							...
							<td colspan="1">
								<input class="nui-textbox"  readonly="readonly" name="pressurevessel.structuretype"  emptyText="请输入结构型式"
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.headtype"  emptyText="请输入封头型式" requiredErrorText="封头型式不能为空"
								 style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								支座型式:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.supportform"  emptyText="请输入支座型式"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.shellweight" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								内件重量:
							</td>
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.innerweight" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label" colspan="2">
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.fillingweight" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								有无保温绝热:
							</td>
							<td colspan="1">
								<input class="nui-combobox" readonly="readonly" name="pressurevessel.whetherthermalinsulation"  valueField="id"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.finishedworkingpressure" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								工作压力(管程):
							</td>
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.tubeprocessworkingpressure" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label" colspan="2">
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.oxygenmeasurementmethod" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
								罐车牌号:
							</td>
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodymaterialcylinder"  emptyText="请输入筒体"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodythicknesscylinder"  emptyText="请输入筒体"
								 requiredErrorText="筒体不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="4">
								工作介质:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.workingmediumshell"  emptyText="请输入壳程"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designpressureshellside"  emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodymaterialhead"  emptyText="请输入封头"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodythicknesshead"  emptyText="请输入封头"
								 requiredErrorText="封头不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								管程:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.workingmediumtube"  emptyText="请输入管程"
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designpressuretube"  emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodymateriallining" style="width:100%" />
							</td>
							<td class="form_label">
								内衬:
							</td>
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.bodythicknesslining" style="width:100%" />
							</td>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.workingmediumjacket" style="width:100%" />
							</td>
							<td class="form_label">
								夹套:
							</td>
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designpressurejacket" style="width:100%" />
							</td>
						</tr>
						<tr>
							<td class="form_label">
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designtemperatureshellside"  emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="3">
								工作温度(℃):
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.worktemperatureshellside"  emptyText="请输入壳程"
								 requiredErrorText="壳程不能为空" style="width:100%" />
							</td>
							<td class="form_label" rowspan="3">
								腐蚀裕量:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.corrosionmargincylinder"  emptyText="请输入筒体"
								 requiredErrorText="筒体不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designtemperaturetube"  emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								管程:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.worktemperaturetube"  emptyText="请输入管程"
								 requiredErrorText="管程不能为空" style="width:100%" />
							</td>
							<td class="form_label">
								封头:
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.corrosionmarginhead"  emptyText="请输入封头"
								 requiredErrorText="封头不能为空" style="width:100%" />
							</td>
						</tr>
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.designtemperaturejacket" style="width:100%" />
							</td>
							<td class="form_label">
								夹套:
							</td>
							<td colspan="1">
								<input class="nui-textbox" readonly="readonly" name="pressurevessel.worktemperaturejacket" style="width:100%" />
							</td>
							<td class="form_label" colspan="2">
							</td>
						</tr>
			...
			<input class="nui-hidden" name="uuid"/>
				<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="registrationdate" style="width:100%" />
						</td>
						<td class="form_label">
							设备注册代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="updatedateday" style="width:100%" />
						</td>
						<td class="form_label">
							产权单位及代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="manufacturedate" style="width:100%" />
						</td>
						<td class="form_label">
							设计单位及代码:
						</td>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="designdate" style="width:100%" />
						</td>
						<td class="form_label">
							设计规范:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="installationdate" style="width:100%" />
						</td>
						<td class="form_label">
							投用日期:
						</td>
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="usedate" style="width:100%" />
						</td>
						<td class="form_label">
							监督单位及代码:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="inspectiondate" style="width:100%" />
						</td>
						<td class="form_label">
							检验类别:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="nextinspectiondate" style="width:100%" />
						</td>
						<td class="form_label">
							事故类别:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="accidentdate" style="width:100%" />
						</td>
						<td class="form_label">
							事故处理:
						</td>
					...
					<tr>
						...
						<td colspan="1">
							<input class="nui-datepicker" readonly="readonly" format="yyyy-MM-dd" name="equipmentchangedate" style="width:100%" />
						</td>
						<td class="form_label">
							变更承担单位:
						</td>
		...
		<script type="text/javascript">
			...
			function getTs(){
				...
				success : function(text) {	
					...
					relationid=pressurevessel.relationid;
				}
			});
			}
			getPressurevessel();
       ...
       function setEna(){
		...
		function load(fileId,fileRealName) {
			...
			function onSubmit() {
				...
				var data = form.getData(false, true);
				 nui.get("#btnSubmit").setEnabled(false);
                var urlStr = "com.cgn.itmp.conventionalislandand.pressurevesselbiz.endupdateworkPressurevessel.biz.ext";
