				...
				<div id="form0">
					<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
						<tr>
							...
							<td colspan="1">
								<input class="nui-combobox" readonly="readonly"  name="pressurevessel.jz" emptyText="请选择机组" emptyText="请选择机组" required="true"
						...
						<tr>
							...
							<td colspan="1">
								<input class="nui-textbox" onvalidation="hasIllegalChar(e,255,true,true)" id="ssbbh" required="true" emptyText="请输入设备编号" requiredErrorText="设备编号不能为空" style="width:100%"
							...
							<td colspan="1">
								<input class="nui-textbox" onvalidation="hasIllegalChar(e,255,true,true)" required="true" emptyText="请输入设备名称" requiredErrorText="设备名称不能为空" style="width:100%"
				 ...
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="sgweldnumber" allowSort="true" align="left" headerAlign="center" width="">
							壳体环焊缝编号
							<input class="nui-textbox" enabled="true" name="sgweldnumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true" />
						</div>
						<div field="srweldparameters" allowSort="true" align="left" headerAlign="center" width="">
							壳体环焊缝特性参数
							<input class="nui-textbox" enabled="true" name="srweldparameters" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true" />
						</div>
					</div>
				</div>
			</div>
				 ...
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="connectpipenumber" allowSort="true" align="left" headerAlign="center" width="">
							连接管道编号
							<input class="nui-textbox" enabled="true" name="connectpipenumber" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true" />
						</div>
						<div field="connectpipeparameter" allowSort="true" align="left" headerAlign="center" width="">
							连接管道特性参数
							<input class="nui-textbox" enabled="true" name="connectpipeparameter" onvalidation="hasIllegalChar(e,255,false,true)" property="editor" required="false" visible="true" />
						</div>
					</div>
				</div>
			</div>
				 ...
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="rdnumber" allowSort="true" align="left" headerAlign="center" width="">
							爆破片编号
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdnumber" property="editor" required="false" visible="true" />
						</div>
						<div field="rdmodel" allowSort="true" align="left" headerAlign="center" width="">
							爆破片型号
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdmodel" property="editor" required="false" visible="true" />
						</div>
						<div field="rdgerange" allowSort="true" align="left" headerAlign="center" width="">
							爆破片量程
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdgerange" property="editor" required="false" visible="true" />
						</div>
						<div field="rdinstallationlocation" allowSort="true" align="left" headerAlign="center" width="">
							爆破片安装位置
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdinstallationlocation" property="editor" required="false"
							 visible="true" />
						</div>
						<div field="rdaccuracy" allowSort="true" align="left" headerAlign="center" width="">
							爆破片精度(误差)
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdaccuracy" property="editor" required="false" visible="true" />
						</div>
						<div field="rdquantity" allowSort="true" align="left" headerAlign="center" width="">
							爆破片数量
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdquantity" property="editor" required="false" visible="true" />
						</div>
						<div field="rdmanufacturer" allowSort="true" align="left" headerAlign="center" width="">
							爆破片制造厂家
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="rdmanufacturer" property="editor" required="false" visible="true" />
						</div>
					</div>
				</div>
			</div>
			...
			<input class="nui-hidden" name="uuid"/>
				<table style="width:100%;height:95%;table-layout:fixed;" class="nui-form-table">
					<tr>
						...
						<td colspan="1">
							<input class="nui-textbox" name="registrationauthority" onvalidation="hasIllegalChar(e,255,false,true)" style="width:100%" />
						</td>
						<td class="form_label">
							注册登记日期:
						</td>
						<td colspan="1">
							<input class="nui-datepicker" format="yyyy-MM-dd" name="registrationdate" style="width:100%" />
						</td>
						<td class="form_label">
							设备注册代码:
						</td>
				 ...
				 editNextOnEnterKey="true"  oncellvalidation="onCellValidation" allowCellValid="true">
					...
					<div property="columns">
						...
						<div field="deviceversion" allowSort="true" align="left" headerAlign="center" width="">
							设备版本
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="deviceversion" property="editor" required="false" visible="true" />
						</div>
						...
						<div field="enteringperson" allowSort="true" align="left" headerAlign="center" width="">
							录入人
							<input class="nui-textbox" enabled="true" onvalidation="hasIllegalChar(e,255,false,true)" name="enteringperson" property="editor" required="false" visible="true" />
						</div>
...
<table id="form_sh">
			<tr class="changeReasons_yy" style="display: none;">
				...
				<td colspan="1"><input class="nui-textarea" id="changereaso" style="width:100%"
				required="true" requiredErrorText="请输入名称" onvalidation="hasIllegalChar(e,4000,true,true)"
		...
		<script type="text/javascript">
			...
			function getPressurevessel(){
				...
				$.ajax({
				url : "com.cgn.itmp.inspectcomponentmanage.conventionalislandand.pressurevessel.impl.pressurevessel_modifbiz.getPressurevesselmodfWork.biz.ext",//该方法可复用
				type : 'POST',
				data : json,
				async :false,
				cache : false,
				...
				success : function(text) {
				 var jdid = text.pressurevessel.jd;
				  ...
				  var grid0Data = text.pressurevessel.longitudinalwelds;
					...
					nui.get("changereaso").setValue(text.pressurevessel.changeReasons);
...
//             }
			...
			function onSubmit() {
				...
				var data = form.getData(false, true);
				 data.jhry= nui.get("jhry").value;
				data.ccry = nui.get("ccry").value;
				
				 data.pressurevessel.jhry= nui.get("jhry").value;
				data.pressurevessel.ccry = nui.get("ccry").value;
				data.pressurevessel.changeReasons=nui.get("changereaso").value;
				...
				var urlStr="com.cgn.itmp.conventionalislandand.pressurevesselbiz.updateEntityByMof.biz.ext";
