...
<%
 ...
 response.sendRedirect(request.getContextPath() + "/com.cgn.itmp.outlineandplan.annual.nuclearislandoverhauls.conventionislandsqsqMainFlow.flow?processInstId="+processInstId
