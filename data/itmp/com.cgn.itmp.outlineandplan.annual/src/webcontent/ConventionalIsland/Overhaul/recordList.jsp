    ...
    <body style="width:98%;height:95%;margin:0 auto;">
       <div  class="nui-layout" style="width:100%;height:98%;">
            ...
            <div id="form1" class="nui-form" align="center" style="height:100%">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaul.PlanGeneration">
                <!-- 排序字段 -->
                ...
                <ul>
                <li>
                <a class="nui-button" onclick="searchs()">
				                查询
	            </a>
        ...
        <div class="nui-panel" title="数据列表"  style="width:100%;height:100%;" showToolbar="false" showFooter="false" >
            <div class="nui-fit">
                <div 
                        id="datagrid1"
                        dataField="tdgglndjhcgddxjhscs"
                        class="nui-datagrid"
                        style="width:100%;height:100%;"
                        url="com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaul.queryTdgglndjhcgddxjhscs.biz.ext"
       ...
       SAP功能位置
                        ...
                        <div name="rwqd" field="rwqd" headerAlign="center" allowSort="true" width="100">
                            维护项目
                        </div>
                        ...
                        <div name="jk" field="jk" headerAlign="center" allowSort="true" >
                            进口
                        </div>
                        <div name="ck" field="ck" headerAlign="center" allowSort="true" >
                            出口
                        </div>
                        ...
                        <div name="chsl" field="chsl" headerAlign="center" allowSort="true" width="65">
                            测厚数量
                        </div>
                        <div name="utbw" field="utbw" headerAlign="center" allowSort="true" >
                            UT 部位
                        </div>
                        <div name="utsl" field="utsl" headerAlign="center" allowSort="true" width="60">
                            UT数量
                        </div>
...
tree.on("nodeselect", function (e) {
    ...
    if (e.isLeaf) {
       ...
       if("xmqd" == parms){//检查项目清单
        ...
        {field: 'rwqd', header: '维护项目', headerAlign: 'center', align: 'center', displayField: 'rwqd',width:'100'},
        {field: 'gdh', header: '工单号', headerAlign: 'center', align: 'center', displayField: 'gdh',width:'100'},
       ...
       $('#jcxmms').html('检查部位/检查内容:');
        ...
        {field: 'chsl', header: '测厚数量', headerAlign: 'center', align: 'center', displayField: 'chsl',width:'65'},
	 ...
	 nui.open({
        ...
        onload: function () {//弹出页面加载完成
            ...
            var data = {
            	...
            	entityName:"com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaul.PlanGeneration",
