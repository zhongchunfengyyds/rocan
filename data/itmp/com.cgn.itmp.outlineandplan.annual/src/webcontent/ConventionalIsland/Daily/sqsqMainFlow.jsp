...
<%
 ...
 response.sendRedirect(request.getContextPath() + "/com.cgn.itmp.outlineandplan.annual.nuclearislandoverhauls.conventionislanddailysqsqMainFlow.flow?processInstId="+processInstId
