...
<!--                  <input id="uuid" class="nui-hidden" name="uuid"/> -->
                 <input id="uuid" class="nui-hidden" name="criteria/_expr[0]/uuid"/>
				<input class="nui-hidden" name="criteria/_expr[0]/_op" value="=">
               <input id="processinstid" class="nui-hidden" name="criteria/_expr[1]/processinstid" value=""/>
		...
		<div class="nui-toolbar" style="border-bottom: 0; padding: 0px;" >
			...
			<table style="width: 100%; height: 100%; table-layout: fixed;text-align: center;"
				...
				<tr id="sqTr">
					...
					<td>
					 	<input id="shry" class="nui-buttonedit" readonly="readonly" onclick="onButtonSelectPerson" name="shry" textName="shry" required="true" style="width: 98%"/>    
                ...
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="isdelete" headerAlign="center" allowSort="true" visible="false">
                          ...
                          <div field="indexcolumn"  type="indexcolumn" headerAlign="center" allowSort="true">
                            序号
                        </div>
	            ...
	            ondestroy: function (action) {
                    ...
                    function saveData(finishFirstActivityId){
                    	...
                    	if(finishFirstActivityId != ""
                    		&& nui.get("shry").getValue() == ""
                    		&& nui.get("pzry").getValue() == ""
                    		&& nui.get("csry").getValue() == ""){
                    		nui.showTips({
                    			content: '表单校验不通过,请确认',
                    			state: 'danger',
                    			x: 'center',
				        ...
				        allInfo.processInstName = "年度计划(核岛)_换料大修计划生效_申请";
				        allInfo.processInstDesc = "年度计划(核岛)_换料大修计划生效_申请";
				        //工作流视图url
				        allInfo.processDefName = "com.cgn.itmp.outlineandplan.annual.nuclearislandoverhaulplan";
				        if(isadmin == 'false'){
					         allInfo.jhry =nui.get("shry").getText();
			 		        allInfo.pzry = nui.get("pzry").getText();
						   	...
						   	if(nui.get("shry").getValue()!= "" || nui.get("shry").getValue()!= null){
						   		person.shry = nui.get("shry").getText();
						   	}
					   	...
					   	$.ajax({
							   	url:"com.cgn.itmp.outlineandplan.annual.NuclearIslandOverhaul.operationWorkflow.biz.ext",
								type : 'POST',
								data : json,
								cache : false,
								contentType : 'text/json',
