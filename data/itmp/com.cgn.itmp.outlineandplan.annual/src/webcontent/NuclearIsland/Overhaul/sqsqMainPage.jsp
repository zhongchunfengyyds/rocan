...
<div  style="padding-top:5px;width:95%;">
    ...
    <input id="backid" class="nui-hidden"  value="<b:write property='backid'/>" name="backid"/>
     <input id="Id" class="nui-hidden" name="criteria/_expr[1]/processinstid"   />
                ...
                <td class="form_label"  style="width: 10%">
		         ...
		         <tr id="shryTr">
		            <td class="form_label" style="width: 10%">审核人员:</td>
			    	 <td colspan="5">
			    	 	<input id="shry" class="nui-buttonedit" readonly="readonly" onclick="onButtonSelectPerson" name="shry" textName="shry" required="true"  style="width: 55.5%"/> 
		            </td>
		        </tr>
		             <tr id="pzryTr">
    ...
    //数据加载
		...
		function getBusinessId(){
			$.ajax({
				...
				type:'POST',
                data: nui.encode({processInstId : processInstId,entityType: 'com.cgn.itmp.outlineandplan.annual.NuclearIslandOverhaul.PlanEntity'}),
                cache: false,
                ...
                success:function(result){
                	if(result != null){
                		...
                		if(result.result.shry != null && result.result.shry != ""){
                			nui.get("shry").setValue(getUserId(result.result.shry));
                			nui.get("shry").setText(result.result.shry);
                		}
    ...
    function onSubmit() {
            ...
            data.workItemId = nui.get('workItemId').getValue();
   		    ...
   		    data.spyj = nui.get('spyj').getValue();
   		   	data.jhry = nui.get('shry').getText();
   		    data.backid = backid;
   		    if(backid == 'finish'){
   		    	 data.entityType="com.cgn.itmp.outlineandplan.annual.NuclearIslandOverhaul.PlanEntity";
   		    	 data.isdelete = "4";
				...
				if(nui.get("shry").getValue()!= "" || nui.get("shry").getValue()!= null){
			   		personInfo.shry = nui.get("shry").getText();
			   	}
		        ...
		        function(action){
		           if(action=="ok"){
		        	 nui.get("#btnSubmit").setEnabled(false);
					    ...
					    json.entityType = "com.cgn.itmp.outlineandplan.annual.NuclearIslandOverhaul.PlanEntity";
					    json.isdelete = "0";
