       ...
       <div  class="nui-layout" style="width:100%;height:98%;">
            ...
            <div id="form1" class="nui-form" align="center" style="height:100%">
                ...
                <ul>
					...
					<li>
                    	...
                    	<input class="nui-hidden" name="criteria/_expr[27]/lcv" value="" />
                    	<input class="nui-hidden" name="criteria/_expr[27]/_op" value="<>">
                    	<input class="nui-hidden" name="criteria/_expr[28]/lcv"  />
                    	<input class="nui-hidden" name="criteria/_expr[28]/_op" value="notnull">
        ...
        <div class="nui-fit">
        	<ul id="tree1" class="nui-tree" resultAsTree="false" style="width:100%;height:100%;" idField="id" parentField="pid" 
            	dataField="treeDepts" textField="name" url="/itmp/annual/NuclearIsland/Daily/deptTree.txt">
			</ul>
		</div>
    	</div>
        ...
        <div class="nui-panel" title="数据列表"   style="width:100%;height:100%;" showToolbar="false" showFooter="false" >
            <div class="nui-fit">
                <div 
                        id="datagrid1"
                        dataField="tgglndjhhdrcjhscs"
                        class="nui-datagrid"
                        style="width:100%;height:100%;"
                        url="com.cgn.itmp.outlineandplan.annual.NuclearIslandDaily.queryTgglndjhhdrcjhscs.biz.ext"
                    ...
                    <div property="columns">
                        ...
                        <div name="detailed" field="detailed" headerAlign="center" allowSort="true" >
                            维护项目
                        </div>
                        ...
                        <div name="inspectionscope" field="inspectionscope" headerAlign="center" allowSort="true" >
                            检查项目描述
                        </div>
                        ...
                        <div name="ident" field="ident" headerAlign="center" allowSort="true" width="40">
                            标识
                        </div>
                    </div>
                </div>
...
tree.on("nodeselect", function (e) {
    ...
    if (e.isLeaf) {
       if("fd" == parms){//规范法定检测项目清单
       	var columns = [
        {type: 'checkcolumn'},
        {type: 'indexcolumn', header: '序号', headerAlign: 'center', align: 'center', displayField: 'indexcolumn'},
        ...
        {field: 'detailed', header: '维护项目', headerAlign: 'center', align: 'center', displayField: 'detailed'},
        ...
        {field: 'referencefigureno',header: '参考图号',headerAlign: 'center',lign: 'center',displayField: 'referencefigureno',width:'65'},
       ...
       var columns = [
        ...
        {field: 'gxnumber', header: '管线号', headerAlign: 'center', align: 'center', displayField: 'gxnumber'},
        {field: 'referencefigureno', header: '参考图号', headerAlign: 'center', align: 'center', displayField: 'referencefigureno',width:'65'},
        {field: 'roomnumber', header: '房间号', headerAlign: 'center', align: 'center', displayField: 'roomnumber'},
        {field: 'approachmode', header: '接近方式', headerAlign: 'center', align: 'center', displayField: 'approachmode'},
        {field: 'method', header: '检查方法', headerAlign: 'center', align: 'center', displayField: 'method'},
        {field: 'program', header: '检查程序', headerAlign: 'center', align: 'center', displayField: 'program'},
	 ...
	 nui.open({
        ...
        onload: function () {//弹出页面加载完成
            ...
            var data = {
            	...
            	entityName:"com.cgn.itmp.outlineandplan.annual.NuclearIslandDailyCreate.PlanGeneration",
