...
var ScollTop = 0;
 //this.verIEFull == null || this.verIEFull <= 7 ? 0 : this.verIEFull;
...
function PresenceControl(uri,scoll)
{
	ScollTop=scoll;
    if (uri == null || uri == '')
        return;
...
function PresenceControlGetOOUILocation(obj, fprint)
{
    ...
    var objSpan = obj;
    var objOOUI = obj;
    var oouiX = 0, oouiY = 0, objDX = 0,Y = 0;
   ...
   obj = objOOUI;
    ...
    if (IeVersion > 7 && IeVersion < 11) {
        ...
        objRet.oouiY = ScollTop == 0 ? oouiY - Y : oouiY - Y - ScollTop;
    }
    else {
         objRet.oouiY = oouiY;
    }
