...
<div class="bs-docs-section">
				...
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center"
						...
						<input class="nui-hidden" name="criteria/_entity"
							value="com.cgn.itmp.inspectcomponentmanage.trainsmg.Trainsmg_mf">
						<!-- 排序字段 -->
						<table id="table1" class="table" style="height: 100%">
							...
							<tr>
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[9]/changeuser" /> <input class="nui-hidden"
									name="criteria/_expr[9]/_op" value="="></td>
								<td class="form_label">修改内容:</td>
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[10]/changeinfo" /> <input
							...
							<tr
								...
								<td style="visibility: hidden; height: 1px; overflow: hidden;"
									...
									name="criteria/_expr[13]/isdel" value="3" /> <input
									class="nui-hidden" name="criteria/_expr[13]/_op" value="=">
								</td>
								<td style="visibility: hidden; height: 1px; overflow: hidden;"
									colspan="1"><input class="nui-textbox" id="jd"
									name="criteria/_expr[14]/jd" value="" /> <input
									class="nui-hidden" name="criteria/_expr[14]/_op" value="=">
								</td>
								<td style="visibility: hidden; height: 1px; overflow: hidden;"
									colspan="1"><input class="nui-textbox" id="jz"
									name="criteria/_expr[15]/jz" value="" /> <input
									class="nui-hidden" name="criteria/_expr[15]/_op" value="=">
								</td>
							</tr>
						</table>
					</div>
	...
	<div style="width: 100%; height: 98%;" showToolbar="false"
		showFooter="false">
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="trainsmg_mfs" class="nui-datagrid"
				style="width: 100%; height: 95%;"
				url="com.cgn.itmp.inspectcomponentmanage.trainsmg.trainsmg_mfbiz.queryTrainsmg_mfs.biz.ext"
...
<!-- 					<div field="jz" headerAlign="center" allowSort="true">机组</div> -->
					...
					<div field="shoupostion" headerAlign="center" allowSort="true">
						显示位置</div>
					<div field="overhaulsq" headerAlign="center" width="200" allowSort="true">
						缺陷显示首次出现的大修轮次</div>
					<div field="planone" headerAlign="center" width="190" allowSort="true">
						跟踪检查计划及结果第1次</div>
					<div field="plantwo" headerAlign="center" width="190" allowSort="true">
						跟踪检查计划及结果第2次</div>
					<div field="planthree" headerAlign="center" width="190" allowSort="true">
						跟踪检查计划及结果第3次</div>
...
<!-- 						是否删除</div> -->
	...
	<script type="text/javascript">
					...
					$("#delebtn").prop("disabled", "disabled");
									if (action == "ok") {
										var json = nui
												.encode({
													data : rows,
													entity : "com.cgn.itmp.inspectcomponentmanage.trainsmg.Trainsmg_mf",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
												});
		...
		function refresh() {
			...
			json["criteria/_expr[10]/isdel"] = "3";
		...
		function output() {
			...
			nui.open({
						...
						onload : function() {//弹出页面加载完成
							...
							var data = {
								entityName : "com.cgn.itmp.inspectcomponentmanage.trainsmg.Trainsmg_mf",
								queryParam : json, //查询数据
								queryKey : 'criteria', //查询实体名
								query : ['checkpostion',
										'checkmethond', 'screwiden',
										'shoupostion', 'overhaulsq', 'planone',
										'plantwo', 'planthree','changeuser','changeinfo','changeReason','changeDate', 'isdel', 'jd', 'jz' ], //按顺序放置
								filterField : [ 'uuid', 'isdel', 'jd', 'jz','relationid','createtime','processInstId','processStatus','applicant','applicanttime','jhry','ccry','deleteperson','deletetime','orderno' ],
								expTitle : "跟踪检查管理修改记录",
								jdFieds : "jd",
								jzFieds : "jz",
								...
								defaultCheck : [ 'checkpostion',
										'checkmethond', 'screwiden',
										'shoupostion', 'overhaulsq', 'planone',
										'plantwo', 'planthree', 'remake' ,'changeuser','changeinfo','changeReason','changeDate']
							};//传入页面的json数据
