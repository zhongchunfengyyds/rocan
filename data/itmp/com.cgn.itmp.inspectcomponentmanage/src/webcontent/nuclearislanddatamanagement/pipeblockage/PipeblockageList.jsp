...
<body style="background-color:#f1f1f1;width: 98%; height: 95%;">
		...
		<div class="search-box">
			<div class="search-container folding-menu" id="queryForm">
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center" style="height: 82px">
						<!-- 数据实体的名称 -->
						...
						<table id="table1" class="table" style="height: 100%">
							<tr>
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[1]/funlocation" /> <input
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[2]/no_r" /> <input class="nui-hidden"
							...
							<tr>
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[5]/location" /> <input
								...
								<td colspan="1"><input class="nui-textbox"
									name="criteria/_expr[6]/pluggingReason" /> <input
	...
	<div style="width: 100%; height: 96%;" showToolbar="false"
		showFooter="false">
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="pipeblockages" class="nui-datagrid"
				...
				<div property="columns">
					...
					<div field="steamGeneratorModel" headerAlign="center" width="120"
...
<%-- 		accessControlButton('<%=userRoleCodeList%>',7); --%>
								...
								function(action) {
									if (action == "ok") {
										var json = nui
												.encode({
													data : rows,
													entity : "com.cgn.itmp.inspectcomponentmanage.inspecomponentmenutree.inspecomponentmenutree.Pipeblockage",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
												});
		...
		function btnQuery() {
			...
			if (gjz == "") {
				...
				var data = {
					matchFied : "steamGeneratorModel,steamGeneratorNo,funlocation,no_r,no_c,defectTypes,defectSize,location,pluggingReason,pluggingTime",
		...
		function batchAdd() {
			nui.open({
				...
				onload : function() {//弹出页面加载完成
					...
					var data = {
						pageType : "batchAdd",
						tempFileName : getCookie('jdid')=="86"?"pipeblockageList_TS.xlsx":"pipeblockageList.xlsx",
						tempLoadName : "堵管统计",
						entitfName : "com.cgn.itmp.inspectcomponentmanage.inspecomponentmenutree.inspecomponentmenutree.Pipeblockage",
					};//传入页面的json数据
					...
					.open({
						...
						onload : function() {//弹出页面加载完成
							...
							var data = {
								...
								query : [ 'funlocation', 'no_r', 'no_c',
										'defectTypes', 'location',
										'pluggingReason', 'isdel','jd','jz' ], //按顺序放置
								filterField : [ 'processInstId','uuid', 'jd', 'jz', 'isdel',
										'fileid', 'filepath','createtime','processStatus','deleteperson','deletetime','orderno' ],
								expTitle : "堵管统计",
								...
								defaultCheck : [ 'steamGeneratorModel',
										'steamGeneratorNo', 'funlocation',
										'no_r', 'no_c', 'defectTypes',
										'defectSize', 'location',
										'pluggingReason', 'pluggingTime' ]
							};//传入页面的json数据
							iframe.contentWindow.setFormData(data);
						},
						ondestroy : function(action) {//弹出页面关闭前
          	...
          	if(data){
          		for(var i=0;i<data.length;i++){
          			if(data[i].processStatus=="0"){
		          		focds+="蒸汽发生器编号["+data[i].steamGeneratorNo+"]正在[修改]流程中<br>";
          			}
          		}
          	}
          	if(focds==""){
