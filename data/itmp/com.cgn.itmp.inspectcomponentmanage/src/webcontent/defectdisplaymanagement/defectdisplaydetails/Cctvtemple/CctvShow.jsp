		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
					...
					<table style="width: 100%; height: 100%; table-layout: fixed;"
						class="nui-form-table">
				                <tr>
				                    ...
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover1" readOnly="readOnly" />
				                    </td>
				                    <td class="form-label">2#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover2" readOnly="readOnly" />
				                    </td>
				                 </tr>
				                 <tr>
				                    <td class="form-label">3#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover3" readOnly="readOnly"/>
				                    </td>
				                    <td class="form-label">5#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover5" readOnly="readOnly"/>
				                    </td>
				                </tr>
				                <tr>
				                    <td class="form-label">6#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover6" readOnly="readOnly"/>
				                    </td>
				                    <td class="form-label">7#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover7" readOnly="readOnly"/>
				                    </td>
				                </tr>
						</table>
				</fieldset>
			...
			class="nui-form-table">
	                <tr>
	               		...
	               		<td class="form_label">机器坐标</td>
	               			<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.machinecoordinates" readOnly="readOnly" style="width: 100%" />
				</td>
	                </tr>
	                <tr>
	               		<td class="form_label">实际坐标</td>
	               		<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.actualcoordinates" readOnly="readOnly" style="width: 100%" />
				</td>
	                </tr>		
	          <tr>    
			...
			<tr>    
				...
				<td colspan="3">
					...
					name="defectsshowdetailedinformation.templeremark" readOnly="readOnly" style="width: 100%" />
				</td>
			</tr>
		</table>
