...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.row" emptyText="请输入ROW" required="required" style="width: 100%" requiredErrorText="ROW不能为空"  /></td>
				</tr>
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.leg" emptyText="请输入LEG"  required="required" requiredErrorText="LEG不能为空"  style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">CALGROUP</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.calgroup" emptyText="请输入CALGROUP" required="required" requiredErrorText="CALGROUP不能为空"  style="width: 100%" /></td>
				<td class="form_label">ACQ</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.acq" emptyText="请输入ACQ" required="required" requiredErrorText="ACQ不能为空"  style="width: 100%" /></td>
			</tr>
			<tr>
			<td class="form_label">TER</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.ter" emptyText="请输入TER" required="required" requiredErrorText="TER不能为空"  style="width: 100%" /></td>
				<td class="form_label">DIAM. AVERG</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.diamaverg" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">DIAM. EHE</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.diamehe" style="width: 100%" /></td>
			<td class="form_label">POSIT.EHE</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.positehe"  style="width: 100%" /></td>
			
			</tr>
			<tr>
			<td class="form_label">DV1 DIAM</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.dv1diam" style="width: 100%" /></td>
			<td class="form_label">DV1 POSIT</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.dv1posit" style="width: 100%" /></td>
			
			</tr>
			<tr>
			<td class="form_label">DV2 DIAM</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.dv2diam" style="width: 100%" /></td>
			<td class="form_label">DV2 POSIT</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.dv2posit" style="width: 100%" /></td>
			
			</tr>
			<tr>
			<td class="form_label">DATA FILE</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.datafile" style="width: 100%" /></td>
...
// 		nui.get("sf1").load(sfdata);
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"crglkqx"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="crglkqx";
