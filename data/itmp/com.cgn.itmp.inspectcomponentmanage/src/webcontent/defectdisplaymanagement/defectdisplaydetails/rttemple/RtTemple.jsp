...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" emptyText="请输入缺陷位置"
					name="defectsshowdetailedinformation.defectlocation" requiredErrorText="缺陷位置不能为空" required="required" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷大小</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入缺陷大小"
					name="defectsshowdetailedinformation.defectsize" requiredErrorText="缺陷大小不能为空" required="required" style="width: 100%" /></td>
				<td class="form_label">缺陷性质</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入缺陷性质"
					name="defectsshowdetailedinformation.defecttype" requiredErrorText="缺陷性质不能为空" required="required" style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">位置</td>
				<td colspan="1"><input class="nui-textbox"  emptyText="请输入位置"
					name="defectsshowdetailedinformation.position" requiredErrorText="位置不能为空" required="required" style="width: 100%" /></td>
...
<td colspan="1"><input class='nui-dictcombobox' dictTypeId='ISORNO' nullItemText="请选择是否超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" required="required" style="width: 100%" /></td>			</tr>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   onload: function () {//弹出页面加载完成
		                    ...
		                    var data = {stencilplate:"rt"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="rt";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "rt") {
