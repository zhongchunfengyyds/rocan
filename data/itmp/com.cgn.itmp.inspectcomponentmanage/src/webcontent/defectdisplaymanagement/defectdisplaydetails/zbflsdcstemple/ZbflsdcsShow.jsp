	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.keywayedgenumber" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hb" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">D(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.zbfld" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">W(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.zbflw" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">Hd(dB) 12.5%FSH</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hd" readOnly="readOnly" style="width: 100%" /></td>
