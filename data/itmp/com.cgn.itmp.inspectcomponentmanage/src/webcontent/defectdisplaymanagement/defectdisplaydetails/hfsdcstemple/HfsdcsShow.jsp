	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hfsda" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
		</table>
					...
					<table style="width: 100%; height: 100%; table-layout: fixed;"
						class="nui-form-table">
				                <tr>
				                    ...
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.hfsdxa" readOnly="readOnly" style="width:80%;" />
				                    </td>
				                    <td class="form-label" ">B：</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.hfsdxb" readOnly="readOnly" style="width:80%;"/>
				                    </td>
				                </tr>
						</table>
				</fieldset>
			...
			class="nui-form-table">
	                <tr>
	                    <td class="form-label" >A：</td>
	                    <td >
	                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.hfsdya" readOnly="readOnly" />
	                    </td>
	                    <td class="form-label" >B：</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.hfsdyb" readOnly="readOnly"/>
	                    </td>
	                    </tr>
	                    <tr>
	                    <td class="form-label" >C：</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.hfsdyc" readOnly="readOnly"/>
	                    </td>
	                	</tr>
	              </table>
				</fieldset>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hfsdd" readOnly="readOnly" style="width: 100%" /></td>
