	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td class="form_label">（类型）缺陷类型</td>
				<td colspan="1"><input class="nui-textbox"
					...
					<table style="width: 100%; height: 100%; table-layout: fixed;"
						class="nui-form-table">
				                ...
				                <tr>
				                 ...
				                 <tr>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.amplitude" readOnly="readOnly"/>
				                    </td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.phase" readOnly="readOnly" />
				                    </td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.axialposition" readOnly="readOnly"/>
				                    </td>
				                </tr>
						</table>
				</fieldset>
