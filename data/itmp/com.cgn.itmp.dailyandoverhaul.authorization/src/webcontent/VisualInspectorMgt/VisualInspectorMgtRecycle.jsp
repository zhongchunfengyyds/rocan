                ...
                <div 
                    ...
                    <div type="indexcolumn">
                     ...
                     <div field="uuid" headerAlign="center" allowSort="true" visible="false" >
                        ...
                        <div field="name" headerAlign="center" width="70" allowSort="true" >
                            姓名
                        </div>
            	...
            	if(data.isJdgly){
                    ...
                    function remove(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tdxglzzsqglhdwxfcmsjyrygls:rows});
                                    grid.loading("正在删除中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.authorization.VisualInspectorMgt.deleteTDxglZzsqglHdwxfcmsjyrygls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({  
                                        url:"com.cgn.itmp.dailyandoverhaul.authorization.VisualInspectorMgt.hfdeleteTDxglZzsqglHdwxfcmsjyrygls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
