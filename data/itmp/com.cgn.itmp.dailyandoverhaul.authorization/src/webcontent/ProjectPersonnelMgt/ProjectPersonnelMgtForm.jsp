            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                ...
                <tr>
                  <td class="form_label">
                      ...
                      <td colspan="1">
                        <input style="width:100%;" onvalidation="hasIllegalChar(e,200,false,true)" class="nui-textbox"  name="jsonObject.empnubmer"/>
                    </td>
                                        <td class="form_label">
                        身份证号:
                    </td>
                      <td colspan="1">
                      <input style="width:100%;display:none;" class="nui-textbox"  id="personnumber"/>
                      <input class="nui-dictcombobox" allowInput="true" url="com.cgn.itmp.dailyandoverhaul.authorization.ProjectPersonnelMgt.getIdnumber.biz.ext"
                          dataField="jsonObject" textField="IDNUMBER" id="idnumber" valueField="IDNUMBER"  onvalidation="onIDCardsValidation"  onbeforeload="onBeforeLoadeidN" style="width: 100%;" required="true" requiredErrorText="身份证号不能为空" emptyText="请输入身份证号" name="jsonObject.idnumber"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <input  class="nui-dictcombobox"
								style="width: 100%;" dataField="sydx" dictTypeId="SYDX" multiSelect="true" required="true" requiredErrorText="适用堆型不能为空"  emptyText="请输入适用堆型"  name="jsonObject.sydx" />
                    </td>
                    <td class="form_label">
                        验证项目:
                    </td>
                    <td colspan="1">
                        <input  id="yzxm" class="nui-buttonedit" onclick="onButtonEdit(this);"  textName="b" style="width: 100%;" required="true" requiredErrorText="验证项目不能为空"  emptyText="请输入验证项目"  name="jsonObject.yzxm"/>
                    </td>
                </tr>
                <tr>
                	   <td class="form_label">
                    ...
                    <td colspan="1">
		<input   style="width:100%;" class="nui-datepicker"  showClose="true"
									oncloseclick="this.setValue(null);"  allowInput="false" name="jsonObject.pzrq"/>                    </td>
                </tr>
                 <tr>
                    <td class="form_label">
                        有效期至:
                    ...
                    <td colspan="1">
                        <input required="true" requiredErrorText="有效期不能为空"  emptyText="请输入有效期"  style="width:100%;" class="nui-datepicker"  showClose="true"
									 format="yyyy-MM-dd" oncloseclick="this.setValue(null);" onvaluechanged="setSqzt" allowInput="false" name="jsonObject.yxrq"/>
                    </td>
                              <td class="form_label">
                        状态:
                    </td>
			...
			readOnly="true" class="nui-dictcombobox" dictTypeId="WSZT" name="jsonObject.zt"/>
                 ...
                 <tr>
                    ...
                    <td colspan="3">
                        <input style="width:100%;" class="nui-textArea" onvalidation="hasIllegalChar(e,256,false,true)" name="jsonObject.bz"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_label">
                ...
                $.ajax({
                    ...
                    function setFormData(data){
                        ...
                        if (infos.pageType == "edit") {
					        ...
					        nui.get("yzxm").setText(nui.getDictText("YZXM",json.jsonObject.yzxm));
					        nui.get("yzxm").setValue(json.jsonObject.yzxm);
					        ...
					        nui.get("yzxm").setText(nui.getDictText("YZXM",json.jsonObject.yzxm));
					        nui.get("yzxm").setValue(json.jsonObject.yzxm);
					        nui.get("personnumber").setValue(json.jsonObject.idnumber);
					        $("#personnumber").show();
					        $("#idnumber").hide();
					        SetFilehref();
                        }
			    ...
			    ondestroy: function (action) {
			        if (action == "ok") {
			            ...
			            data = nui.clone(data);    //必须
			          	nui.get('yzxm').setValue(data[0].dictid);
			        	var xm=nui.getDictText("YZXM",data[0].dictid);
			        	nui.get('yzxm').setText(xm);
			            }
			            /*  return xm;  */
		            }
