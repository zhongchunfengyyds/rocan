...
<div id="form1">
    ...
    <table style="width: 98%">
        ...
        <tr id="shryTr" align="right">
          ...
          <td class="form_label" colspan="5" align="left">
                <%--<input  property="editor" id="jhry"  name="jhry"  class="nui-textboxlist" dataField="list" required="true"  requiredErrorText="请输入审核人员" style="width:250px"--%>
...
<!--               <input class="nui-combobox" dataField="resultList.EmployeeSource"  onvaluechanged="onchangePerson" id="jhry"  name="data.jhry"  textField="empname" style="width:50%" -->
