...
- Description:
    ...
    <body style="width:98%;height:95%;margin:0 auto;">
      	<div id="form1">
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.OverhaulRecycle">
                <!-- 排序字段 -->
            ...
            <div class="nui-fit">
                <div 
                        ...
                        url="com.cgn.itmp.outlineandplan.tenyearplan.RecoverMgt.queryRecovers.biz.ext"
                        pageSize="20"
                    ...
                    <div property="columns">
                        ...
                        <div field="ptype" headerAlign="center" allowSort="true" visible="false">
                            项目类型
                        </div>
                        ...
                        <div field="itemno" headerAlign="center" allowSort="true" Align="center" width="60">
                            项号
                        </div>
                        <div field="inspectionscope" headerAlign="center" allowSort="true" Align="center">
                            检查项目描述
                        </div>
                        <div field="site" headerAlign="center" allowSort="true" Align="center">
                           功能位置
                        </div>
                        ...
                        <div field="edition"  headerAlign="center" allowSort="true" Align="center">
                           版次
                        </div>
                         <div field="remark" headerAlign="center" allowSort="true" Align="center">
                            备注
                        </div>
...
function remove(){
    ...
    if(rows.length > 0){
        ...
        function(action){
            if(action=="ok"){
                ...
                $.ajax({
                    url:"com.cgn.itmp.outlineandplan.tenyearplan.RecoverMgt.deleteRecoversData5.biz.ext",
                    type:'POST',
                    data:jsondata,
                    cache: false,
	...
	function setDel(){
	    ...
	    if(rows.length > 0){
	        ...
	        function(action){
	            if(action=="ok"){
	                var json = {tdgglsnjhhddxs:rows};
	                grid.loading("正在恢复,请稍等...");
	                
	                var success = true;
	                for(var i = 0;i< json.tdgglsnjhhddxs.length;i++){
	                	var jsondata = "{'tdgglsnjhhddx':{'id':'"+json.tdgglsnjhhddxs[i].uuid+"','isdelete':'0'}}";
	                	$.ajax({
		                    url:"com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.updateTdgglsnjhhddx.biz.ext",
		                    type:'POST',
		                    data:jsondata,
		                    cache:false,
		                    contentType:'text/json',
