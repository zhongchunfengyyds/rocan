            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<tr>
                    ...
                    <td>
                        <input id="parts" class="nui-textbox" name="preData.parts"/>
                    </td>
                    <td>
                    </td>
         		</tr>
         		...
         		<tr>
                    ...
                    <td colspan="1">
                        <input id="detailed" onvalidation="hasIllegalChar(e,500,false,true)" class="nui-textbox" name="nextData.detailed"/>
                    </td> 
                    <td class="form_label"  align="center">
                          检查周期:
                    </td>
                    ...
                    <td colspan="1">
                        <input id="period" onvalidation="hasIllegalChar(e,4000,false,true)" class="nui-textbox" name="nextData.period"/>
                    </td>
         		</tr>
           ...
           <!-- C1-C60 -->
             ...
             <!-- 人员及原因信息 -->
              ...
              <tr>
                    ...
                    <td colspan="2">
                        <input id="remark" onvalidation="hasIllegalChar(e,4000,false,true)" style="width: 100%" class="nui-textarea" name="preData.remark"/>
                    </td>
                    <td colspan="3">
                        <input style="width: 100%" class="nui-textarea" name="nextData.remark"/>
                    </td>
                </tr>
              	<tr>
              		<td class="form_label"  align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
            ...
            function saveData(finishFirstActivityId){
            	...
            	if(detailed != null && detailed != ''){
					...
					jsondata.base = jdid;
					jsondata.crew = jzid;
					jsondata.entity = 'com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.OverhaulEntity';
					...
					$.ajax({
	                    ...
	                    success:function(data){
		                	if(data.record != null && data.record.length > 0){
								...
								data.processInstName = "十年计划(核岛)_大修执行条目_修改";
								data.processInstDesc = "十年计划(核岛)_大修执行条目_修改";
								data.processDefName = "com.cgn.itmp.outlineandplan.tenyearplan.editSnjhHdDxzxtm";
								data.middleEntity = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit";
								data.realEntity = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.OverhaulEntity";
