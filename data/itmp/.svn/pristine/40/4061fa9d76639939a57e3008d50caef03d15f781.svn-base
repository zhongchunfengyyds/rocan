   ...
   <input class="nui-hidden" name="processInstId" value="<b:write property='processInstId'/>"/> 
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-combobox" readonly="readonly" dataField="jsonObject" value="<b:write property='entity/crew'/>" id="jz" textField="name" 
                       url="com.cgn.itmp.basecommon.DictionaryOperation.getJzDicInfoByjdid.biz.ext?jdid=<b:write property='entity/base'/>"  name="delete_entity.crew"  valueField="id"/>
                    </td>
                    <td class="form_label"  align="center">
                        项目类型:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly" required="true" requiredErrorText="请输入类型" name="delete_entity.protype" value="<b:write property='entity/protype'/>"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" readonly="readonly" required="true" requiredErrorText="请输入部件"  value="<b:write property='entity/parts'/>" name="delete_entity.parts"/>
                    </td>
                    <td class="form_label"  align="center">
                        模板:
                    </td>
                    <td colspan="1">
                        <input id="template" required="true" requiredErrorText="请选择模板" value="<b:write property='entity/template'/>" onvaluechanged="setHidden" class="nui-dictcombobox" name="delete_entity.template" dictTypeId="template"/>
                    </td>
                    <td class="form_label"  align="center">
                        参考图号:
                    </td>
                    <td colspan="1">
                    	<input id="btnEdit1"  class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'1');" value="<b:write property='entity/referencefigureno'/>" name="delete_entity.referencefigureno" textName="b"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" value="<b:write property='entity/itemno'/>" requiredErrorText="请输入项号" name="delete_entity.itemno"/>
                    </td>
                    <td class="form_label"  align="center">
                        维护项目:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" value="<b:write property='entity/detailed'/>" requiredErrorText="请输入维护项目" name="delete_entity.detailed"/>
                    </td>      
                </tr>
                ...
                <td class="form_label"  >
                    ...
                    <td colspan="5">
                        <input class="nui-textarea" required="true" requiredErrorText="请输入检查内容/检查范围" style="width: 100%" name="delete_entity.inspectionscope"  value="<b:write property='entity/inspectionscope'/>" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <input class="nui-textarea" style="width: 100%" name="delete_entity.mapno"  value="<b:write property='entity/mapno'/>" />
                    </td>
                </tr>
              </table>
            ...
            <table id="zytab" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	<tr>
	                ...
	                <td colspan="5">
	      	     <input class="nui-textarea" required="true" requiredErrorText="请输入被检部位" style="width: 90%" name="delete_entity.detectedsite"  value="<b:write property='entity/detectedsite'/>" />
	                </td>
            	</tr>
            	<tr>
                	<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                       <input class="nui-textbox"  name="delete_entity.number"  value="<b:write property='entity/number'/>" />
                    </td>
                    <td class="form_label"  align="center">
                        接近方式:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" name="delete_entity.approachmode"  value="<b:write property='entity/approachmode'/>" />
                    </td>
                    <td class="form_label"  align="center">
                        检查方法:
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" required="true" requiredErrorText="请输入 检查方法" name="delete_entity.method"  value="<b:write property='entity/method'/>" />
                    </td>
                </tr>
                <tr>
                    <td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                    	<input id="btnEdit2" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'2');" name="delete_entity.program"  value="<b:write property='entity/program'/>" textName="b"/>
                    </td>
                    <td class="form_label"  align="center">
                专用工具:
            		</td>
            		<td colspan="1">
            			<input id="btnEdit3" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'3');" name="delete_entity.tool" textName="b" value="<b:write property='entity/tool'/>"/>
	            	</td>
	                <td class="form_label"  align="center">
		                专用检查计划:
		            </td>
		            <td colspan="1">
		                <input id="option" required="true" requiredErrorText="请选择专用检查计划" class="nui-dictcombobox" name="delete_entity.inspectplan" dictTypeId="option"  value="<b:write property='entity/inspectplan'/>" />
		            </td>
                </tr>
            </table>
             ...
             <table id="sytab" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
             	<tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="delete_entity.medium"  value="<b:write property='entity/medium'/>" />
                    </td>
                    <td class="form_label"  align="center">
                    试验部位:
                </td>
                <td colspan="1">
                    <input id="site" class="nui-dictcombobox" name="delete_entity.site" dictTypeId="site"  value="<b:write property='entity/site'/>" />
                </td>
                 <td class="form_label"  align="center">
                    试验程序:
                </td>
                <td colspan="1">
                    <input id="btnEdit4" class="nui-buttonedit" onbuttonclick="onButtonEdit(this,'4');" name="delete_entity.testprocedure" textName="b"  value="<b:write property='entity/testprocedure'/>" />
                </td>
             	</tr>
            <tr>
            <td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" name="delete_entity.operatingpressure"  value="<b:write property='entity/operatingpressure'/>" />
                    </td>
                    <td class="form_label"  align="center">
                        设计压力（Bar):
                    </td>
                    <td colspan="1">
                        <input class="nui-textbox" name="delete_entity.designpressure"  value="<b:write property='entity/designpressure'/>" />
                    </td>
            <td class="form_label"  align="center">
                    试验压力（Bar）:
                </td>
                <td colspan="1">
                    <input class="nui-textbox" name="delete_entity.testpressure"  value="<b:write property='entity/testpressure'/>" />
                </td>
            ...
            <td class="form_label"  align="center">
                ...
                <td colspan="1">
                    <input class="nui-datepicker" name="delete_entity.firsttesttime"  value="<b:write property='entity/firsttesttime'/>" />
                </td>
                <td class="form_label"  align="center">
                    前次试验日期:
                </td>
                <td colspan="1">
                    <input class="nui-datepicker" name="delete_entity.beforetesttime"  value="<b:write property='entity/beforetesttime'/>" />
                </td>
               <td class="form_label"  align="center">
                    下次试验最晚日期:
                </td>
                <td colspan="1">
                    <input class="nui-datepicker" name="delete_entity.nexttesttime"  value="<b:write property='entity/nexttesttime'/>" />
                </td> 
            </tr>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
	    	...
	    	function onSubmit(){
	            ...
	            data.entityType = "com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulEdit";
            ...
            $(function() {
            	...
            	if(btnEdit2 != null && btnEdit2 != ''){
            		nui.get('btnEdit2').setText(btnEdit2);
            	}
            	var btnEdit3 =  nui.get('btnEdit3').getValue();
            	if(btnEdit3 != null && btnEdit3 != ''){
            		nui.get('btnEdit3').setText(btnEdit3);
            	}
            	var btnEdit4 =  nui.get('btnEdit4').getValue();
            	if(btnEdit4 != null && btnEdit4 != ''){
            		nui.get('btnEdit4').setText(btnEdit4);
            	}
