            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<tr>
                    ...
                    <td>
                        <input value="<%=dataParms.get("protype")==null?"":dataParms.get("protype") %>" class="nui-textbox" name="tdgglgfffdrctm.protype"/>
                    </td>
                    <td>
                    </td>
         			<td class="form_label"  align="center">
                    ...
                    <td>
                        <input value="<%=dataParms.get("parts")==null?"":dataParms.get("parts") %>" class="nui-textbox" name="tdgglgfffdrctm.parts"/>
                    </td>
                    <td>
                    </td>
         		</tr>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="itemno" value="<%=dataParms.get("itemno")==null?"":dataParms.get("itemno") %>" class="nui-textbox" name="tdgglgfffdrctm.itemno"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="prosource" value="<%=dataParms.get("prosource")==null?"":dataParms.get("prosource") %>" class="nui-textbox" name="tdgglgfffdrctm.prosource"/>
                    </td>
                    <td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="insystem" value="<%=dataParms.get("insystem")==null?"":dataParms.get("insystem") %>" class="nui-textbox" name="tdgglgfffdrctm.insystem"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="equipment" value="<%=dataParms.get("equipment")==null?"":dataParms.get("equipment") %>" class="nui-textbox" name="tdgglgfffdrctm.equipment"/>
                    </td>
                    <td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="seat" value="<%=dataParms.get("seat")==null?"":dataParms.get("seat") %>" class="nui-textbox" name="tdgglgfffdrctm.seat"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="mapno" value="<%=dataParms.get("mapno")==null?"":dataParms.get("mapno") %>" class="nui-textbox" name="tdgglgfffdrctm.mapno"/>
                    </td>
                    <td>
                    	<input id="mapno" value="<%=editdataParms.get("mapno")==null?"":editdataParms.get("mapno") %>" class="nui-textbox" name="tdgglgfffdrctm.mapno"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="inspectionscope" value="<%=dataParms.get("inspectionscope")==null?"":dataParms.get("inspectionscope") %>" class="nui-textbox" name="tdgglgfffdrctm.inspectionscope"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="approachmode" value="<%=dataParms.get("approachmode")==null?"":dataParms.get("approachmode") %>" class="nui-textbox" name="tdgglgfffdrctm.approachmode"/>
                    </td>
                    <td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="method" value="<%=dataParms.get("method")==null?"":dataParms.get("method") %>" class="nui-textbox" name="tdgglgfffdrctm.method"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="executionunit" value="<%=dataParms.get("executionunit")==null?"":dataParms.get("executionunit") %>" class="nui-textbox" name="tdgglgfffdrctm.executionunit"/>
                    </td>
                    <td>
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="rsemcycle" value="<%=dataParms.get("rsemcycle")==null?"":dataParms.get("rsemcycle") %>" class="nui-textbox" name="tdgglgfffdrctm.rsemcycle"/>
                    </td>
                    <td colspan="1">
                    ...
                    <td>
                        <input id="sapcycle" value="<%=dataParms.get("sapcycle")==null?"":dataParms.get("sapcycle") %>" class="nui-textbox" name="tdgglgfffdrctm.sapcycle"/>
                    </td>
                    <td>
         		...
         		<tr>
                    ...
                    <td colspan="1"  name="tdgglgfffdrctm.detailed">
                        <input id="detailed" value="<%=dataParms.get("detailed")==null?"":dataParms.get("detailed") %>" class="nui-textbox" name="tdgglgfffdrctm.detailed"/>
                    </td>   
                    <td colspan="1">
                    ...
                    <td colspan="1">
                        <input  id="inspectplan" value="<%=dataParms.get("inspectplan")==null?"":dataParms.get("inspectplan") %>" class="nui-dictcombobox" name="tdgglgfffdrctm.inspectplan" dictTypeId="option"/>
                    </td>
                    <td colspan="1">
           ...
           <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
             	<tr>
					...
					<td id="n1991i" colspan="1">
						<input id="n1991" value="<%=dataParms.get("n1991")==null?"":dataParms.get("n1991") %>" class="nui-textbox" name="tdgglgfffdrctm.n1991"/>
					</td>
					...
					<td id="n1992i" colspan="1">
						<input id="n1992" value="<%=dataParms.get("n1992")==null?"":dataParms.get("n1992") %>" class="nui-textbox" name="tdgglgfffdrctm.n1992"/>
					</td>
             ...
             <tr>
				...
				<td id="n1993i" colspan="1">
					<input id="n1993" value="<%=dataParms.get("n1993")==null?"":dataParms.get("n1993") %>" class="nui-textbox" name="tdgglgfffdrctm.n1993"/>
				</td>
				...
				<td id="n1994i" colspan="1">
					<input id="n1994" value="<%=dataParms.get("n1994")==null?"":dataParms.get("n1994") %>" class="nui-textbox" name="tdgglgfffdrctm.n1994"/>
				</td>
			...
			<tr>
				...
				<td id="n1995i" colspan="1">
					<input id="n1995" value="<%=dataParms.get("n1995")==null?"":dataParms.get("n1995") %>" class="nui-textbox" name="tdgglgfffdrctm.n1995"/>
				</td>
				...
				<td id="n1996i" colspan="1">
					<input id="n1996" value="<%=dataParms.get("n1996")==null?"":dataParms.get("n1996") %>" class="nui-textbox" name="tdgglgfffdrctm.n1996"/>
				</td>
			...
			<tr>
				...
				<td id="n1997i" colspan="1">
					<input id="n1997" value="<%=dataParms.get("n1997")==null?"":dataParms.get("n1997") %>" class="nui-textbox" name="tdgglgfffdrctm.n1997"/>
				</td>
				...
				<td id="n1998i" colspan="1">
					<input id="n1998" value="<%=dataParms.get("n1998")==null?"":dataParms.get("n1998") %>" class="nui-textbox" name="tdgglgfffdrctm.n1998"/>
				</td>
			...
			<tr>
				...
				<td id="n1999i" colspan="1">
					<input id="n1999" value="<%=dataParms.get("n1999")==null?"":dataParms.get("n1999") %>" class="nui-textbox" name="tdgglgfffdrctm.n1999"/>
				</td>
				...
				<td id="n2000i" colspan="1">
					<input id="n2000" value="<%=dataParms.get("n2000")==null?"":dataParms.get("n2000") %>" class="nui-textbox" name="tdgglgfffdrctm.n2000"/>
				</td>
			...
			<tr>
				...
				<td id="n2001i" colspan="1">
					<input id="n2001" value="<%=dataParms.get("n2001")==null?"":dataParms.get("n2001") %>" class="nui-textbox" name="tdgglgfffdrctm.n2001"/>
				</td>
				...
				<td id="n2002i" colspan="1">
					<input id="n2002" value="<%=dataParms.get("n2002")==null?"":dataParms.get("n2002") %>" class="nui-textbox" name="tdgglgfffdrctm.n2002"/>
				</td>
			...
			<tr>
				...
				<td id="n2003i" colspan="1">
					<input id="n2003" value="<%=dataParms.get("n2003")==null?"":dataParms.get("n2003") %>" class="nui-textbox" name="tdgglgfffdrctm.n2003"/>
				</td>
				...
				<td id="n2004i" colspan="1">
					<input id="n2004" value="<%=dataParms.get("n2004")==null?"":dataParms.get("n2004") %>" class="nui-textbox" name="tdgglgfffdrctm.n2004"/>
				</td>
			...
			<tr>
				...
				<td id="n2005i" colspan="1">
					<input id="n2005" value="<%=dataParms.get("n2005")==null?"":dataParms.get("n2005") %>" class="nui-textbox" name="tdgglgfffdrctm.n2005"/>
				</td>
				...
				<td id="n2006i" colspan="1">
					<input id="n2006" value="<%=dataParms.get("n2006")==null?"":dataParms.get("n2006") %>" class="nui-textbox" name="tdgglgfffdrctm.n2006"/>
				</td>
			...
			<tr>
				...
				<td id="n2007i" colspan="1">
					<input id="n2007" value="<%=dataParms.get("n2007")==null?"":dataParms.get("n2007") %>" class="nui-textbox" name="tdgglgfffdrctm.n2007"/>
				</td>
				...
				<td id="n2008i" colspan="1">
					<input id="n2008" value="<%=dataParms.get("n2008")==null?"":dataParms.get("n2008") %>" class="nui-textbox" name="tdgglgfffdrctm.n2008"/>
				</td>
			...
			<tr>
				...
				<td id="n2009i" colspan="1">
					<input id="n2009" value="<%=dataParms.get("n2009")==null?"":dataParms.get("n2009") %>" class="nui-textbox" name="tdgglgfffdrctm.n2009"/>
				</td>
				...
				<td id="n2010i" colspan="1">
					<input id="n2010" value="<%=dataParms.get("n2010")==null?"":dataParms.get("n2010") %>" class="nui-textbox" name="tdgglgfffdrctm.n2010"/>
				</td>
			...
			<tr>
				...
				<td id="n2011i" colspan="1">
					<input id="n2011" value="<%=dataParms.get("n2011")==null?"":dataParms.get("n2011") %>" class="nui-textbox" name="tdgglgfffdrctm.n2011"/>
				</td>
				...
				<td id="n2012i" colspan="1">
					<input id="n2012" value="<%=dataParms.get("n2012")==null?"":dataParms.get("n2012") %>" class="nui-textbox" name="tdgglgfffdrctm.n2012"/>
				</td>
			...
			<tr>
				...
				<td id="n2013i" colspan="1">
					<input id="n2013" value="<%=dataParms.get("n2013")==null?"":dataParms.get("n2013") %>" class="nui-textbox" name="tdgglgfffdrctm.n2013"/>
				</td>
				...
				<td id="n2014i" colspan="1">
					<input id="n2014" value="<%=dataParms.get("n2014")==null?"":dataParms.get("n2014") %>" class="nui-textbox" name="tdgglgfffdrctm.n2014"/>
				</td>
			...
			<tr>
				...
				<td id="n2015i" colspan="1">
					<input id="n2015" value="<%=dataParms.get("n2015")==null?"":dataParms.get("n2015") %>" class="nui-textbox" name="tdgglgfffdrctm.n2015"/>
				</td>
				...
				<td id="n2016i" colspan="1">
					<input id="n2016" value="<%=dataParms.get("n2016")==null?"":dataParms.get("n2016") %>" class="nui-textbox" name="tdgglgfffdrctm.n2016"/>
				</td>
			...
			<tr>
				...
				<td id="n2017i" colspan="1">
					<input id="n2017" value="<%=dataParms.get("n2017")==null?"":dataParms.get("n2017") %>" class="nui-textbox" name="tdgglgfffdrctm.n2017"/>
				</td>
				...
				<td id="n2018i" colspan="1">
					<input id="n2018" value="<%=dataParms.get("n2018")==null?"":dataParms.get("n2018") %>" class="nui-textbox" name="tdgglgfffdrctm.n2018"/>
				</td>
			...
			<tr>
				...
				<td id="n2019i" colspan="1">
					<input id="n2019" value="<%=dataParms.get("n2019")==null?"":dataParms.get("n2019") %>" class="nui-textbox" name="tdgglgfffdrctm.n2019"/>
				</td>
				...
				<td id="n2020i" colspan="1">
					<input id="n2020" value="<%=dataParms.get("n2020")==null?"":dataParms.get("n2020") %>" class="nui-textbox" name="tdgglgfffdrctm.n2020"/>
				</td>
			...
			<tr>
				...
				<td id="n2021i" colspan="1">
					<input id="n2021" value="<%=dataParms.get("n2021")==null?"":dataParms.get("n2021") %>" class="nui-textbox" name="tdgglgfffdrctm.n2021"/>
				</td>
				...
				<td id="n2022i" colspan="1">
					<input id="n2022" value="<%=dataParms.get("n2022")==null?"":dataParms.get("n2022") %>" class="nui-textbox" name="tdgglgfffdrctm.n2022"/>
				</td>
			...
			<tr>
				...
				<td id="n2023i" colspan="1">
					<input id="n2023" value="<%=dataParms.get("n2023")==null?"":dataParms.get("n2023") %>" class="nui-textbox" name="tdgglgfffdrctm.n2023"/>
				</td>
				...
				<td id="n2024i" colspan="1">
					<input id="n2024" value="<%=dataParms.get("n2024")==null?"":dataParms.get("n2024") %>" class="nui-textbox" name="tdgglgfffdrctm.n2024"/>
				</td>
			...
			<tr>
				...
				<td id="n2025i" colspan="1">
					<input id="n2025" value="<%=dataParms.get("n2025")==null?"":dataParms.get("n2025") %>" class="nui-textbox" name="tdgglgfffdrctm.n2025"/>
				</td>
				...
				<td id="n2026i" colspan="1">
					<input id="n2026" value="<%=dataParms.get("n2026")==null?"":dataParms.get("n2026") %>" class="nui-textbox" name="tdgglgfffdrctm.n2026"/>
				</td>
			...
			<tr>
				...
				<td id="n2027i" colspan="1">
					<input id="n2027" value="<%=dataParms.get("n2027")==null?"":dataParms.get("n2027") %>" class="nui-textbox" name="tdgglgfffdrctm.n2027"/>
				</td>
				...
				<td id="n2028i" colspan="1">
					<input id="n2028" value="<%=dataParms.get("n2028")==null?"":dataParms.get("n2028") %>" class="nui-textbox" name="tdgglgfffdrctm.n2028"/>
				</td>
			...
			<tr>
				...
				<td id="n2029i" colspan="1">
					<input id="n2029" value="<%=dataParms.get("n2029")==null?"":dataParms.get("n2029") %>" class="nui-textbox" name="tdgglgfffdrctm.n2029"/>
				</td>
				...
				<td id="n2030i" colspan="1">
					<input id="n2030" value="<%=dataParms.get("n2030")==null?"":dataParms.get("n2030") %>" class="nui-textbox" name="tdgglgfffdrctm.n2030"/>
				</td>
			...
			<tr>
				...
				<td id="n2031i" colspan="1">
					<input id="n2031" value="<%=dataParms.get("n2031")==null?"":dataParms.get("n2031") %>" class="nui-textbox" name="tdgglgfffdrctm.n2031"/>
				</td>
				...
				<td id="n2032i" colspan="1">
					<input id="n2032" value="<%=dataParms.get("n2032")==null?"":dataParms.get("n2032") %>" class="nui-textbox" name="tdgglgfffdrctm.n2032"/>
				</td>
			...
			<tr>
				...
				<td id="n2033i" colspan="1">
					<input id="n2033" value="<%=dataParms.get("n2033")==null?"":dataParms.get("n2033") %>" class="nui-textbox" name="tdgglgfffdrctm.n2033"/>
				</td>
				...
				<td id="n2034i" colspan="1">
					<input id="n2034" value="<%=dataParms.get("n2034")==null?"":dataParms.get("n2034") %>" class="nui-textbox" name="tdgglgfffdrctm.n2034"/>
				</td>
			...
			<tr>
				...
				<td id="n2035i" colspan="1">
					<input id="n2035" value="<%=dataParms.get("n2035")==null?"":dataParms.get("n2035") %>" class="nui-textbox" name="tdgglgfffdrctm.n2035"/>
				</td>
				...
				<td id="n2036i" colspan="1">
					<input id="n2036" value="<%=dataParms.get("n2036")==null?"":dataParms.get("n2036") %>" class="nui-textbox" name="tdgglgfffdrctm.n2036"/>
				</td>
			...
			<tr>
				...
				<td id="n2037i" colspan="1">
					<input id="n2037" value="<%=dataParms.get("n2037")==null?"":dataParms.get("n2037") %>" class="nui-textbox" name="tdgglgfffdrctm.n2037"/>
				</td>
				...
				<td id="n2038i" colspan="1">
					<input id="n2038" value="<%=dataParms.get("n2038")==null?"":dataParms.get("n2038") %>" class="nui-textbox" name="tdgglgfffdrctm.n2038"/>
				</td>
			...
			<tr>
				...
				<td id="n2039i" colspan="1">
					<input id="n2039" value="<%=dataParms.get("n2039")==null?"":dataParms.get("n2039") %>" class="nui-textbox" name="tdgglgfffdrctm.n2039"/>
				</td>
				...
				<td id="n2040i" colspan="1">
					<input id="n2040" value="<%=dataParms.get("n2040")==null?"":dataParms.get("n2040") %>" class="nui-textbox" name="tdgglgfffdrctm.n2040"/>
				</td>
			...
			<tr>
				...
				<td id="n2041i" colspan="1">
					<input id="n2041" value="<%=dataParms.get("n2041")==null?"":dataParms.get("n2041") %>" class="nui-textbox" name="tdgglgfffdrctm.n2041"/>
				</td>
				...
				<td id="n2042i" colspan="1">
					<input id="n2042" value="<%=dataParms.get("n2042")==null?"":dataParms.get("n2042") %>" class="nui-textbox" name="tdgglgfffdrctm.n2042"/>
				</td>
			...
			<tr>
				...
				<td id="n2043i" colspan="1">
					<input id="n2043" value="<%=dataParms.get("n2043")==null?"":dataParms.get("n2043") %>" class="nui-textbox" name="tdgglgfffdrctm.n2043"/>
				</td>
				...
				<td id="n2044i" colspan="1">
					<input id="n2044" value="<%=dataParms.get("n2044")==null?"":dataParms.get("n2044") %>" class="nui-textbox" name="tdgglgfffdrctm.n2044"/>
				</td>
			...
			<tr>
				...
				<td id="n2045i" colspan="1">
					<input id="n2045" value="<%=dataParms.get("n2045")==null?"":dataParms.get("n2045") %>" class="nui-textbox" name="tdgglgfffdrctm.n2045"/>
				</td>
				...
				<td id="n2046i" colspan="1">
					<input id="n2046" value="<%=dataParms.get("n2046")==null?"":dataParms.get("n2046") %>" class="nui-textbox" name="tdgglgfffdrctm.n2046"/>
				</td>
			...
			<tr>
				...
				<td id="n2047i" colspan="1">
					<input id="n2047" value="<%=dataParms.get("n2047")==null?"":dataParms.get("n2047") %>" class="nui-textbox" name="tdgglgfffdrctm.n2047"/>
				</td>
				...
				<td id="n2048i" colspan="1">
					<input id="n2048" value="<%=dataParms.get("n2048")==null?"":dataParms.get("n2048") %>" class="nui-textbox" name="tdgglgfffdrctm.n2048"/>
				</td>
			...
			<tr>
				...
				<td id="n2049i" colspan="1">
					<input id="n2049" value="<%=dataParms.get("n2049")==null?"":dataParms.get("n2049") %>" class="nui-textbox" name="tdgglgfffdrctm.n2049"/>
				</td>
				...
				<td id="n2050i" colspan="1">
					<input id="n2050" value="<%=dataParms.get("n2050")==null?"":dataParms.get("n2050") %>" class="nui-textbox" name="tdgglgfffdrctm.n2050"/>
				</td>
			...
			<tr>
				...
				<td id="n2051i" colspan="1">
					<input id="n2051" value="<%=dataParms.get("n2051")==null?"":dataParms.get("n2051") %>" class="nui-textbox" name="tdgglgfffdrctm.n2051"/>
				</td>
				...
				<td id="n2052i" colspan="1">
					<input id="n2052" value="<%=dataParms.get("n2052")==null?"":dataParms.get("n2052") %>" class="nui-textbox" name="tdgglgfffdrctm.n2052"/>
				</td>
			...
			<tr>
				...
				<td id="n2053i" colspan="1">
					<input id="n2053" value="<%=dataParms.get("n2053")==null?"":dataParms.get("n2053") %>" class="nui-textbox" name="tdgglgfffdrctm.n2053"/>
				</td>
				...
				<td id="n2054i" colspan="1">
					<input id="n2054" value="<%=dataParms.get("n2054")==null?"":dataParms.get("n2054") %>" class="nui-textbox" name="tdgglgfffdrctm.n2054"/>
				</td>
			...
			<tr>
				...
				<td id="n2055i" colspan="1">
					<input id="n2055" value="<%=dataParms.get("n2055")==null?"":dataParms.get("n2055") %>" class="nui-textbox" name="tdgglgfffdrctm.n2055"/>
				</td>
				...
				<td id="n2056i" colspan="1">
					<input id="n2056" value="<%=dataParms.get("n2056")==null?"":dataParms.get("n2056") %>" class="nui-textbox" name="tdgglgfffdrctm.n2056"/>
				</td>
			...
			<tr>
				...
				<td id="n2057i" colspan="1">
					<input id="n2057" value="<%=dataParms.get("n2057")==null?"":dataParms.get("n2057") %>" class="nui-textbox" name="tdgglgfffdrctm.n2057"/>
				</td>
				...
				<td id="n2058i" colspan="1">
					<input id="n2058" value="<%=dataParms.get("n2058")==null?"":dataParms.get("n2058") %>" class="nui-textbox" name="tdgglgfffdrctm.n2058"/>
				</td>
			...
			<tr>
				...
				<td id="n2059i" colspan="1">
					<input id="n2059" value="<%=dataParms.get("n2059")==null?"":dataParms.get("n2059") %>" class="nui-textbox" name="tdgglgfffdrctm.n2059"/>
				</td>
				...
				<td id="n2060i" colspan="1">
					<input id="n2060" value="<%=dataParms.get("n2060")==null?"":dataParms.get("n2060") %>" class="nui-textbox" name="tdgglgfffdrctm.n2060"/>
				</td>
			...
			<tr>
				...
				<td id="n2061i" colspan="1">
					<input id="n2061" value="<%=dataParms.get("n2061")==null?"":dataParms.get("n2061") %>" class="nui-textbox" name="tdgglgfffdrctm.n2061"/>
				</td>
				...
				<td id="n2062i" colspan="1">
					<input id="n2062" value="<%=dataParms.get("n2062")==null?"":dataParms.get("n2062") %>" class="nui-textbox" name="tdgglgfffdrctm.n2062"/>
				</td>
			...
			<tr>
				...
				<td id="n2063i" colspan="1">
					<input id="n2063" value="<%=dataParms.get("n2063")==null?"":dataParms.get("n2063") %>" class="nui-textbox" name="tdgglgfffdrctm.n2063"/>
				</td>
				...
				<td id="n2064i" colspan="1">
					<input id="n2064" value="<%=dataParms.get("n2064")==null?"":dataParms.get("n2064") %>" class="nui-textbox" name="tdgglgfffdrctm.n2064"/>
				</td>
			...
			<tr>
				...
				<td id="n2065i" colspan="1">
					<input id="n2065" value="<%=dataParms.get("n2065")==null?"":dataParms.get("n2065") %>" class="nui-textbox" name="tdgglgfffdrctm.n2065"/>
				</td>
				...
				<td id="n2066i" colspan="1">
					<input id="n2066" value="<%=dataParms.get("n2066")==null?"":dataParms.get("n2066") %>" class="nui-textbox" name="tdgglgfffdrctm.n2066"/>
				</td>
			...
			<tr>
				...
				<td id="n2067i" colspan="1">
					<input id="n2067" value="<%=dataParms.get("n2067")==null?"":dataParms.get("n2067") %>" class="nui-textbox" name="tdgglgfffdrctm.n2067"/>
				</td>
				...
				<td id="n2068i" colspan="1">
					<input id="n2068" value="<%=dataParms.get("n2068")==null?"":dataParms.get("n2068") %>" class="nui-textbox" name="tdgglgfffdrctm.n2068"/>
				</td>
			...
			<tr>
				...
				<td id="n2069i" colspan="1">
					<input id="n2069" value="<%=dataParms.get("n2069")==null?"":dataParms.get("n2069") %>" class="nui-textbox" name="tdgglgfffdrctm.n2069"/>
				</td>
				...
				<td id="n2070i" colspan="1">
					<input id="n2070" value="<%=dataParms.get("n2070")==null?"":dataParms.get("n2070") %>" class="nui-textbox" name="tdgglgfffdrctm.n2070"/>
				</td>
			...
			<tr>
				...
				<td id="n2071i" colspan="1">
					<input id="n2071" value="<%=dataParms.get("n2071")==null?"":dataParms.get("n2071") %>" class="nui-textbox" name="tdgglgfffdrctm.n2071"/>
				</td>
				...
				<td id="n2072i" colspan="1">
					<input id="n2072" value="<%=dataParms.get("n2072")==null?"":dataParms.get("n2072") %>" class="nui-textbox" name="tdgglgfffdrctm.n2072"/>
				</td>
			...
			<tr>
				...
				<td id="n2073i" colspan="1">
					<input id="n2073" value="<%=dataParms.get("n2073")==null?"":dataParms.get("n2073") %>" class="nui-textbox" name="tdgglgfffdrctm.n2073"/>
				</td>
				...
				<td id="n2074i" colspan="1">
					<input id="n2074" value="<%=dataParms.get("n2074")==null?"":dataParms.get("n2074") %>" class="nui-textbox" name="tdgglgfffdrctm.n2074"/>
				</td>
			...
			<tr>
				...
				<td id="n2075i" colspan="1">
					<input id="n2075" value="<%=dataParms.get("n2075")==null?"":dataParms.get("n2075") %>" class="nui-textbox" name="tdgglgfffdrctm.n2075"/>
				</td>
				...
				<td id="n2076i" colspan="1">
					<input id="n2076" value="<%=dataParms.get("n2076")==null?"":dataParms.get("n2076") %>" class="nui-textbox" name="tdgglgfffdrctm.n2076"/>
				</td>
			...
			<tr>
				...
				<td id="n2077i" colspan="1">
					<input id="n2077" value="<%=dataParms.get("n2077")==null?"":dataParms.get("n2077") %>" class="nui-textbox" name="tdgglgfffdrctm.n2077"/>
				</td>
				...
				<td id="n2078i" colspan="1">
					<input id="n2078" value="<%=dataParms.get("n2078")==null?"":dataParms.get("n2078") %>" class="nui-textbox" name="tdgglgfffdrctm.n2078"/>
				</td>
			...
			<tr>
				...
				<td id="n2079i" colspan="1">
					<input id="n2079" value="<%=dataParms.get("n2079")==null?"":dataParms.get("n2079") %>" class="nui-textbox" name="tdgglgfffdrctm.n2079"/>
				</td>
				...
				<td id="n2080i" colspan="1">
					<input id="n2080" value="<%=dataParms.get("n2080")==null?"":dataParms.get("n2080") %>" class="nui-textbox" name="tdgglgfffdrctm.n2080"/>
				</td>
			...
			<tr>
				...
				<td id="n2081i" colspan="1">
					<input id="n2081" value="<%=dataParms.get("n2081")==null?"":dataParms.get("n2081") %>" class="nui-textbox" name="tdgglgfffdrctm.n2081"/>
				</td>
				...
				<td id="n2082i" colspan="1">
					<input id="n2082" value="<%=dataParms.get("n2082")==null?"":dataParms.get("n2082") %>" class="nui-textbox" name="tdgglgfffdrctm.n2082"/>
				</td>
			...
			<tr>
				...
				<td id="n2083i" colspan="1">
					<input id="n2083" value="<%=dataParms.get("n2083")==null?"":dataParms.get("n2083") %>" class="nui-textbox" name="tdgglgfffdrctm.n2083"/>
				</td>
				...
				<td id="n2084i" colspan="1">
					<input id="n2084" value="<%=dataParms.get("n2084")==null?"":dataParms.get("n2084") %>" class="nui-textbox" name="tdgglgfffdrctm.n2084"/>
				</td>
			...
			<tr>
				...
				<td id="n2085i" colspan="1">
					<input id="n2085" value="<%=dataParms.get("n2085")==null?"":dataParms.get("n2085") %>" class="nui-textbox" name="tdgglgfffdrctm.n2085"/>
				</td>
				...
				<td id="n2086i" colspan="1">
					<input id="n2086" value="<%=dataParms.get("n2086")==null?"":dataParms.get("n2086") %>" class="nui-textbox" name="tdgglgfffdrctm.n2086"/>
				</td>
			...
			<tr>
				...
				<td id="n2087i" colspan="1">
					<input id="n2087" value="<%=dataParms.get("n2087")==null?"":dataParms.get("n2087") %>" class="nui-textbox" name="tdgglgfffdrctm.n2087"/>
				</td>
				...
				<td id="n2088i" colspan="1">
					<input id="n2088" value="<%=dataParms.get("n2088")==null?"":dataParms.get("n2088") %>" class="nui-textbox" name="tdgglgfffdrctm.n2088"/>
				</td>
			...
			<tr>
				...
				<td id="n2089i" colspan="1">
					<input id="n2089" value="<%=dataParms.get("n2089")==null?"":dataParms.get("n2089") %>" class="nui-textbox" name="tdgglgfffdrctm.n2089"/>
				</td>
