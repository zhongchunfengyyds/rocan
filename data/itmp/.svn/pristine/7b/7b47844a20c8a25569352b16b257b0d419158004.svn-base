	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.boltsnutsnumber" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">显示位置</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.displayposition" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">显示信号幅值(V)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.displaysignalmagnitude" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">标定螺栓/螺母上人工刻伤0.5mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n1" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">标定螺栓/螺母上人工刻伤1mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n2" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">标定螺栓/螺母上人工刻伤2mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n3" readOnly="readOnly" style="width: 100%" /></td>
