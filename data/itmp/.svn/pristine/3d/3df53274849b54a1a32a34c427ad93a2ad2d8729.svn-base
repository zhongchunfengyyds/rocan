    ...
    function(e, t, r) {
        ...
        s = function(e) {
            ...
            t.prototype.initResourceView = function() {
                ...
                this.watch("displayingResources", t,
                function() {
                ...
                this.watch("displayingBusinessHours", ["businessHourGenerator", "displayingResources", "displayingDates"],
                function(t) {
                ...
                this.watch("displayingEvents", ["displayingResources", "hasEvents"],
                function() {
            ...
            t.prototype.bindBaseRenderHandlers = function() {
                ...
                this.on("before:resourcesUnrendered",
                function() {
                    e && (e = !1)
                }),
            ...
            t.prototype.queryScroll = function() {
                ...
                return this.isResourcesRendered && n.extend(e, this.queryResourceScroll()),
                e
            },
        ...
        t["default"] = s,
        s.prototype.isResourcesRendered = !1
    },
    , , ,
    function(e, t, r) {
        Object.defineProperty(t, "__esModule", {
        ...
        l = function(e) {
            function t(t) {
                ...
                return r.isResourceFootprintsEnabled = !0,
                r
            }
            return o.__extends(t, e),
            ...
            t.prototype.componentFootprintToSegs = function(e) {
                for (var t = this.resourceCnt,
                r = this.datesAboveResources ? this.sliceRangeByDay(e.unzonedRange) : this.sliceRangeByRow(e.unzonedRange), o = [], i = 0, s = r; i < s.length; i++) for (var l = s[i], c = 0; c < t; c++) {
                    var u = this.flattenedResources[c];
                    if (! (e instanceof a["default"]) || e.resourceId === u.id) {
                        var d = n.extend({},
                        l);
                        d.resource = u,
                        this.isRTL ? (d.leftCol = this.indicesToCol(c, l.lastRowDayIndex), d.rightCol = this.indicesToCol(c, l.firstRowDayIndex)) : (d.leftCol = this.indicesToCol(c, l.firstRowDayIndex), d.rightCol = this.indicesToCol(c, l.lastRowDayIndex)),
                        o.push(d)
                    }
                }
                return o
    ...
    function(e, t, r) {
        ...
        y = function(e) {
            function t(t, r) {
                ...
                return o.emphasizeWeeks = !1,
                o.isTimeBodyScrolled = !1,
                o.slotWidth = o.opt("slotWidth"),
                o
            }
            return o.__extends(t, e),
            t.prototype.normalizeComponentFootprint = function(e) {
                var t, r, o = e.unzonedRange;
                if (this.isTimeScale) r = this.normalizeGridDate(o.getStart()),
                t = this.normalizeGridDate(o.getEnd());
                else {
            ...
            t.prototype.normalizeGridDate = function(e) {
                var t = e.clone();
                return this.calendar.localizeMoment(t),
                this.isTimeScale ? t.hasTime() || t.time(0) : (t = t.clone().stripTime(), this.largeUnit && t.startOf(this.largeUnit)),
                t
            },
            ...
            t.prototype.updateGridDates = function() {
                for (var e = -1,
                t = 0,
                r = [], o = [], n = this.normalizedUnzonedStart.clone(); n < this.normalizedUnzonedEnd;) this.isValidDate(n) ? (e++, r.push(e), o.push(t)) : r.push(e + .5),
            ...
            t.prototype.unrenderSkeleton = function() {
                ...
                e.prototype.unrenderSkeleton.call(this)
            },
            t.prototype.renderDates = function(e) {
                ...
                for (this.calendar.localizeMoment(r); r < this.normalizedUnzonedEnd;) this.isValidDate(r) && t.push(r.clone()),
                ...
                this.slatCoordCache = new s.CoordCache({
                    els: this.slatEls,
                    isHorizontal: !0
                }),
                ...
                for (var n = 0; n < this.slotDates.length; n++) r = this.slotDates[n],
...
//            	
                for (var e, t, r, o, n = this.calendar.theme,
...
//                        console.log(M[x])
                ...
                C += "</tbody></table>";
/*console.log('11111',jdManagerArray);*/
//.resourceIds[0]
                var F = '<table class="' + n.getClass("tableGrid") + '">';
                F += "<colgroup>";
                for (var _ = 0,
                B = h; _ < B.length; _++) e = B[_],
                F += "<col/>";
                F += "</colgroup>",
                F += "<tbody id='jzClom'><tr class='huizhouTr' style='background:#00CED1;height:24px;border-bottom:1px solid #dfdfdf;'>";
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);

                F +="</tr><tr class='huizhouTr' style='background:#00CED1;height:24px;border-bottom:1px solid #dfdfdf;'>"
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
                ...
                F +="</tr><tr class='yangjiangTr' style='background:#99ff99;height:24px;border-bottom:1px solid #dfdfdf;'>";
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
                ...
                F +="</tr><tr class='ningdeTr' style='background:#cccccc;height:24px;border-bottom:1px solid #dfdfdf;'>"
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
                ...
                F +="</tr><tr class='taishanTr' style='background:#cc9999;height:24px;border-bottom:1px solid #dfdfdf;'>"
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
               ...
               F +="</tr><tr class='dayawanTr' style='background:#99cccc;height:24px;border-bottom:1px solid #dfdfdf;'>"
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
                ...
                F +="</tr><tr class='fangchenggangTr' style='background:#99cc99;height:24px;border-bottom:1px solid #dfdfdf;'>"
                for (var T = 0; T < h.length; T++) e = h[T],
                t = d[T],
                F += this.slatCellHtml(t, e.weekStart);
                ...
                F +="</tr><tr class='hongyanheTr' style='background:#9999ff;height:24px;border-bottom:1px solid #dfdfdf;'>"
                    for (var T = 0; T < h.length; T++) e = h[T],
                    t = d[T],
                    F += this.slatCellHtml(t, e.weekStart);
            ...
            t.prototype.slatCellHtml = function(e, t) {
                ...
                return this.isTimeScale ? (r = [], r.push(s.isInt(s.divideRangeByDuration(this.normalizedUnzonedStart, e, this.labelInterval)) ? "fc-major": "fc-minor")) : (r = this.getDayClasses(e), r.push("fc-day")),
            ...
            t.prototype.computeSlotWidth = function() {
                ...
                return a && (a = parseInt(a, 10), a && (i = Math.max(i, a))),
                i
            },
            ...
            t.prototype.computeDateSnapCoverage = function(e) {
                ...
                return s.isInt(o) ? o += t - r: o = Math.ceil(o),
                o
            },
            ...
            t.prototype.renderDrag = function(e, t, r) {
                if (t) return this.helperRenderer.renderEventDraggingFootprints(e, t, r),
                !0;
                for (var o = 0,
                n = e; o < n.length; o++) {
                    var i = n[o];
    ...
    function(e, t) {
        ...
        var r = function() {
            ...
            return e.prototype.initScroller = function(e) {
                var t = this;
                e.scrollEl.on("wheel mousewheel DomMouseScroll MozMousePixelScroll",
                function() {
                ...
                function() {
                    if (e === t.masterScroller) for (var r = 0,
                    o = t.scrollers; r < o.length; r++) {
                        var n = o[r];
            ...
            e.prototype.update = function() {
                ...
                }), n = 0, i = 0, s = 0, a = 0, l = 0, c = o; l < c.length; l++) t = c[l],
                n = Math.max(n, t.left),
                i = Math.max(i, t.right),
                s = Math.max(s, t.top),
                a = Math.max(a, t.bottom);
                for (r = 0; r < this.scrollers.length; r++) e = this.scrollers[r],
                t = o[r],
                e.canvas.setGutters("horizontal" === this.axis ? {
                    left: n - t.left,
                    right: i - t.right
                }: {
                    top: s - t.top,
    ...
    function(e, t, r) {
        ...
        function n(e) {
            return null == e.top && (e.top = o(e.above)),
            e.top + e.height
        }
        function i(e, t) {
        ...
        c = function(e) {
            ...
            t.prototype.renderFgSegs = function(e) {
                for (var t = this.view.eventTitleFollower,
                r = 0,
                n = e; r < n.length; r++) {
                    var i = n[r],
                ...
                this.component.segContainerHeight = o(e);
                for (var h = 0,
                p = e; h < p.length; h++) {
                    var i = p[h];
                    //i.el.css("top", i.top)
            ...
            t.prototype.fgSegHtml = function(e, t) {
                ...
                var type = r.resourceIds[0];
                var top = '0px';
                if(r.resourceIds[0]=='惠州'){
                    if(r.title.indexOf('P1')!=-1){
                        return '<a class="huizhouTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('P2')!=-1){
                        return '<a class="huizhouTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('P3')!=-1){
                        return '<a class="huizhouTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('P4')!=-1){
                        return '<a class="huizhouTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                
                }else if(r.resourceIds[0]=='阳江'){
                    if(r.title.indexOf('Y1')!=-1){
/*                    	for(var m=0;m< 6;m++){
    						top +=(2-1)*24;
    						
    					}
    					ele.style.top = top;*/
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
//                   console.log(top)
                    }
                   if(r.title.indexOf('Y2')!=-1){
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                   }
                   if(r.title.indexOf('Y3')!=-1){
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                   }
                   if(r.title.indexOf('Y4')!=-1){
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                   }
                   if(r.title.indexOf('Y5')!=-1){
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                   }
                   if(r.title.indexOf('Y6')!=-1){
                       return '<a class="yangjiangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                   }   
                }else if(r.resourceIds[0]=='宁德'){
                    if(r.title.indexOf('N1')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('N2')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('N3')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('N4')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('N5')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('N6')!=-1){
                        return '<a class="ningdeTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                
                }else if(r.resourceIds[0]=='台山'){
                    if(r.title.indexOf('T1')!=-1){
                        return '<a class="taishanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('T2')!=-1){
                        return '<a class="taishanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                }else if(r.resourceIds[0]=='大亚湾'){
                    if(r.title.indexOf('D1')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('D2')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('L1')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('L2')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('L3')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }
                    if(r.title.indexOf('L4')!=-1){
                        return '<a class="dayawanTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                    }   
            }else if(r.resourceIds[0]=='防城港'){
                if(r.title.indexOf('F1')!=-1){
                    return '<a class="fangchenggangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                }
                if(r.title.indexOf('F2')!=-1){
                    return '<a class="fangchenggangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                }     
                if(r.title.indexOf('F3')!=-1){
                    return '<a class="fangchenggangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                }  
                if(r.title.indexOf('F4')!=-1){
                    return '<a class="fangchenggangTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
                }  
            }else if(r.resourceIds[0]=='红沿河'){
                if(r.title.indexOf('H1')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               }
               if(r.title.indexOf('H2')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               }
               if(r.title.indexOf('H3')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               }
               if(r.title.indexOf('H4')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               }
               if(r.title.indexOf('H5')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               }
               if(r.title.indexOf('H6')!=-1){
                   return '<a class="hongyanheTr1 ' + s.join(" ") + '" style="position:absolute;height:25px;' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>"    
               } 
            }   
                //var tt = '<a class="' + s.join(" ") + '" style="margin-top:'+top+'  px; ' + a.cssToStr(this.getSkinCss(e.footprint.eventDef)) + '"' + (r.url ? ' href="' + a.htmlEscape(r.url) + '"': "") + '><div class="fc-content">' + (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>": "") + '<span class="fc-title">' + (r.title ? a.htmlEscape(r.title) : "&nbsp;") + '</span></div><div class="fc-bg" />' + (n ? '<div class="fc-resizer fc-start-resizer"></div>': "") + (i ? '<div class="fc-resizer fc-end-resizer"></div>': "") + "</a>";
                //$('.myStyle').css('margin-top',top);
        ...
        a = function(e) {
            ...
            t.prototype.renderSkeleton = function() {
                ...
                if (this.hasOwnRow) {
                    ...
                    for (var r in this.view.tbodyHash) {
                        ...
                        this[a] && this[a](s),
                        t ? t.trHash[r].after(s) : o.prepend(s)
                    }
                    this.trs = n(e).on("click", ".fc-expander", i.proxy(this, "toggleExpanded")),
                    this.thisRowShown()
                }
                if (this.set("isInDom", !0), this.isExpanded) for (var l = 0,
                c = this.children; l < c.length; l++) {
                    var u = c[l];
                    u.renderSkeleton()
                }
            },
            ...
            t.prototype.animateExpand = function() {
                ...
                r && (r.addClass("fc-collapsed"), setTimeout(function() {
                    r.addClass("fc-transitioning"),
                    r.removeClass("fc-collapsed")
                }), r.one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
                function() {
            ...
            t.prototype.descendantAdded = function(e) {
                this.get("isInDom") && this.hasOwnRow && 1 === this.children.length && this.indicateExpandingEnabled(),
                (this.parent || this.view).descendantAdded(e)
            },
            t.prototype.descendantRemoved = function(e) {
                this.get("isInDom") && this.hasOwnRow && 0 === this.children.length && this.indicateExpandingDisabled(),
                (this.parent || this.view).descendantRemoved(e)
            },
            t.prototype.thisRowShown = function() { (this.parent || this.view).descendantShown(this)
            },
            t.prototype.thisRowHidden = function() { (this.parent || this.view).descendantHidden(this)
            },
            t.prototype.descendantShown = function(e) { (this.parent || this.view).descendantShown(e)
            },
            t.prototype.descendantHidden = function(e) { (this.parent || this.view).descendantHidden(e)
            },
            t
        } (i.DateComponent);
        t["default"] = a,
        a.prototype.hasOwnRow = !1
    },
    function(e, t) {
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var r = function() {
            ...
            return e.extractIds = function(t, r) {
                ...
                n = [];
                if (t.resourceIds) for (var i = 0,
                s = t.resourceIds; i < s.length; i++) {
                    var a = s[i];
    ...
    function(e, t, r) {
        ...
        a = function(e) {
            ...
            t.prototype.flattenResources = function(e) {
                ...
                var n = [];
                return this.accumulateResources(e, t, n),
                n
            },
            t.prototype.accumulateResources = function(e, t, r) {
                ...
                i = o; n < i.length; n++) {
                    var s = i[n];
                    r.push(s),
                    this.accumulateResources(s.children, t, r)
                }
            },
            ...
            t.prototype.indicesToCol = function(e, t) {
                ...
                return this.isRTL && (r = this.colCnt - 1 - r),
                r
            },
            ...
            t.prototype.renderHeadResourceHtml = function() {
                ...
                return t.length || t.push("<td>&nbsp;</td>"),
                this.wrapTr(t, "renderHeadIntroHtml")
            },
            ...
            t.prototype.renderHeadDateAndResourceHtml = function() {
                for (var e = [], t = [], r = this.daysPerRow, o = 0; o < r; o++) {
                    ...
                    for (var i = 0,
                    s = this.flattenedResources; i < s.length; i++) {
                        var a = s[i];
            ...
            t.prototype.renderHeadResourceCellHtml = function(e, t, r) {
                return void 0 === r && (r = 1),
                '<th class="fc-resource-cell" data-resource-id="' + e.id + '"' + (t ? ' data-date="' + t.format("YYYY-MM-DD") + '"': "") + (r > 1 ? ' colspan="' + r + '"': "") + ">" + i.htmlEscape(this.view.getResourceText(e)) + "</th>"
            },
            ...
            t.prototype.processHeadResourceEls = function(e) {
                ...
                e.find(".fc-resource-cell").each(function(e, r) {
                    var o;
                    o = t.datesAboveResources ? t.getColResource(e) : t.flattenedResources[t.isRTL ? t.flattenedResources.length - 1 - e: e],
            ...
            t.prototype.renderBusinessHours = function(e) {
                for (var t = this.hasAllDayBusinessHours,
                r = this.dateProfile.activeUnzonedRange,
                o = [], n = 0, a = this.flattenedResources; n < a.length; n++) {
                    var l = a[n],
                    c = (l.businessHourGenerator || e).buildEventInstanceGroup(t, r);
                    if (c) for (var u = 0,
                    d = c.sliceRenderRanges(r); u < d.length; u++) {
                        var h = d[u];
    ...
    function(e, t, r) {
        ...
        t["default"] = a,
        a.prototype.dayGridClass = s["default"],
        i["default"].mixInto(a)
    },
    function(e, t, r) {
        Object.defineProperty(t, "__esModule", {
    ...
    function(e, t, r) {
        ...
        a = function(e) {
            function t(t) {
                var r = e.call(this, t) || this;
                return r.isHScrollbarsClipped = !1,
            ...
            t.prototype.updateSize = function() {
               // 
                ...
                return this.isHScrollbarsClipped && (r.marginTop = -t.top, r.marginBottom = -t.bottom),
            ...
            t.prototype.getScrollbarWidths = function() {
                ...
                return this.isHScrollbarsClipped && (e.top = 0, e.bottom = 0),
    ...
    function(e, t, r) {
        ...
        n = function() {
            ...
            return e.prototype.render = function() {
                this.el = o('<div class="fc-scroller-canvas"> <div class="fc-content"></div> <div class="fc-bg"></div> </div>'),
                this.contentEl = this.el.find(".fc-content"),
                this.bgEl = this.el.find(".fc-bg")
            },
            e.prototype.setGutters = function(e) {
                e ? o.extend(this.gutters, e) : this.gutters = {},
                this.updateSize()
            },
    ...
    function(e, t, r) {
        ...
        s = function() {
            ...
            e.prototype.addSprite = function(e) {
                e.follower = this,
                this.spritesById[e.id] = e
            },
            e.prototype.removeSprite = function(e) {
                e.clear(),
                delete this.spritesById[e.id]
            },
    ...
    function(e, t, r) {
        ...
        p = function() {
            ...
            e.prototype.assignPosition = function() {
                if (this.isEnabled) if (this.rect) if (this.doAbsolute && !this.follower.isForcedRelative) this.absolutize(),
                this.absoluteEl.css({
                    ...
                    this.unabsolutize(),
                    this.el.toggleClass("fc-following", Boolean(e || t)).css({
                        top: e,
                        left: t
                    })
    ...
    function(e, t, r) {
        function o(e) {
            ...
            r = 0,
            o = e; r < o.length; r++) {
                var n = o[r]; (t[n.componentFootprint.resourceId] || (t[n.componentFootprint.resourceId] = [])).push(n)
            }
            return t
        }
        function n(e) {
        ...
        R = function(e) {
            function t(t, r) {
                var o = e.call(this, t, r) || this;
                return o.canHandleSpecificResources = !0,
            ...
            t.prototype.syncHeadHeights = function() {
                ...
                return this.spreadsheet.headHeight(e),
                this.headHeight(e),
                e
            },
            t.prototype.queryResourceScroll = function() {
                for (var e = {},
                t = this.timeBodyScroller.scrollEl.offset().top, r = 0, o = this.getVisibleRows(); r < o.length; r++) {
                    var n = o[r];
                    if (n.resource) {
                        var i = n.getTr("event"),
                        s = i.offset().top + i.outerHeight();
                        if (s > t) {
                            e.resourceId = n.resource.id,
                            e.bottom = s - t;
                            break
                        }
                    }
            ...
            t.prototype.prepareHits = function() {
                ...
                this.rowCoordCache = new a.CoordCache({
                    els: r,
                    isVertical: !0
                }),
            ...
            t.prototype.renderBusinessHours = function(e) {
                if (this.genericBiz = e, this.isIndiBizRendered = !1, this.isGenericBizRendered = !1, this.indiBizCnt) {
                    ...
                    for (var t = 0,
                    r = this.getEventRows(); t < r.length; t++) {
                        var o = r[t];
                        o.renderBusinessHours(o.resource.businessHourGenerator || e)
                    }
                } else this.isGenericBizRendered = !0,
                this.businessHourRenderer.render(e)
            },
            t.prototype.updateIndiBiz = function() { (this.indiBizCnt && this.isGenericBizRendered || !this.indiBizCnt && this.isIndiBizRendered) && (this.unrenderBusinessHours(), this.renderBusinessHours(this.genericBiz))
            },
            t.prototype.insertResource = function(e, t) {
                ...
                for (var i = 0,
                s = e.children; i < s.length; i++) {
                    var a = s[i];
                    this.insertResource(a, o)
                }
                return r && n(o.parent) && o.renderSkeleton(),
                o
            },
            t.prototype.removeResource = function(e) {
                var t = this.resourceRowHash[e.id];
                return t && (delete this.resourceRowHash[e.id], this.removeChild(t), t.removeFromParentAndDom(), e.businessHourGenerator && (this.indiBizCnt--, this.updateIndiBiz())),
                t
            },
            ...
            t.prototype.computeChildRowPosition = function(e, t) {
                if (this.orderSpecs.length) for (var r = 0; r < t.children.length; r++) {
                    var o = t.children[r],
                    n = this.compareResources(o.resource || {},
                    e.resource || {});
                    if (n > 0) return r
                }
                return null
            ...
            t.prototype.ensureResourceGroup = function(e, t, r) {
                ...
                return s || (s = this.isVGrouping ? new y["default"](this, r, i) : new g["default"](this, r, i), t.addChildRowNode(s, o), s.renderSkeleton()),
                s
            },
            t.prototype.descendantAdded = function(e) {
            ...
            t.prototype.descendantShown = function(e) { (this.rowsNeedingHeightSync || (this.rowsNeedingHeightSync = [])).push(e)
            },
            ...
            t.prototype.syncRowHeights = function(e, t) {
                void 0 === e && (e = this.getVisibleRows()),
                void 0 === t && (t = !1);
                for (var r = 0,
                o = e; r < o.length; r++) {
                    var n = o[r];
            ...
            t.prototype.unrenderEventResize = function() {
                for (var e = 0,
                t = this.getEventRows(); e < t.length; e++) {
                    var r = t[e];
            ...
            t.prototype.renderDrag = function(e, t, r) {
                ...
                for (i in a) {
                    ...
                    c = n; l < c.length; l++) {
                        var u = c[l];
                        s = this.getResourceRow(i),
                        s.renderHighlight(u.componentFootprint)
                    }
                }
                return ! 1
            },
        ...
        t["default"] = R,
        R.prototype.eventRendererClass = p["default"],
        u["default"].mixInto(R)
    },
    function(e, t, r) {
        Object.defineProperty(t, "__esModule", {
        ...
        s = function(e) {
            ...
            t.prototype.descendantShown = function(t) {
                this.rowspan += 1,
                this.renderRowspan(),
                e.prototype.descendantShown.call(this, t)
            },
            t.prototype.descendantHidden = function(t) {
                this.rowspan -= 1,
                this.renderRowspan(),
                e.prototype.descendantHidden.call(this, t)
            },
            t
        } (i["default"]);
        t["default"] = s
    ...
    function(e, t, r) {
        ...
        s = function(e) {
            ...
            t.prototype.renderGroupContentEl = function() {
                ...
                return "function" == typeof t && (e = t(e, this.groupValue) || e),
                e
            },
            t.prototype.renderGroupTextEl = function() {
                var e = this.groupValue || "",
                t = this.groupSpec.text;
                return "function" == typeof t && (e = t(e) || e),
                n('<span class="fc-cell-text" />').text(e)
            },
            t
        } (i["default"]);
        t["default"] = s
    ...
    function(e, t, r) {
        ...
        l = function(e) {
            ...
            t.prototype.componentFootprintToSegs = function(e) {
                for (var t = this.resourceCnt,
                r = this.sliceRangeByTimes(e.unzonedRange), o = [], i = 0, s = r; i < s.length; i++) for (var l = s[i], c = 0; c < t; c++) {
                    var u = this.flattenedResources[c];
                    if (! (e instanceof a["default"]) || e.resourceId === u.id) {
                        var d = n.extend({},
                        l);
                        d.resource = u,
                        d.col = this.indicesToCol(c, l.dayIndex),
                        o.push(d)
                    }
                }
                return o
    ...
    function(e, t, r) {
        ...
        l = function(e) {
            ...
            t.prototype.reportMovingEnd = function() {
                this.isMoving = !1,
                this.isTouching || this.reportScrollEnd()
            },
...
//            console.log(e)
            ...
            e.largeUnit = o,
            e.emphasizeWeeks = 1 === e.slotDuration.as("days") && e.currentRangeAs("weeks") >= 2 && !e.opt("businessHours");
        ...
        function i(e) {
            ...
            if (e.labelInterval && e.slotDuration) {
                ...
                if (!d.isInt(n) || n < 1) return d.warn("slotLabelInterval must be a multiple of slotDuration"),
                e.slotDuration = null
            }
        }
        function s(e) {
        ...
        function l(e) {
            ...
            case "year":
                ...
                break;
            case "month":
                e.currentRangeAs("years") > 1 && (s = "YYYY"),
                t = "MMM";
                break;
            case "week":
                e.currentRangeAs("years") > 1 && (s = "YYYY"),
                t = e.opt("shortWeekFormat");
                break;
            case "day":
                e.currentRangeAs("years") > 1 ? s = e.opt("monthYearFormat") : e.currentRangeAs("months") > 1 && (s = "MMMM"),
    ...
    function(e, t, r) {
        ...
        d = function() {
            ...
            return e.prototype.renderSkeleton = function() {
                ...
                this.bodyScroller = new i["default"]({
            ...
            e.prototype.renderHeadHtml = function() {
                for (var e = this.view.calendar.theme,
                t = this.view.colSpecs,
                r = '<table class="' + e.getClass("tableGrid") + '">', o = "<colgroup>", i = 0, s = t; i < s.length; i++) {
                    var a = s[i];
                ...
                r += o,
                r += "<tbody>",
                this.view.superHeaderText && (r += '<tr class="fc-super"><th class="' + e.getClass("widgetHeader") + '" colspan="' + t.length + '"><div class="fc-cell-content"><span class="fc-cell-text">' + n.htmlEscape(this.view.superHeaderText) + "</span></div></th></tr>"),
                r += "<tr>";
            ...
            e.prototype.applyColWidths = function() {
                for (var e, t, r, o = this.colMinWidths,
                n = this.colWidths,
                i = !0,
                s = !1,
                a = 0,
                l = 0,
                c = n; l < c.length; l++) r = c[l],
                "number" == typeof r ? a += r: (i = !1, r && (s = !0));
                var u = s && !this.view.isHGrouping ? "auto": "",
                d = n.map(function(e) {
                    return null != e ? e: u
                }),
                h = 0;
                for (t = 0; t < d.length; t++) e = d[t],
                h += "number" == typeof e ? e: o[t];
                for (t = 0; t < d.length; t++) e = d[t],
            ...
            e.prototype.updateCellFollower = function() {
                ...
                this.cellFollower.setSpriteEls(o(e)),
    ...
    function(e, t, r) {
        ...
        a = function(e) {
            function t(t, r) {
                ...
                return o.resource = r,
                o.eventRenderer.designatedResource = o.resource,
                o
            }
            return o.__extends(t, e),
            t.prototype.renderSkeleton = function() {
            ...
            t.prototype.renderEventSkeleton = function(t) {
                e.prototype.renderEventSkeleton.call(this, t),
                t.attr("data-resource-id", this.resource.id)
            },
            ...
            t.prototype.executeEventUnrender = function() {
                e.prototype.executeEventUnrender.call(this),
                this.eventsPayload = null
            },
            t.prototype.renderBusinessHours = function(t) {
                this.businessHourGenerator = t,
                this.get("isInDom") && e.prototype.renderBusinessHours.call(this, this.businessHourGenerator)
            },
            t.prototype.unrenderBusinessHours = function() {
                e.prototype.unrenderBusinessHours.call(this),
                this.businessHourGenerator = null
            },
            t.prototype.renderSpreadsheetSkeleton = function(e) {
                for (var t = this.view.calendar.theme,
                r = this.resource,
                o = 0,
                s = this.view.colSpecs; o < s.length; o++) {
                    var a = s[o];
                    if (!a.group) {
            ...
            t.prototype.renderGutterHtml = function() {
                for (var e = "",
                t = this.depth,
                r = 0; r < t; r++) e += '<span class="fc-icon"/>';
    ...
    function(e, t, r) {
        ...
        s = function(e) {
            ...
            t.prototype.renderSpreadsheetSkeleton = function(e) {
                ...
                return t.prepend('<span class="fc-expander"><span class="fc-icon"></span></span>'),
                n('<td class="fc-divider" />').attr("colspan", this.view.colSpecs.length).append(n("<div/>").append(t)).appendTo(e)
            },
            t.prototype.renderEventSkeleton = function(e) {
    ...
    function(e, t, r) {
        ...
        n.Calendar.prototype.constructed = function() {
            l.constructed.apply(this, arguments),
            this.resourceManager = new s["default"](this)
        },
        n.Calendar.prototype.instantiateView = function(e) {
            var t = this.viewSpecManager.getViewSpec(e),
            r = t["class"];
            return this.opt("resources") && t.options.resources !== !1 && (t.queryResourceClass ? r = t.queryResourceClass(t) || r: t.resourceClass && (r = t.resourceClass)),
            new r(this, t)
        },
        ...
        n.Calendar.prototype.getEventResources = function(e) {
            ...
            r = [];
            if (t) for (var o = 0,
            n = this.getEventResourceIds(t); o < n.length; o++) {
                var i = n[o],
    ...
    function(e, t, r) {
        ...
        s = function(e) {
            ...
            t.prototype.setResources = function(e) {
                ...
                }), i = [], s = 0, a = n; s < a.length; s++) t = a[s],
                this.addResourceToIndex(t) && i.push(t);
                for (var l = 0,
                c = i; l < c.length; l++) t = c[l],
                this.addResourceToTree(t);
                o ? this.trigger("reset", this.topLevelResources) : this.trigger("set", this.topLevelResources),
            ...
            t.prototype.removeResource = function(e) {
                ...
                return this.fetching ? this.fetching.then(function() {
                    ...
                    return e && (t.removeResourceFromTree(e), t.trigger("remove", e, t.topLevelResources)),
                    e
                }) : i.Promise.reject()
            },
            ...
            t.prototype.buildResource = function(e) {
                ...
                e),
                s = e.eventClassName;
                return o.id = String(null != e.id ? e.id: "_fc" + t.resourceGuid++),
    ...
    function(e, t, r) {
        ...
        n.Constraints.prototype.buildCurrentBusinessFootprints = function(e) {
            ...
            if (r) {
                for (var l = this._calendar.view,
                c = l.get("businessHourGenerator"), u = l.dateProfile.activeUnzonedRange, d = [], h = 0, p = t; h < p.length; h++) {
                    var i = p[h],
                    f = i.businessHourGenerator || c,
                    v = f.buildEventInstanceGroup(e, u);
                    if (v) for (var g = 0,
                    y = v.getAllEventRanges(); g < y.length; g++) {
                        var m = y[g];
    ...
    function(e, t, r) {
        ...
        n.View.prototype.setElement = function() {
            s.setElement.apply(this, arguments),
            this.watchResources()
        },
        n.View.prototype.removeElement = function() {
            this.unwatchResources(),
            s.removeElement.apply(this, arguments)
        },
        ...
        n.View.prototype.watchResources = function() {
            ...
            this.watch("initialResources", t,
            function(t) {
                return e.getInitialResources(t.dateProfile)
            }),
            this.watch("bindingResources", r,
            function(t) {
        ...
        n.View.watch("displayingEvents", ["displayingDates", "hasEvents", "currentResources"],
        function(e) {
        ...
        n.View.prototype.filterResourcesWithEvents = function(e, t) {
            for (var r = this.eventsPayloadToRanges(t), n = {},
            i = 0, s = r; i < s.length; i++) for (var a = s[i], l = 0, c = a.eventDef.getResourceIds(); l < c.length; l++) {
                var u = c[l];
                n[u] = !0
            }
            return o(e, n)
    ...
    function(e, t, r) {
        ...
        o.InteractiveDateComponent.prototype.isEventDefResourceEditable = function(e) {
            ...
            return null == t && (t = (e.source || {}).resourceEditable, null == t && (t = this.opt("eventResourceEditable"), null == t && (t = this.isEventDefGenerallyEditable(e)))),
            t
        }
    },
    function(e, t, r) {
    ...
    function(e, t, r) {
        ...
        o.DateSelecting.prototype.computeSelectionFootprint = function(e, t) {
            ...
            return e.resourceId && (r = new n["default"](r.unzonedRange, r.isAllDay, e.resourceId)),
            r
        }
    },
    function(e, t, r) {
        ...
        o.EventDragging.prototype.computeEventDropMutation = function(e, t, r) {
            ...
            if (e.resourceId && t.resourceId && e.resourceId !== t.resourceId && this.component.isEventDefResourceEditable(r)) {
                ...
                return s.oldResourceId = e.resourceId,
    ...
    function(e, t, r) {
        ...
        o.ExternalDropping.prototype.computeExternalDrop = function(e, t) {
            ...
            return e.resourceId && r.addResourceId(e.resourceId),
            r
        }
    },
    function(e, t, r) {
