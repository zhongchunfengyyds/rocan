         ...
         <input id="idcopy" class="nui-hidden" name="nextData.id" value="<b:write property='entity/id'/>" />
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
				...
				<tr>
                    ...
                    <td colspan="1">
                        <input id="inspectplan" value="<%=dataParms.get("inspectplan")==null?"":dataParms.get("inspectplan") %>" dictTypeId="option" class="nui-dictcombobox" name="preData.inspectplan"/>
                    </td>
                     <td colspan="1">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		...
		function onSubmit(){
	            ...
	            var jsonData = {};
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.ConventionalIslandOverhaulEdit.OverhaulEdit";
