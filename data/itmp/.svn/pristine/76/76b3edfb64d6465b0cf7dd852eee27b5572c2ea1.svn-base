...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,2000,false,true)" style="width: 100%" name="nextData.jcbw"/>
            </td>
            <td class="form_label" align="center">
                备注:
            </td>
            ...
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="nextData.bz"/>
            </td>
        </tr>
    </table>
    <table id="zq" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td id="c1ii" colspan="1">
                <div name="nextData.c1" id="combobox1i" class="nui-combobox" style="width:125px;" popupWidth="100"
            ...
            <td id="c2ii" colspan="1">
                <div name="nextData.c2" id="combobox2i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c3ii" colspan="1">
                <div name="nextData.c3" id="combobox3i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c4ii" colspan="1">
                <div name="nextData.c4" id="combobox4i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c5ii" colspan="1">
                <div name="nextData.c5" id="combobox5i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c6ii" colspan="1">
                <div name="nextData.c6" id="combobox6i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c7ii" colspan="1">
                <div name="nextData.c7" id="combobox7i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c8ii" colspan="1">
                <div name="nextData.c8" id="combobox8i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c9ii" colspan="1">
                <div name="nextData.c9" id="combobox9i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c10ii" colspan="1">
                <div name="nextData.c10" id="combobox10i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c11ii" colspan="1">
                <div name="nextData.c11" id="combobox11i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c12ii" colspan="1">
                <div name="nextData.c12" id="combobox12i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c13ii" colspan="1">
                <div name="nextData.c13" id="combobox13i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c14ii" colspan="1">
                <div name="nextData.c14" id="combobox14i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c15ii" colspan="1">
                <div name="nextData.c15" id="combobox15i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c16ii" colspan="1">
                <div name="nextData.c16" id="combobox16i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c17ii" colspan="1">
                <div name="nextData.c17" id="combobox17i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c18ii" colspan="1">
                <div name="nextData.c18" id="combobox18i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c19ii" colspan="1">
                <div name="nextData.c19" id="combobox19i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c20ii" colspan="1">
                <div name="nextData.c20" id="combobox20i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c21ii" colspan="1">
                <div name="nextData.c21" id="combobox21i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c22ii" colspan="1">
                <div name="nextData.c22" id="combobox22i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c23ii" colspan="1">
                <div name="nextData.c23" id="combobox23i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c24ii" colspan="1">
                <div name="nextData.c24" id="combobox24i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c25ii" colspan="1">
                <div name="nextData.c25" id="combobox25i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c26ii" colspan="1">
                <div name="nextData.c26" id="combobox26i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c27ii" colspan="1">
                <div name="nextData.c27" id="combobox27i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c28ii" colspan="1">
                <div name="nextData.c28" id="combobox28i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c29ii" colspan="1">
                <div name="nextData.c29" id="combobox29i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c30ii" colspan="1">
                <div name="nextData.c30" id="combobox30i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c31ii" colspan="1">
                <div name="nextData.c31" id="combobox31i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c32ii" colspan="1">
                <div name="nextData.c32" id="combobox32i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c33ii" colspan="1">
                <div name="nextData.c33" id="combobox33i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c34ii" colspan="1">
                <div name="nextData.c34" id="combobox34i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c35ii" colspan="1">
                <div name="nextData.c35" id="combobox35i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c36ii" colspan="1">
                <div name="nextData.c36" id="combobox36i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c37ii" colspan="1">
                <div name="nextData.c37" id="combobox37i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c38ii" colspan="1">
                <div name="nextData.c38" id="combobox38i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c39ii" colspan="1">
                <div name="nextData.c39" id="combobox39i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c40ii" colspan="1">
                <div name="nextData.c40" id="combobox40i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c41ii" colspan="1">
                <div name="nextData.c41" id="combobox41i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c42ii" colspan="1">
                <div name="nextData.c42" id="combobox42i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c43ii" colspan="1">
                <div name="nextData.c43" id="combobox43i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c44ii" colspan="1">
                <div name="nextData.c44" id="combobox44i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c45ii" colspan="1">
                <div name="nextData.c45" id="combobox45i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c46ii" colspan="1">
                <div name="nextData.c46" id="combobox46i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c47ii" colspan="1">
                <div name="nextData.c47" id="combobox47i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c48ii" colspan="1">
                <div name="nextData.c48" id="combobox48i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c49ii" colspan="1">
                <div name="nextData.c49" id="combobox49i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c50ii" colspan="1">
                <div name="nextData.c50" id="combobox50i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c51ii" colspan="1">
                <div name="nextData.c51" id="combobox51i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c52ii" colspan="1">
                <div name="nextData.c52" id="combobox52i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c53ii" colspan="1">
                <div name="nextData.c53" id="combobox53i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c54ii" colspan="1">
                <div name="nextData.c54" id="combobox54i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c55ii" colspan="1">
                <div name="nextData.c55" id="combobox55i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c56ii" colspan="1">
                <div name="nextData.c56" id="combobox56i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c57ii" colspan="1">
                <div name="nextData.c57" id="combobox57i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c58ii" colspan="1">
                <div name="nextData.c58" id="combobox58i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c59ii" colspan="1">
                <div name="nextData.c59" id="combobox59i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c60ii" colspan="1">
                <div name="nextData.c60" id="combobox60i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input id="reason" required="true" onvalidation="hasIllegalChar(e,100,true,true)" name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea"
                       style="width: 100%;"/>
            </td>
        </tr>
    </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(常规岛及BOP)_大修执行条目_修改通用";
        data.processInstDesc = "专用检查计划(常规岛及BOP)_大修执行条目_修改通用";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.OverhaulCurrencyEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.OverhaulEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.Currency";
