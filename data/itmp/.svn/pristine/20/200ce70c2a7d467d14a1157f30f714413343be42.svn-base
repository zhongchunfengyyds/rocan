...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectlength" vtype="float;range:0,99999" rangeErrorText="请输入正数" floatErrorText="请输入数字" emptyText="请输入缺陷长度" required="required" requiredErrorText="缺陷长度不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷方向</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectdirection" emptyText="请输入缺陷方向" required="required" requiredErrorText="缺陷方向不能为空" style="width: 100%" /></td>
			...
			<tr>
				<td class="form_label">a(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hfsda" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" /></td>
			</tr>
			</table>
			<fieldset id="baseInfo" style="width:100%;">
				<legend><span>X(mm)</span></legend>
			<table style="width: 100%; height: 100%; table-layout: fixed;"
			class="nui-form-table">
					<table style="width: 100%; height: 100%; table-layout: fixed;"
						class="nui-form-table">
				                <tr>
				                    <td class="form-label">A：</td>
				                    <td >
				                        <input class="nui-textbox" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" name="defectsshowdetailedinformation.hfsdxa"  style="width:80%;" />
				                    </td>
				                    <td class="form-label" ">B：</td>
				                    <td >
				                        <input class="nui-textbox" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" name="defectsshowdetailedinformation.hfsdxb"  style="width:80%;"/>
				                    </td>
				                </tr>
						</table>
				</fieldset>
				<fieldset id="baseInfo1" style="width:100%;">
				<legend><span>Y(mm)</span></legend>
			<table style="width: 100%; height: 100%; table-layout: fixed;"
			class="nui-form-table">
	                <tr>
	                    <td class="form-label" >A：</td>
	                    <td >
	                        <input class="nui-textbox" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" name="defectsshowdetailedinformation.hfsdya"/>
	                    </td>
	                    <td class="form-label" >B：</td>
	                    <td >
	                        <input class="nui-textbox"  vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" name="defectsshowdetailedinformation.hfsdyb" />
	                    </td>
	                  </tr>
	                  <tr>
	                    <td class="form-label" >C：</td>
	                    <td >
	                        <input class="nui-textbox" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"  style="width: 100%" name="defectsshowdetailedinformation.hfsdyc" />
	                    </td>
	                  </tr>
	              </table>
				</fieldset>
			...
			class="nui-form-table">	
			<tr>
				<td class="form_label">d(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hfsdd" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数" style="width: 100%" /></td>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"hfsdcs"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="hfsdcs";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "hfsdcs") {
