...
<div style="display:none;">
	...
	<script type="text/javascript">
    	...
    	function exp(){
            ...
            var json = nui.encode({fileds:fileds,queryParam:searchParam,dicFieds:dicFieds,jdFied:jdFied,jzFied:jzFied,order:order});
            var message = nui.loading("正在下载,请稍后...",'提示');
            nui.ajax({
                url: "com.cgn.itmp.basecommon.Common.expExcelByFiled.biz.ext",
                type: 'POST',
                data: json,
                success: function (text) {
