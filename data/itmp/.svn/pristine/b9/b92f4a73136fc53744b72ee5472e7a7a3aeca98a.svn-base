...
- Description:
    ...
    <body style="width:98%;height:95%;margin:0 auto;">
            ...
            <div class="nui-fit">
                <div id="datagrid1" dataField="tddxglfxgls" class="nui-datagrid" style="width:100%;height:100%;" url="com.cgn.itmp.dailyandoverhaul.overhaul.RiskMgt.queryTdDxglFxgls.biz.ext" pageSize="20" sizeList="[20,100,1000]" showPageInfo="true" multiSelect="true" onselectionchanged="selectionChanged" allowSortColumn="true" sortMode="client">
                    <div property="columns">
                        ...
                        <div field="type1" renderer="typeRenderer" headerAlign="center" allowSort="true" >
                            类型
                        </div>
        ...
        //恢复
                    function back(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tddxglfxgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({//com.cgn.itmp.dailyandoverhaul.overhaul.RiskMgt.LogicBackDeleteTdDxglFxgls
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.RiskMgt.LogicBackDeleteTdDxglFxgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.RiskMgt.deleteTdDxglFxgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
