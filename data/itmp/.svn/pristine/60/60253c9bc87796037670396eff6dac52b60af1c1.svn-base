            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
            	...
            	<td class="form_label"  align="center">
         		...
         		<td class="form_label"  align="center">
                    ...
                    <td>
                        <input id="prosource" class="nui-textbox" name="preData.prosource"/>
                    </td>
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.prosource"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="insystem" class="nui-textbox" name="preData.insystem"/>
                    </td>
                    <td colspan="1">
                        <input id="insystem" class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.insystem"/>
                    </td>
                    <td class="form_label"  align="center">
                        设备名称:
                    </td>
                    ...
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.equipment"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="seat" class="nui-textbox" name="preData.seat"/>
                    </td>
                    <td colspan="1">
                        <input id="seat" class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.seat"/>
                    </td>
                    <td class="form_label"  align="center">
                        图号:
                    </td>
                    <td>
                        <input id="mapno" class="nui-textbox" name="preData.mapno"/>
                    </td>
                    <td>
                        <input id="btnEdit1" class="nui-buttonedit" readonly="readonly" onclick="onButtonEdit(this,'1');" name="nextData.mapno"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="inspectionscope" class="nui-textbox" name="preData.inspectionscope"/>
                    </td>
                    <td colspan="1">
                        <input id="inspectionscope" class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.inspectionscope"/>
                    </td>
                    <td class="form_label"  align="center">
                        接近方式:
                    </td>
                    ...
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.approachmode"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="method" class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.method"/>
                    </td>
                    <td class="form_label"  align="center">
                         执行单位:
                    </td>
                    <td>
                        <input id="executionunit" class="nui-textbox" name="preData.executionunit"/>
                    </td>
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.executionunit"/>
                    </td>
         		</tr>
         		<tr>
         		<td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="rsemcycle" class="nui-textbox" name="preData.rsemcycle"/>
                    </td>
                    <td colspan="1">
                        <input id="rsemcycle" class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.rsemcycle"/>
                    </td>
                    <td class="form_label"  align="center">
                         检查周期(SAP):
                    </td>
                    <td>
                        <input id="sapcycle" class="nui-textbox" name="preData.sapcycle"/>
                    </td>
                    <td>
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)" name="nextData.sapcycle"/>
                    </td>
         		</tr>
         		<tr>
                    <td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                        <input id="inspectplan" dictTypeId="option"  class="nui-dictcombobox" name="preData.inspectplan"/>
                    </td>
                    <td colspan="1">
             ...
             <!-- 人员及原因信息 -->
              ...
              <tr>
              	...
              	<tr>
                    ...
                    <td colspan="2">
                        <input id="creator" name="nextData.creator" onvalidation="hasIllegalChar(e,32,false,true)" class="nui-textbox" value="<%=username %>"/>
                    </td>
                    <td class="form_label"  align="center">
                        修改日期:
                    </td>
              	...
              	<tr>
                    ...
                    <td colspan="5">
                        <input id="reason" required="true"  onvalidation="hasIllegalChar(e,4000,false,true)" name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea" style="width: 100%;"/>
                    </td>
                </tr>
                </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		  ...
		  nui.get("#btnSave").setEnabled(false);
				...
				data.processInstName = "规范非法定总纲_日常执行条目_修改";
				data.processInstDesc = "规范非法定总纲_日常执行条目_修改";
				data.processDefName = "com.cgn.itmp.outlineandplan.outline.editGffddRczxtm";
				data.middleEntity = "com.cgn.itmp.outlineandplan.outline.common.NonStaturory.NonStaturoryEdit";
         		data.realEntity = "com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity";
