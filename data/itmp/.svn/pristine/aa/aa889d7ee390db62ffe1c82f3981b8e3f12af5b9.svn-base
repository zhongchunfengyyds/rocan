...
function AjaxLoadingBox(cfg){
	...
	$.extend(this.config, cfg);
	if(AjaxLoadingBox.prototype.boundingBox) return;
	this.renderAjaxLoading();
	return this;
};

AjaxLoadingBox.prototype.boundingBox = null;

AjaxLoadingBox.prototype.renderAjaxLoading = function(){
	this.renderUI();
	
	this.bindUI();
};
AjaxLoadingBox.prototype.renderUI = function(){
	
	AjaxLoadingBox.prototype.boundingBox = $("<div id='animationTipBox'></div>");  
	var load = "<div class='load'>";  
    	load += "<div class='icon'><img src='./img/loading.png' style='width:100px;height:90px;'/></div>";  
    	load += "</div>";
    	load += "<div class='dec_txt' style='padding-top:0px;'>"+this.config.str+"</br></div>";
        AjaxLoadingBox.prototype.boundingBox.append(load);
        AjaxLoadingBox.prototype.boundingBox.appendTo(this.config.windowDom.document.body);
...
AjaxLoadingBox.prototype.bindUI = function(){
	_this = this;
};

//销毁  
AjaxLoadingBox.prototype.destroy = function(){  
    this._mask && this._mask.remove();  
    AjaxLoadingBox.prototype.boundingBox && AjaxLoadingBox.prototype.boundingBox.remove();   
    AjaxLoadingBox.prototype.boundingBox = null;
};
/**************************************************AjaxLoadingBox分割结束线******************************************************************/
...
TipBox.prototype.tipRenderUI = function(){  
    var tip = "<div class='tip'>";
        tip +="     <div class='icon'><img src='./img/tip.png' style='width:100px;height:90px;'/></div>";  
...
TipBox.prototype.successRenderUI = function(){
    var suc = "<div class='success'>";
        suc +=" <div class='icon'><img src='./img/success.png' style='width:100px;height:90px;'/></div>";  
...
TipBox.prototype.errorRenderUI = function(){  
    var err  = "<div class='lose'>";  
        err +=  "   <div class='icon'><img src='./img/error.png' style='width:100px;height:90px;'/></div>";  
