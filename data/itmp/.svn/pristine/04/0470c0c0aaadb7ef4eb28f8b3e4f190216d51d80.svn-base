...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1">
					<input id="bjbw" readOnly="readOnly" emptyText="请选择被检部位" name="defectsshowdetailedinformation.checklocation" class="nui-textbox" required="required" requiredErrorText="被检部位不能为空" style="width: 50%" />
			...
			<tr>
				...
				<td colspan="1"><input class="nui-dictcombobox" dictTypeId="YJJCFF"
					name="defectsshowdetailedinformation.inspectionmethod" emptyText="请选择检查方法" requiredErrorText="检查方法不能为空" required="required" style="width: 100%" /></td>
			...
			<tr>
				...
				<input class="nui-hidden" id="defectnum"
					name="defectsshowdetailedinformation.defectdisplaynumber" required="required" style="width: 100%" /></td>
					<td class="form_label">通道编号</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入通道编号" 
					name="defectsshowdetailedinformation.channelnumber" requiredErrorText="通道编号不能为空" required="required" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">在堆芯内的位置</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入在堆芯内的位置" 
					name="defectsshowdetailedinformation.corelocation" requiredErrorText="在堆芯内的位置不能为空" required="required" style="width: 100%" /></td>
				<td class="form_label">幅值（V）</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入幅值" 
					name="defectsshowdetailedinformation.amplitude" requiredErrorText="幅值不能为空" required="required" style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">相位（°）</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入相位" required="true" name="defectsshowdetailedinformation.phase"  requiredErrorText="相位不能为空" style="width: 100%" /></td>
				<td class="form_label">磨损深度(壁厚%)</td>
				<td colspan="1">
				<input name="defectsshowdetailedinformation.weardepth" class="nui-spinner" minValue="0" maxValue="100" />
				<!-- <input class="nui-textbox"
					name="defectsshowdetailedinformation.weardepth" required="required" style="width: 100%" /></td> -->
			</tr>
			<tr>
				<td class="form_label">三字符</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.threecharacter" style="width: 100%" /></td>
				<td class="form_label">测量通道</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入测量通道" 
					name="defectsshowdetailedinformation.measurementchannel" requiredErrorText="测量通道不能为空" required="required" style="width: 100%" /></td>
			</tr>
			<tr>
			<td class="form_label">磨损位置</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入磨损位置" 
					name="defectsshowdetailedinformation.wearlocation" requiredErrorText="磨损位置不能为空" required="required" style="width: 100%" /></td>
			<td class="form_label">是否超标缺陷</td>
				<td colspan="1"><input class='nui-dictcombobox' dictTypeId='ISORNO' nullItemText="请选择是否超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" url="" required="required" style="width: 100%" /></td>
			</tr>
			<tr>
			<td class="form_label">移位/堵管信息</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.displacementplugging" style="width: 100%" /></td>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   onload: function () {//弹出页面加载完成
		                    ...
		                    var data = {stencilplate:"ztgwl"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="ztgwl";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "ztgwl") {
