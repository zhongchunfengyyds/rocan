	...
	<div class="nui-fit" style="padding: 15px;padding-top: 2px;height:80%;overflow: visible;">
		...
		<!--<div class="tab-first">
			<div class="nav-second">
					<a class="nui-button" checkOnClick="true" checked="true" plain="true" id="toread"><b:message key="btn-toread"/><span class="statistics">0</span></a>
					<a class="nui-button" checkOnClick="true" plain="true" id="readed"><b:message key="btn-readed"/><span class="statistics">0</span></a>
			</div>
		</div>-->
			<!-- 列表 -->
			<div id="taskList" width="100%"  height="100%"  class="nui-datagrid"
				url="com.cgn.components.coframe.taskcenter.TaskManager.getCC2meList.biz.ext?readed=true"
			    ...
			    <div property="columns">
			        ...
			        <div header='<b:message key="task-current-dealt/user"/>' headerAlign="center" width="20">
			        	<div property="columns">
					        <div header='<b:message key="task-current-grammar"/>' field="currentPerson" width="20" headerAlign="center" allowSort="true"></div>
				        </div>
			        </div>
