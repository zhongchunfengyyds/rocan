...
<div id="dataform1" style="padding-top:5px;">
    <!-- hidden域 -->
    <input class="nui-hidden" name="nextData.<%=TokenUtil.TOKEN_STRING_NAME%>" id="userToken">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="wj" value="<%=dataParms.get("wj")==null?"":dataParms.get("wj") %>"
                       name="preData.wj"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="mybh"
                       value="<%=dataParms.get("mybh")==null?"":dataParms.get("mybh") %>" readonly="readonly"
                       name="preData.mybh"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("mybh")==null?"":editdataParms.get("mybh") %>" name="nextData.mybh"/>
            </td>
            <td class="form_label" align="center">
                进口:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="jk" value="<%=dataParms.get("jk")==null?"":dataParms.get("jk") %>"
                       readonly="readonly" name="preData.jk"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="ck" value="<%=dataParms.get("ck")==null?"":dataParms.get("ck") %>"
                       readonly="readonly" name="preData.ck"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="lct" value="<%=dataParms.get("lct")==null?"":dataParms.get("lct") %>"
                       name="preData.lct"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" value="<%=editdataParms.get("lct")==null?"":editdataParms.get("lct") %>"
                       name="nextData.lct"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea" id="jcbw" value="<%=dataParms.get("jcbw")==null?"":dataParms.get("jcbw") %>"
                       style="width: 100%" readonly="readonly" name="preData.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" value="<%=editdataParms.get("jcbw")==null?"":editdataParms.get("jcbw") %>"
                       style="width: 100%" name="nextData.jcbw"/>
            </td>
...
<script type="text/javascript">
    ...
    function onSubmit() {
        ...
        jsonData.modelName = '专用检查计划(常规岛及BOP)_大修';
        jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.OverhaulEdit';
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandOverhaul.Currency";
