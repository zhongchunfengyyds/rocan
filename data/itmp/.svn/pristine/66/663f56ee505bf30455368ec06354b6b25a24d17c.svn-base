		...
		<div class="search-container folding-menu" id="queryForm">
			<div style="width: 100%; height: 100%;">
				<table cellpadding="0" cellspacing="0" class="table Keywordsearchtable" style="height: 100%;">
					<tr class="">
							...
							<td colspan="1" style="width: 40%;"><div style="float: left;text-align: left;">
													显示周期---年度<input class="nui-spinner"  id="start" maxValue="2089" value="1991" minValue="1991" style="width: 55px" name=""/>-年度<input class="nui-spinner"  id="end" maxValue="2089" minValue="1991" value="2089" style="width: 55px" name=""/>
				...
				<div id="overhaulform" class="nui-form display" align="center" style="height: 17%">
					<!-- 数据实体的名称 -->
					<input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailySearch">
					<!-- 排序字段 -->
					...
					<table id="table1" class="table" style="height: 100%">
						...
						<tr>
							...
							<td colspan="1"><input id="combo1" class="nui-combobox" style="width:45%;" valueField="id" 
	        ...
	        <div class="container-fluid">
	            <div class="collapse navbar-collapse">
	                <div class="navbar-header">
                 	...
                 	年度<input class="nui-spinner"  id="start" maxValue="2089" value="1991" minValue="1991" style="width: 90px" name=""/>-年度<input class="nui-spinner"  id="end" maxValue="2089" value="2089" minValue="1991" style="width: 90px" name=""/>
							<a class="nui-button" onclick="search()" id="btnZq">
				               修改显示周期
				            </a>
	                </div>
            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="datetime" headerAlign="center" Align="center" allowSort="true" visible="false" dateFormat="yyyy-MM-dd HH:mm:ss">
                            日期
                        </div>
                        <div field="base" headerAlign="center" visible="false" allowSort="true" Align="center">
                            基地
                        </div>
                        <div field="crew" headerAlign="center" visible="false" allowSort="true" Align="center">
                            机组
                        </div>
                        <div field="protype" headerAlign="center" visible="false" allowSort="true" Align="center">
                            项目类型
                        </div>
                        <div field="parts" headerAlign="center" visible="false" allowSort="true" Align="center">
                            部件
                        </div>
                        <div field="itemno" headerAlign="center" allowSort="true" width="40">
                            项号
                        </div>
                        <div field="prosource" headerAlign="center" allowSort="true" Align="center" width="80">
                            项目来源
                        </div>
                        ...
                        <div field="mapno" renderer="setmapno" headerAlign="center" allowSort="true" Align="center">
                            图号
                        </div>
                        ...
                        <div field="method" headerAlign="center" allowSort="true" Align="center">
                            检查方法
                        </div>
                        <div field="executionunit" headerAlign="center" allowSort="true" Align="center">
                            执行单位
                        </div>
                        <div field="rsemcycle" headerAlign="center" allowSort="true" Align="center" width="120">
                            检查周期（RSEM)
                        </div>
                        <div field="sapcycle" headerAlign="center" allowSort="true" Align="center">
                            检查周期(SAP)
                        </div>
...
// 	            nui.get('baseid').setValue(jdid);
// 	            nui.get('crewid').setValue(jzid);
	            nui.get('tree1').setUrl("com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.getProtypeAndPartsData.biz.ext?baseid="+jdid+"&crewid="+jzid);
// 	            search();
...
tree.on("nodeselect", function (e) {
    if (e.isLeaf) {
       //grid.load({"criteria/_entity": "com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity","criteria/_expr[4]/parts" : e.node.name });
       nui.get('parts').setValue(e.node.name);
       parentid = e.node.parentid;
	   nui.get('protype').setValue(parentid);
       parms = "";
    } else {
       //grid.load({"criteria/_entity": "com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity","criteria/_expr[5]/protype" : e.node.name });
...
function add() {
	...
	if (row) {
		nui.open({showMaxButton : true,
	        url: "/itmp/outline/NonStaturory/Daily/addForm.jsp",
	        title: "新增记录", width: 800, height: 400,
	        onload: function () {//弹出页面加载完成
		        var iframe = this.getIFrameEl();
		        var data = {pageType:"add",record:{tdgglgfffdrctm:row},parts:row.parts,protype:row.protype};//传入页面的json数据
    	...
    	$.ajax({
                ...
                success:function(data){
                	...
                	if(returnJson.record != ''){
                		...
                		nui.open({
	                		showMaxButton : true,
				            url: "/itmp/outline/NonStaturory/Daily/editForm.jsp",
				            title: "编辑数据",
				            width: 800,
				            height: 400,
				            onload: function () {
...
function planupdate(flag){
 ...
 var processDef = flag==1 ? 'com.cgn.itmp.outlineandplan.outline.gfffdRczxtmPlanComplete' : 'com.cgn.itmp.outlineandplan.outline.gfffdRczxtmPlanCancel';
nui.open({
			showMaxButton : true,
	        url: encodeURI("/itmp/basecommon/workFolw/planUpdate.jsp?fieldName=id&reason=项号&relFieldName=relid&tsName=itemno&planFlag="+flag+"&modelFlag="+4+"&entity=com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity&processName=规范非法定总纲_日常执行条目&middleEntity=com.cgn.itmp.outlineandplan.outline.common.NonStaturory.NonStaturoryEdit&processDef="+processDef),
						  ...
						  nui.confirm("确定删除选中记录？","系统提示",
				                    function(action){
				                        if(action=="ok"){
				                            ...
				                            json.upFieldValue="1";
				                            json.entity="com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity";
				                            json = nui.encode(json);
						            ...
						            onload: function () {
							                ...
							                ,'processInstName':'规范非法定总纲_日常执行条目_删除','processInstDesc':'规范非法定总纲_日常执行条目_删除','entityType':'com.cgn.itmp.outlineandplan.outline.common.NonStaturory.NonStaturoryEdit','modelFlag':4}};
							                //直接从页面获取，不用去后台获取
							                iframe.contentWindow.setFormData(data);
				            },
				            ondestroy: function (action) {
...
function openrecord(){
	nui.open({showMaxButton : true,
            url: "/itmp/outline/NonStaturory/Daily/vitaeList.jsp",
            title: "变更履历",
            width: 1000,
            height: 520,
            onload: function () {
...
function synchronous(){
	var row = grid.getSelected();
    if (row) {
    	var jsondata = '{"tdgglgfffdrctm":'+ nui.encode(row)+'}';
        if('y' == row.inspectplan){
        	var urlStr = "com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.synchronous.biz.ext";
			$.ajax({
                url:urlStr,
                type:'POST',
                data:jsondata,
...
function recover(){
	nui.open({showMaxButton : true,
            url: "/itmp/outline/NonStaturory/Daily/recycleList.jsp",
            title: "回收站查询",
            width: 800,
            height: 400,
            onload: function () {
	   		 ...
	   		 var count = data.count;
	   			if(count > 0){
	   				nui.alert("该基地升版流程正在审批中,不能升版","提示");
						...
						nui.open({
							showMaxButton : true,
				            url: "/itmp/outlineCommon/dgEdition/edtionStart.jsp?modelFlag=4&entity=com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity&basename=base&crewname=crew&editionname=edition",
				            title: "升版",
				            width: 500,
				            height: 330,
				            onload: function () {
...
function output(){
    ...
    nui.open({showMaxButton : true,
        ...
        var data = {
                entityName:"com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailySearch",
                queryParam:json,								    //查询数据
                queryKey:'criteria',                              //查询实体名
                query:['itemno','method','detailed','parts','protype','base','crew'],  //按顺序放置
                expTitle:"规范非法定总纲管理日常执行条目",
...
function batchAdd(){
	...
	$.ajax({
        ...
        onload: function () {//弹出页面加载完成
            ...
            var data = {
            	pageType:"batchAdd",
            	tempFileName:"ffddgrczxtm.xlsx",
            	tempLoadName:"规范非法定总纲管理日常执行条目导入模板",
            	entitfName:"com.cgn.itmp.outlineandplan.outline.NonStaturoryDaily.DailyEntity"
            };//传入页面的json数据
