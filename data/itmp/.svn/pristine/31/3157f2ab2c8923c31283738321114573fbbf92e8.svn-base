...
<%--             <input id="id" class="nui-hidden" name="preData.id" value="<b:write property='dataParms/id'/>" /> --%>
      ...
      //驳回
		...
		function onSubmit(){
	            ...
	            jsonData.modelName = '十年计划(核岛)_大修';
	            jsonData.middleEntity = 'com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit';
	            jsonData.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaul.OverhaulEntity";
