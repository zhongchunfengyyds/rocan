...
<script type="text/javascript">
    ...
    //数据加载
		...
		function getBusinessId(){
			$.ajax({
				...
				type:'POST',
                data: nui.encode({processInstId : processInstId,entityType: 'com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaulPlan.PlanEntity'}),
                cache: false,
		...
		function getGridDatas(id){
 	 		...
 	 		var json =nui.encode({tgglndjhcgddxjhscs:d});
  			          $.ajax({
                        url:"com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaul.queryPlanGenerations.biz.ext",
                        type:'POST',
                        data:json,
    ...
    function onSubmit() {
            ...
            data.workItemId = nui.get('workItemId').getValue();
   		    ...
   		    data.backid = backid;
   		    if(backid == 'finish'){
   		    	 data.entityType="com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaulPlan.PlanEntity";
   		    	 data.isdelete = "4";
		        ...
		        function(action){
		           if(action=="ok"){
		        	 nui.get("#btnSubmit").setEnabled(false);
					    ...
					    json.entityType = "com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaulPlan.PlanEntity";
					    json.isdelete = "0";
