...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.PressurePipe"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.DailyConduitAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(常规岛及BOP)_日常执行条目_新增压力管道"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(常规岛及BOP)_日常执行条目_新增压力管道"/>
	...
	<td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea" style="width: 100%" onvalidation="hasIllegalChar(e,4000,false,true)"  name="data.bz"/>
            </td>
        </tr>
    </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
		...
		if(isadmin == 'true'){
			data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.PressurePipe';
		}
