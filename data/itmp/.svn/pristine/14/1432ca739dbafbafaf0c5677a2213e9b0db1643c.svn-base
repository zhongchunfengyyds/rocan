		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-dictcombobox" dictTypeId="YJJCFF" emptyText="请选择检查方法"
					name="defectsshowdetailedinformation.inspectionmethod" emptyText="请输入检查方法" required="required" requiredErrorText="检查方法不能为空" style="width: 100%" /></td>
			...
			<tr>
				...
				<td colspan="1">
				<div id="cbl1" class="mini-checkboxlist" repeatItems="3" repeatLayout="table" requiredErrorText="缺陷显示编号不能为空"
				...
				<input class="nui-hidden" id="defectnum"
					...
					<td class="form_label">缺陷显示所在螺栓/螺母标识号</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.boltsnutsnumber" emptyText="请输入缺陷显示所在螺栓/螺母标识号" required="required" requiredErrorText="缺陷显示所在螺栓/螺母标识号不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">显示位置</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.displayposition" emptyText="请输入显示位置" required="required" requiredErrorText="显示位置不能为空" style="width: 100%" /></td>
				<td class="form_label">显示信号幅值(V)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.displaysignalmagnitude" emptyText="请输入显示信号幅值" required="required" requiredErrorText="显示信号幅值不能为空" style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">标定螺栓/螺母上人工刻伤0.5mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n1" emptyText="请输入标定螺栓/螺母上人工刻伤0.5mm显示信号幅值" required="required" requiredErrorText="标定螺栓/螺母上人工刻伤0.5mm显示信号幅值不能为空"  style="width: 100%" /></td>
				<td class="form_label">标定螺栓/螺母上人工刻伤1mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n2" emptyText="请输入标定螺栓/螺母上人工刻伤1mm显示信号幅值" required="required" requiredErrorText="标定螺栓/螺母上人工刻伤1mm显示信号幅值不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">标定螺栓/螺母上人工刻伤2mm显示信号幅值（V）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitude_n3" emptyText="请输入标定螺栓/螺母上人工刻伤2mm显示信号幅值" required="required" requiredErrorText="标定螺栓/螺母上人工刻伤2mm显示信号幅值不能为空" style="width: 100%" /></td>
...
<td colspan="1"><input class='nui-dictcombobox' dictTypeId='ISORNO' nullItemText="请选择是否超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" required="required" style="width: 100%" /></td>				</tr>
			...
			<td class="form_label">备注</td>
				<td colspan="3"><input class="nui-textarea" 
					name="defectsshowdetailedinformation.templeremark" required="required" requiredErrorText="备注不能为空" style="width: 100%" /></td>
				</tr>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"lslm"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="lslm";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "lslm") {
