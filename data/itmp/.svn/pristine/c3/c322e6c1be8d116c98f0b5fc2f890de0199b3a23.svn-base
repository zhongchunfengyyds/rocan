...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" dictTypeId="ZYJCJH" value="CRG" value="<b:write property='entity/type'/>" name="delete_entity.type"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<b:write property='entity/columnsint'/>" name="delete_entity.columnsint"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" value="<b:write property='entity/row'/>"name="delete_entity.row"/>
            </td>
            <td class="form_label" align="center">
                检查类型:
            </td>
            <td colspan="1">
                <input class="nui-dictcombobox"value="<b:write property='entity/checktype'/>"  dictTypeId="JCLX" name="delete_entity.checktype"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<b:write property='entity/jccycle'/>" name="delete_entity.jccycle"/>
            </td>
        </tr>
        <tr>
            <td class="form_label"   align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function doWriteBackRealData() {
        ...
        var json = "{sourceEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit'," +
            "targetEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Tube'," +
