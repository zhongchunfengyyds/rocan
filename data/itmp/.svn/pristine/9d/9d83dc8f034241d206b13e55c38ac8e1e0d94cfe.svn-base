...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="gnwz"readonly="readonly" value="<%=dataParms.get("gnwz")==null?"":dataParms.get("gnwz") %>"name="preData.gnwz"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="sbname"readonly="readonly"value="<%=dataParms.get("sbname")==null?"":dataParms.get("sbname") %>" name="preData.sbname"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textbox"id="gkc"readonly="readonly" value="<%=dataParms.get("gkc")==null?"":dataParms.get("gkc") %>"name="preData.gkc"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"value="<%=editdataParms.get("gkc")==null?"":editdataParms.get("gkc") %>" name="nextData.gkc"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="sbnumber"value="<%=dataParms.get("sbnumber")==null?"":dataParms.get("sbnumber") %>"readonly="readonly" name="preData.sbnumber"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea"id="jcbw"readonly="readonly"  style="width: 100%" value="<%=dataParms.get("jcbw")==null?"":dataParms.get("jcbw") %>"name="preData.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea"  style="width: 100%" value="<%=editdataParms.get("jcbw")==null?"":editdataParms.get("jcbw") %>"name="nextData.jcbw"/>
            </td>
        </tr>
        <tr>
            <td class="form_label"   align="center">
...
<script type="text/javascript">
    ...
    function onSubmit(){
        ...
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Container";
