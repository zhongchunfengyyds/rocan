...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
        		...
        		textField="text" valueField="id"   multiSelect="false" required="required" value="系统自动编号" requiredErrorText="缺陷显示编号不能为空"
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.checkdirection" emptyText="请输入检查方向" required="required" requiredErrorText="检查方向不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.probeangle"  style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">最大回波幅值（dB）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.maximumechoamplitude" style="width: 100%" /></td>
				<td class="form_label">参考幅值（dB）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.referenceamplitude" style="width: 100%" /></td>
			</tr>
			</table>
						...
						class="nui-form-table">
				                <tr>
				                    ...
				                    <td >
				                        ...
				                        style="width: 100%" name="defectsshowdetailedinformation.maxfzx" style="width:80%;" />
				                    </td>
				                    <td class="form-label">Y：</td>
				                    <td >
				                        <input class="nui-textbox" 
				                        vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
				                        style="width: 100%" name="defectsshowdetailedinformation.maxfzy" style="width:80%;"/>
				                    </td>
				                    <td class="form-label">Z：</td>
				                    <td >
				                        <input class="nui-textbox"
				                        vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
				                         style="width: 100%" name="defectsshowdetailedinformation.maxfzz" style="width:80%;"/>
				                    </td>
				                </tr>
						</table>
				</fieldset>
			...
			class="nui-form-table">
	                <tr>
	                    ...
	                    <td >
	                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.rangex1" />
	                    </td>
	                    <td class="form-label" >X2：</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.rangex2" />
	                    </td>
	                    </tr>
	                    <tr>
	                    <td class="form-label" >Y1：</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.rangey1"/>
	                    </td>
	                    <td class="form-label" >Y2：</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.rangey2"/>
	                    </td>
	                	</tr>
	                	<tr>
	                    <td class="form-label" >Z1:</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.rangez1"/>
	                    </td>
	                    <td class="form-label" >Z2:</td>
	                    <td >
	                        <input class="nui-textbox"  style="width: 100%" name="defectsshowdetailedinformation.rangez2"/>
	                    </td>
	                	</tr>
	              </table>
				</fieldset>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
					name="defectsshowdetailedinformation.diameterd" style="width: 100%" /></td>
...
<td colspan="1"><input class='nui-dictcombobox' dictTypeId='ISORNO' nullItemText="请选择是否超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" required="required" style="width: 100%" /></td>			
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"rpvzdcs"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="rpvzdcs";
