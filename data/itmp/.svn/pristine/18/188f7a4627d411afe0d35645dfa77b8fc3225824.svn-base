	...
	<div class="search-box">
		<div class="search-container folding-menu" id="queryForm">
			<div style="width: 100%; height: 100%;">
					<table cellpadding="0" cellspacing="0" class="table Keywordsearchtable" style="height: 100%;">
						...
						<div id="form1" class="nui-form display" align="center" style="height: 10%">
							...
							<input class="nui-hidden" name="criteria/_orderby[1]/_property" value="defectdisplaynumber">
							 ...
							 <input class="nui-hidden" name="criteria/_expr[12]/jd" value="" id="con_jdid">
							  <input class="nui-hidden" name="criteria/_expr[12]/_op" value="=">			
							   <input class="nui-hidden" name="criteria/_expr[13]/jz" value="" id="con_jzid">
						...
						<!-- <div property="footer" class="searchfooter" align="center">
							<a class="nui-button" onclick="btnQuery()"> 模糊查询 </a> <a class="nui-button" onclick="search()"> 查询 </a> <a class="nui-button"
							 onclick="reset()"> 重置 </a>
				...
				<div id="gridField" style="width:100%;height:80%;margin-top:3%" ></div>
				<div style="position:absolute;left:50%;transform: translate(-50%, 0);bottom:5;text-align:center">
					<a class="nui-button" id="colseStyle" style="background: #60B1E3;color:#ffffff;border-radius: 4px;" onclick="onCancel()"> <span style="color:#ffffff">关闭</span> </a> 
				</div>
				</body>		
...
function setFormData(data) {
	...
	checklocation = data.checklocation;
	stencilplate=data.stencilplate;
	overhaulsequence=data.overhaulsequence;
	...
	table1.innerHTML="<tr>"
                    ...
                    +"<tr>"
                        ...
                        +"</td>"
                         +"<input id='checklocation' class='nui-hidden' name='criteria/_expr[5]/checklocation'/>"
                        +"<input class='nui-hidden' name='criteria/_expr[5]/_op' value='='>"
                        +"<input id='overhaulsequence' class='nui-hidden' name='criteria/_expr[6]/overhaulsequence'/>"
                        +"<input class='nui-hidden' name='criteria/_expr[6]/_op' value='='>"
                         +"<input id='stencilplate' class='nui-hidden' name='criteria/_expr[7]/stencilplate'/>"
                        +"<input class='nui-hidden' name='criteria/_expr[7]/_op' value='='>"
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,boltsnutsnumbe,displayposition,influence";
	}else
	...
	table1.innerHTML="<tr>"
                    ...
                    +"<tr>"
                        ...
                        +"<input id='overhaulsequence' class='nui-hidden' name='criteria/_expr[9]/overhaulsequence'/>"
                        +"<input class='nui-hidden' name='criteria/_expr[9]/_op' value='='>"
                         +"<input id='stencilplate' class='nui-hidden' name='criteria/_expr[10]/stencilplate'/>"
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="corelocation,corelocation";
			var cxdata=[
				{"id":"49","name":">=50"},
				{"id":"50","name":"<50"}];	
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,defectdirection,defecttype";
	}else
	if(pageType=="rplsdcs"){
	table1.innerHTML="<tr>"
						+"<td class='form_label'>缺陷显示编号:</td><td colspan='1'>"
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,boltidentificationnumber,defecttype,depthposition,circumferentialposition";
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,keywayedgenumber,defecttype";
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,identificationmark,defecttype";
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,checkdirection,defecttype";
	}else
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,defecttype";
	}else
	if(pageType=="paut"){
	table1.innerHTML="<tr>"
						+"<td class='form_label'>缺陷显示编号:</td><td colspan='1'>"
	...
	table1.innerHTML="<tr>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,defectproperty";
	}else
	...
	table1.innerHTML="<tr>"
					    ...
					    +"<input id='defectdisplaynumber' class='nui-textbox' name='criteria/_expr[2]/defectlocation'/>"
                    ...
                    +"</tr>";
            nui.parse();      
			matchFied="defectdisplaynumber,defectlocation";
	}else
	if(pageType=="cctv"){
	table1.innerHTML="<tr>"
						+"<td class='form_label'>缺陷显示编号:</td><td colspan='1'>"
			...
			if(checklocation != 'null' && checklocation != null && checklocation != ''){
			nui.get('checklocation').setValue(checklocation);
			}
			if(overhaulsequence != 'null' && overhaulsequence != null && overhaulsequence != ''){
			nui.get('overhaulsequence').setValue(overhaulsequence);
			}
...
var gjz = document.getElementById("cond").value;
			if (gjz == "") {
				...
				var data = {
					...
					matchFiedFM:"checklocation,"+nui.get('checklocation').value,
					matchFiedFY:"overhaulsequence,"+nui.get('overhaulsequence').value,
		 ...
		 //重新刷新页面
                                ...
                                function reset(){
									...
									checklocation=nui.get('checklocation').value;
									overhaulsequence=nui.get('overhaulsequence').value;
									form.reset();
									if(checklocation != 'null' && checklocation != null && checklocation != ''){
										nui.get('checklocation').setValue(checklocation);
										}
