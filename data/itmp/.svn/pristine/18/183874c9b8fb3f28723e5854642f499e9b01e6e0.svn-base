	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.identificationmark" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷类型</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defecttype" required="required" style="width: 100%" /></td>
				<td class="form_label">信号幅度Hd(dB)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.signalamplitudehd" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">X1</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.x1" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">Xmax</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.xmax" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">X2</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.x2" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">Ymax</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.ymax" readOnly="readOnly" style="width: 100%" /></td>
					
			</tr>
			<tr>	
					<td class="form_label">Zmax</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.zmax" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">观察结果</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.observationresults" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
