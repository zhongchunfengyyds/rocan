...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" id="bjmc" name="defectsshowdetailedinformation.componentname"
					 readOnly="readOnly" style="width: 100%" emptyText="选择被检部位自动回填" requiredErrorText="部件名称不能为空" required="required"/></td>
			...
			<fieldset id="baseInfo" style="width:100%;">
				<legend><span>机器坐标（顶盖）</span></legend>
					<table style="width: 100%; height: 100%; table-layout: fixed;"
						class="nui-form-table">
				                <tr>
				                    <td class="form-label">1#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover1" />
				                    </td>
				                    <td class="form-label">2#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover2"  />
				                    </td>
				                 </tr>
				                 <tr>
				                    <td class="form-label">3#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover3" />
				                    </td>
				                    <td class="form-label">5#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover5" />
				                    </td>
				                </tr>
				                <tr>
				                    <td class="form-label">6#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover6" />
				                    </td>
				                    <td class="form-label">7#</td>
				                    <td >
				                        <input class="nui-textbox" style="width: 100%" name="defectsshowdetailedinformation.topcover7" />
				                    </td>
				                </tr>
						</table>
				</fieldset>
			...
			class="nui-form-table">
	                <tr>
	               		...
	               		<td class="form_label" rowspan="2">	 稳压器/蒸发器</td>
	               		<td class="form_label">机器坐标</td>
	               			<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.machinecoordinates" style="width: 100%" />
				</td>
	                </tr>
	                <tr>
	               		<td class="form_label">实际坐标</td>
	               		<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.actualcoordinates" style="width: 100%" />
				</td>
	                </tr>		
	          <tr>    
			...
			<tr>    
				...
				<td colspan="3">
					...
					name="defectsshowdetailedinformation.templeremark" style="width: 100%" />
				</td>
			</tr>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"cctv"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="cctv";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "cctv") {
