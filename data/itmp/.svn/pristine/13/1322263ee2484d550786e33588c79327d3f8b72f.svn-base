...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" id="type" dictTypeId="CGDRC" name="preData.type"/>
            </td>
            <td>
            </td>
			<td class="form_label" align="center">
            ...
            <td colspan="1">
            	<input id="protype" class="nui-dictcombobox"  readonly="readonly" required="true" dictTypeId="protype" name="preData.xt"/>
            </td>
            <td colspan="1">
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" readonly="readonly" name="preData.checkprojectname"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"  onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.checkprojectname"/>
            </td>
            <td class="form_label" align="center">
                维护项目:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="rwqd" readonly="readonly" name="preData.rwqd"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.rwqd"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gl" readonly="readonly" name="preData.gl"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gl"/>
            </td>
            <td class="form_label" align="center">
                管线号:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="gxh" readonly="readonly" name="preData.gxh"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gxh"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="zysb" readonly="readonly" name="preData.zysb"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.zysb"/>
            </td>
            <td class="form_label" align="center">
                材质:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="cz" readonly="readonly" name="preData.cz"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.cz"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gczj" readonly="readonly" name="preData.gczj"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gczj"/>
            </td>
            <td class="form_label" align="center">
                外径(mm):
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="wj" readonly="readonly" name="preData.wj"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.wj"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="mybh" name="preData.mybh"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.mybh"/>
            </td>
            <td class="form_label" align="center">
                进口:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="jk" name="preData.jk"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.jk"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="ck" name="preData.ck"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.ck"/>
            </td>
            <td class="form_label" align="center">
                流程图/等轴图号:
            </td>
            <td colspan="1">
                <input class="nui-textarea" id="lct" style="width: 100%" name="preData.lct"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="nextData.lct"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textarea" id="jcbw" readonly="readonly" style="width: 100%" name="preData.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="nextData.jcbw"/>
            </td>
            <td class="form_label" align="center">
                备注:
            </td>
            <td colspan="1">
                <input class="nui-textarea" id="bz" readonly="readonly" style="width: 100%" name="preData.bz"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)" style="width: 100%" name="nextData.bz"/>
            </td>
        </tr>
    </table>
    <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td id="c1991ii" colspan="1">
                <div name="nextData.c1991" id="combobox1991i" class="nui-combobox" style="width:125px;" popupWidth="100"
            ...
            <td id="c1992ii" colspan="1">
                <div name="nextData.c1992" id="combobox1992i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c1993ii" colspan="1">
                <div name="nextData.c1993" id="combobox1993i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c1994ii" colspan="1">
                <div name="nextData.c1994" id="combobox1994i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c1995ii" colspan="1">
                <div name="nextData.c1995" id="combobox1995i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c1996ii" colspan="1">
                <div name="nextData.c1996" id="combobox1996i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c1997ii" colspan="1">
                <div name="nextData.c1997" id="combobox1997i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c1998ii" colspan="1">
                <div name="nextData.c1998" id="combobox1998i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c1999ii" colspan="1">
                <div name="nextData.c1999" id="combobox1999i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2000ii" colspan="1">
                <div name="nextData.c2000" id="combobox2000i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2001ii" colspan="1">
                <div name="nextData.c2001" id="combobox2001i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2002ii" colspan="1">
                <div name="nextData.c2002" id="combobox2002i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2003ii" colspan="1">
                <div name="nextData.c2003" id="combobox2003i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2004ii" colspan="1">
                <div name="nextData.c2004" id="combobox2004i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2005ii" colspan="1">
                <div name="nextData.c2005" id="combobox2005i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2006ii" colspan="1">
                <div name="nextData.c2006" id="combobox2006i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2007ii" colspan="1">
                <div name="nextData.c2007" id="combobox2007i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2008ii" colspan="1">
                <div name="nextData.c2008" id="combobox2008i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2009ii" colspan="1">
                <div name="nextData.c2009" id="combobox2009i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2010ii" colspan="1">
                <div name="nextData.c2010" id="combobox2010i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2011ii" colspan="1">
                <div name="nextData.c2011" id="combobox2011i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2012ii" colspan="1">
                <div name="nextData.c2012" id="combobox2012i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2013ii" colspan="1">
                <div name="nextData.c2013" id="combobox2013i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2014ii" colspan="1">
                <div name="nextData.c2014" id="combobox2014i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2015ii" colspan="1">
                <div name="nextData.c2015" id="combobox2015i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2016ii" colspan="1">
                <div name="nextData.c2016" id="combobox2016i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2017ii" colspan="1">
                <div name="nextData.c2017" id="combobox2017i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2018ii" colspan="1">
                <div name="nextData.c2018" id="combobox2018i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2019ii" colspan="1">
                <div name="nextData.c2019" id="combobox2019i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2020ii" colspan="1">
                <div name="nextData.c2020" id="combobox2020i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2021ii" colspan="1">
                <div name="nextData.c2021" id="combobox2021i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2022ii" colspan="1">
                <div name="nextData.c2022" id="combobox2022i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2023ii" colspan="1">
                <div name="nextData.c2023" id="combobox2023i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2024ii" colspan="1">
                <div name="nextData.c2024" id="combobox2024i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2025ii" colspan="1">
                <div name="nextData.c2025" id="combobox2025i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2026ii" colspan="1">
                <div name="nextData.c2026" id="combobox2026i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2027ii" colspan="1">
                <div name="nextData.c2027" id="combobox2027i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2028ii" colspan="1">
                <div name="nextData.c2028" id="combobox2028i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2029ii" colspan="1">
                <div name="nextData.c2029" id="combobox2029i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2030ii" colspan="1">
                <div name="nextData.c2030" id="combobox2030i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2031ii" colspan="1">
                <div name="nextData.c2031" id="combobox2031i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2032ii" colspan="1">
                <div name="nextData.c2032" id="combobox2032i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2033ii" colspan="1">
                <div name="nextData.c2033" id="combobox2033i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2034ii" colspan="1">
                <div name="nextData.c2034" id="combobox2034i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2035ii" colspan="1">
                <div name="nextData.c2035" id="combobox2035i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2036ii" colspan="1">
                <div name="nextData.c2036" id="combobox2036i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2037ii" colspan="1">
                <div name="nextData.c2037" id="combobox2037i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2038ii" colspan="1">
                <div name="nextData.c2038" id="combobox2038i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2039ii" colspan="1">
                <div name="nextData.c2039" id="combobox2039i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2040ii" colspan="1">
                <div name="nextData.c2040" id="combobox2040i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2041ii" colspan="1">
                <div name="nextData.c2041" id="combobox2041i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2042ii" colspan="1">
                <div name="nextData.c2042" id="combobox2042i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2043ii" colspan="1">
                <div name="nextData.c2043" id="combobox2043i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2044ii" colspan="1">
                <div name="nextData.c2044" id="combobox2044i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2045ii" colspan="1">
                <div name="nextData.c2045" id="combobox2045i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2046ii" colspan="1">
                <div name="nextData.c2046" id="combobox2046i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2047ii" colspan="1">
                <div name="nextData.c2047" id="combobox2047i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2048ii" colspan="1">
                <div name="nextData.c2048" id="combobox2048i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2049ii" colspan="1">
                <div name="nextData.c2049" id="combobox2049i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2050ii" colspan="1">
                <div name="nextData.c2050" id="combobox2050i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2051ii" colspan="1">
                <div name="nextData.c2051" id="combobox2051i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2052ii" colspan="1">
                <div name="nextData.c2052" id="combobox2052i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2053ii" colspan="1">
                <div name="nextData.c2053" id="combobox2053i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2054ii" colspan="1">
                <div name="nextData.c2054" id="combobox2054i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2055ii" colspan="1">
                <div name="nextData.c2055" id="combobox2055i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2056ii" colspan="1">
                <div name="nextData.c2056" id="combobox2056i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2057ii" colspan="1">
                <div name="nextData.c2057" id="combobox2057i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2058ii" colspan="1">
                <div name="nextData.c2058" id="combobox2058i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2059ii" colspan="1">
                <div name="nextData.c2059" id="combobox2059i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2060ii" colspan="1">
                <div name="nextData.c2060" id="combobox2060i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2061ii" colspan="1">
                <div name="nextData.c2061" id="combobox2061i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2062ii" colspan="1">
                <div name="nextData.c2062" id="combobox2062i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2063ii" colspan="1">
                <div name="nextData.c2063" id="combobox2063i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2064ii" colspan="1">
                <div name="nextData.c2064" id="combobox2064i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2065ii" colspan="1">
                <div name="nextData.c2065" id="combobox2065i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2066ii" colspan="1">
                <div name="nextData.c2066" id="combobox2066i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2067ii" colspan="1">
                <div name="nextData.c2067" id="combobox2067i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2068ii" colspan="1">
                <div name="nextData.c2068" id="combobox2068i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2069ii" colspan="1">
                <div name="nextData.c2069" id="combobox2069i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2070ii" colspan="1">
                <div name="nextData.c2070" id="combobox2070i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2071ii" colspan="1">
                <div name="nextData.c2071" id="combobox2071i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2072ii" colspan="1">
                <div name="nextData.c2072" id="combobox2072i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2073ii" colspan="1">
                <div name="nextData.c2073" id="combobox2073i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2074ii" colspan="1">
                <div name="nextData.c2074" id="combobox2074i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2075ii" colspan="1">
                <div name="nextData.c2075" id="combobox2075i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2076ii" colspan="1">
                <div name="nextData.c2076" id="combobox2076i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2077ii" colspan="1">
                <div name="nextData.c2077" id="combobox2077i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2078ii" colspan="1">
                <div name="nextData.c2078" id="combobox2078i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2079ii" colspan="1">
                <div name="nextData.c2079" id="combobox2079i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2080ii" colspan="1">
                <div name="nextData.c2080" id="combobox2080i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2081ii" colspan="1">
                <div name="nextData.c2081" id="combobox2081i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2082ii" colspan="1">
                <div name="nextData.c2082" id="combobox2082i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2083ii" colspan="1">
                <div name="nextData.c2083" id="combobox2083i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2084ii" colspan="1">
                <div name="nextData.c2084" id="combobox2084i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2085ii" colspan="1">
                <div name="nextData.c2085" id="combobox2085i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2086ii" colspan="1">
                <div name="nextData.c2086" id="combobox2086i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2087ii" colspan="1">
                <div name="nextData.c2087" id="combobox2087i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="c2088ii" colspan="1">
                <div name="nextData.c2088" id="combobox2088i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="c2089ii" colspan="1">
                <div name="nextData.c2089" id="combobox2089i" class="nui-combobox" style="width:125px;" popupWidth="100"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td colspan="2">
                <input id="datetime" name="nextData.datetime" style="width: 100%" class="nui-textbox"
                       value="<%=dataTime %>"/>
            </td>
        </tr>
    </table>
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="5">
                <input id="reason" required="true" onvalidation="hasIllegalChar(e,4000,true,true)" name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea"
                       style="width: 100%;"/>
            </td>
        </tr>
    </table>
...
<!--                        id="jhry" name="jhry" textField="empname" style="width:100%" -->
<!--                        url="" required="true" -->
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    $(function () {
        ...
        $("^[name^='tcgn']").css('text-align', 'center');
    });
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(常规岛及BOP)_日常执行条目_修改通用";
        data.processInstDesc = "专用检查计划(常规岛及BOP)_日常执行条目_修改通用";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyCurrencyEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.Currency";
    ...
    function setFormData(data) {
        ...
        if (infos.pageType == "edit") {
            ...
            form.setData(json);
            form.setChanged(false);
            nui.get('protype').setValue(json.preData.xt);
            var uuid = json.preData.uuid;
            if (uuid == undefined) uuid = json.preData.uuid;
            nui.get("jd").setValue(json.preData.jd);
            nui.get("creator").setValue('<%=username %>');
            nui.get("datetime").setValue('<%=dataTime %>');
            var url = "com.cgn.itmp.basecommon.DictionaryOperation.getJzDicInfoByjdid.biz.ext?jdid=" + json.preData.jd;
            nui.get("jzid").setUrl(url);
            nui.get("reason").setValue('');
            var parms = "{baseid:" + json.preData.jd + ",crewid:" + json.preData.jz + ",type:n}";
