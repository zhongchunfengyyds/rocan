	...
	<div id="dataform1" style="padding-top: 5px;">
		...
		<table id="table"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" readonly="readonly" required="true" requiredErrorText="焊接质量计划编号不能为空" emptyText="请输入焊接质量计划编号"   
				style="width: 100%" name="quality.qualitynumber" /></td>
				<td class="form_label">主票号</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="主票号不能为空" emptyText="请输入主票号"  
					style="width: 100%" name="quality.ticketnumber" /></td>
				<td class="form_label">功能位置</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="功能位置不能为空" emptyText="请输入功能位置"  
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="部件1不能为空" emptyText="请输入部件1"  
					style="width: 100%" name="quality.uppername" /></td>

				<td class="form_label">部件2</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="部件2不能为空" emptyText="请输入部件2"  
					style="width: 100%" name="quality.downname" /></td>

				<td class="form_label">图纸/版本</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="图纸/版本不能为空" emptyText="请输入图纸/版本"  
					style="width: 100%" name="quality.equiaxedgraph" /></td>


				<td class="form_label">焊缝编码</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="焊缝编码不能为空" emptyText="请输入焊缝编码"  
					style="width: 100%" name="quality.weldnumber" /></td>
				<td class="form_label">接头形式</td>
				<td colspan="1"><input id="formCombo" name="quality.form"
					required="true" requiredErrorText="接头形式不能为空" emptyText="请选择接头形式" class="nui-dictcombobox" dictTypeId="JTXS"
					style="width: 100%;" /></td>
			</tr>
			<tr>
				<td class="form_label">接口尺寸</td>
				<td colspan="2"><input class="nui-textbox" required="true" requiredErrorText="接口尺寸不能为空" emptyText="请输入接口尺寸"  
				...
				<td colspan="1">
					<!-- <div name="quality.welding_method" required="true" requiredErrorText="焊接方法不能为空" emptyText="请选择焊接方法"   
						id="combobox2" class="nui-combobox" style="width: 100%;"
						popupWidth="150" textField="name" valueField="id" url=""
						multiSelect="false" dataField="jsonObject"></div> -->
						<input class="nui-textbox" id="weldingMethod" name="quality.welding_method" style="width:100%" readonly="readonly" required="true" requiredErrorText="焊接方法不能为空" emptyText="请选择焊接方法" />
				</td>
				<td class="form_label">地理位置</td>
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="地理位置不能为空" emptyText="请输入地理位置"  
					style="width: 100%" name="quality.geographicalposition" /></td>
			</tr>
			<tr>
				<td class="form_label">接口厚度</td>
				<td colspan="2"><input class="nui-textbox" required="true" requiredErrorText="接口厚度不能为空" emptyText="请输入接口厚度"  
				...
				<td colspan="1"><input class="nui-textbox" required="true" requiredErrorText="制造级别不能为空" emptyText="请输入制造级别"  
					style="width: 100%" name="quality.level" /></td>
				<td class="form_label">焊接填充材料</td>
				<td colspan="1">
					<!-- <div name="quality.model_specifications" onvaluechanged="tconvalueChanged" id="combobox3" class="nui-combobox" 
					required="true" requiredErrorText="焊接填充材料不能为空" emptyText="请选择焊接填充材料"  style="width:100%;"  popupWidth="150" textField="name" valueField="id" 
				...
				<td colspan="1">
					<!-- <div name="quality.batchnumber"
						required="true" requiredErrorText="批号不能为空" emptyText="请选择批号"   id="combobox4" class="nui-combobox"
						style="width: 100%;" popupWidth="150" textField="name"
						valueField="id" url="" multiSelect="false" dataField="jsonObject">
					</div> -->
			...
			<tr>
				...
				<td colspan="2"><input class="nui-textbox" required="true" requiredErrorText="母材材质不能为空" emptyText="请输入母材材质"  
			...
			<tr>
				<td colspan="11">
	             		<div style="width: 99%;">
		             		<a class="mini-button" id="add" onclick="addtemp()" plain="true" >增加</a>
		             		<a class="mini-button" id="remove" onclick="testq()" plain="true" >删除</a>
	             		（动态添加字段）
	             		</div>
	             		<div style="width: 100%">
			...
			<tr>
				<td colspan="11">
					...
					<tr>
						<td class="form_label">
							编写: </td>
							<td><input class="nui-hidden" name="quality.applicant" /></td>
						<td class="form_label">
							审查:</td>
							<td> <input class="nui-hidden" name="quality.examinant" /></td>
						<td class="form_label">
							复核: </td>
							<td><input class="nui-hidden" name="quality.reviewer" /></td>
						<td class="form_label">
							工作负责人:</td>
			...
			<tr>
				<td colspan="11" style="text-align: center;">
					<a class="nui-button" id="save" onclick="checkforword()">下一步</a>	
	...
	<script type="text/javascript">
		...
		function checkforword(){
				   ...
				   if(k >= 2){
				   		for(var i = 1; i < k; i++){
				   			if($("#qualityname"+i).val() !="" && $("#qualityvalue"+i).val() !="" ){
				   				...
				   				data1.quality["name"+i] = "";
				   				data1.quality["value"+i] = "";
				   			}
				   		}
				   }else{
					   	for(var j = 1; j < 5; j++){
			       ...
			       if((nui.get('combobox5').getValue())!= '' && data1.quality.workingprocedure != nui.get('combobox5').getValue()){
					...
					var entityName = "com.cgn.itmp.weldingmanagement.Quality.Quality";
					if(relationid != ''){
						entityName = "com.cgn.itmp.weldingmanagement.QualityBackup.WeldingQualityBackup";
					}
					$.ajax({
	                    url:'com.cgn.itmp.weldingmanagement.weldingapplybiz.updateQualityOrBackup.biz.ext',
	                    type:'POST',
	                    data:nui.encode({
		                    			data : data1.quality,
		...
		function setFormData(data) {
			...
			if (infos.pageType != '') {
               ...
               if(json.quality.name4 != null && json.quality.name4 != ""){
				...
				//loadingTip.destroy();
				if(infos.pageType != 'first' || infos.daiyue == "1"){
					loadTemplateData(json.quality.workingprocedure,true);
					$("#add").hide();
					$("#remove").hide();
					$("#save").hide();
					$("#processOpe").hide();
					...
					loadTemplateData(json.quality.workingprocedure,false);
				}
			}
            ...
            function addtemp(){
				...
				dynamicColumn.append("<tr>"+
		             				"<td class='form_label'>字段名称</td>"+
		             				"<td><input class='nui-textbox' style='width:100%' required='true' requiredErrorText='必填项不能为空' id='qualityname"+k+"' name='quality.name"+k+"' /></td>"+
		             				"<td class='form_label'>字段值</td>"+
		             				"<td><input class='nui-textbox' style='width:100%' required='true' requiredErrorText='必填项不能为空' id='qualityvalue"+k+"' name='quality.value"+k+"' /></td>"+
		             				"</tr>");            	
				k++;
            }
		...
		function loadTemplateData(pid,readonly){
						$.ajax({
		                    ...
		                    success:function(text){
		                    	...
		                    	if(trs.length > 1){
				                    ...
				                    (readonly == true?("<table style='width:100%;height:100%;'><tr>"+
				                    		"<td style='width:50%;border:0px;text-align: center;'><input type='checkbox' name='checkboxs' readonly='readonly' value='template"+(i+1)+"'/></td>"+
				                    	"<td style='width:50%;border:0px;text-align: center;border-left: 1px solid #cad9ea;'>"+steps[i].orders+"</td></tr></table></td>"+
				                    "<td colspan='2' style='height:65px;'>"+steps[i].steps+"</td>"+
				                    "<td colspan='1' style='text-align:center;'>"+(steps[i].filenumber==null?"":steps[i].filenumber)+"</td>"+
				                    "<td colspan='1' style='text-align:center;'>"+(steps[i].version==null?"":steps[i].version)+"</td>"):("<table style='width:100%;height:100%;'><tr>"+
