...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,4000,false,true)"  name="nextData.checkprojectname"/>
            </td>
            <td class="form_label" align="center">
                维护项目:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="utsl" name="preData.utsl"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)"  name="nextData.utsl"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" id="fac" dictTypeId="FAC" readonly="readonly" name="preData.fac"/>
            </td>
            <td colspan="1">
                <input class="nui-dictcombobox" dictTypeId="FAC" name="nextData.fac"/>
            </td>
            <td class="form_label" align="center">
                测厚部位:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="jcbw" readonly="readonly" name="preData.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,2000,false,true)"  name="nextData.jcbw"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="jcsl" readonly="readonly" name="preData.jcsl"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)"  name="nextData.jcsl"/>
            </td>
            <td class="form_label" align="center">
                UT 部位:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="utbw" name="preData.utbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)"  name="nextData.utbw"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textarea" id="lct" style="width: 100%" readonly="readonly" name="preData.lct"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)"  style="width: 100%" name="nextData.lct"/>
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(常规岛及BOP)_日常执行条目_修改压力管道";
        data.processInstDesc = "专用检查计划(常规岛及BOP)_日常执行条目_修改压力管道";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyConduitEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandEdit.DailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.ConventionalIslandDaily.PressurePipe";
