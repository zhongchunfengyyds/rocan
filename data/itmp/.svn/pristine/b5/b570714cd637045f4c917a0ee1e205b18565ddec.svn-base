...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"  name="nextData.tasklist"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.itemnumber"/>
            </td>
            <td class="form_label" align="center">
                设备名称:
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.sbname"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.sbnumber"/>
            </td>
            <td class="form_label" align="center">
                列:
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.columnsint"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.row"/>
            </td>
            <td class="form_label" align="center">
                检查类型:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" name="nextData.jccycle"/>
            </td>
            <td class="form_label" align="center">
                备注:
            </td>
...
<table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
    ...
    <tr>
        ...
        <td colspan="5">
            <input id="reason" required="true"  name="nextData.xgyy" requiredErrorText="请输入修改原因" class="nui-textarea" style="width: 100%;"/>
        </td>
    </tr>
</table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId){
        var form = new nui.Form("#dataform1");
        form.setChanged(false);
        //编辑com.cgn.itmp.outlineandplan.outline.common.CommonServiceImplFlow
        ...
        data.processInstName = "专用检查计划(核岛部件)_日常执行条目_修改热传管";
        data.processInstDesc = "专用检查计划(核岛部件)_日常执行条目_修改热传管";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyCRGEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Tube";
