...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox" url="com.cgn.itmp.basecommon.DictionaryOperation.getJdDicInfo.biz.ext"
                       ...
                       value="<%=dataParms.get("base")==null?"":dataParms.get("base") %>" dataField="jsonObject"
                       id="jdid" name="preData.base" valueField="id"/>
            </td>
            <td>
            </td>
            <td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="system" readonly="readonly"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="columns" readonly="readonly"
                       value="<%=dataParms.get("columnsint")==null?"":dataParms.get("columnsint") %>"
                       name="preData.columns"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"
                       value="<%=editdataParms.get("columns")==null?"":editdataParms.get("columns") %>"
                       name="nextData.columns"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="checktype" readonly="readonly"
...
<script type="text/javascript">
    ...
    function onSubmit() {
        ...
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.zyjcjh.TDgglTzyjcjhhdcrg";
