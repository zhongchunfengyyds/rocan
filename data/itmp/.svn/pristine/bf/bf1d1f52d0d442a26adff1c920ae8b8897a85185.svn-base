...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" dictTypeId="ZYJCJH" value="CRG"
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" value="<b:write property='entity/columnsint'/>"
                       name="delete_entity.columnsint"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" value="<b:write property='entity/checktype'/>" dictTypeId="JCLX"
                       name="delete_entity.checktype"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function doWriteBackRealData() {
        ...
        var json = "{sourceEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaulEdit.NuclearIslandEdit'," +
            "targetEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaul.Tube'," +
