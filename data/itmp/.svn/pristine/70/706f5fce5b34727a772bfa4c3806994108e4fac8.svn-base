        ...
        <div class="nui-panel" title="检查项目清单" iconCls="icon-add" style="width:100%;height:400px;" showToolbar="false" showFooter="false" >
            <div class="nui-fit">
                <div 
                        ...
                        url="com.cgn.itmp.outlineandplan.annual.ConventionalIslandOverhaul.queryPlanGenerations.biz.ext"
                       showPager="false"
                        multiSelect="true"
...
//          	 		var d={processinstid:data};
         ...
         //确定保存或更新
                    ...
                    function saveData(finishFirstActivityId){
				        ...
				        allInfo.processInstName = "年度计划(常规岛及BOP)_换料大修计划生效_申请";
				        allInfo.processInstDesc = "年度计划(常规岛及BOP)_换料大修计划生效_申请";
				        //工作流视图url
				        allInfo.processDefName = "com.cgn.itmp.outlineandplan.annual.conventionalislandoverhaulWF";
		 		        if(isadmin == 'false'){
					   	...
					   	$.ajax({
							   	url:"com.cgn.itmp.outlineandplan.annual.NuclearIslandOverhaul.conventionoverhaulOperationWorkflow.biz.ext",
								type : 'POST',
								data : json,
								cache : false,
								contentType : 'text/json',
