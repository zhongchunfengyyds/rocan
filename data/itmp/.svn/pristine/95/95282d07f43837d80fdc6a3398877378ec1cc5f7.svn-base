           ...
           <input id="finishFirstActivityId" class="nui-hidden" name="finishFirstActivityId"/>
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
				...
				<tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,100,false,true)"  name="nextData.equipment"/>
                    </td>
                    </tr>
                    <tr>
                    <td class="form_label"  align="center">
                    ...
                    <td colspan="1">
                     ...
                     <td colspan="1">
                        <input dictTypeId="option" class="nui-dictcombobox" name="nextData.inspectplan"/>
                    </td>
                    <td class="form_label"  align="center">
                        设备编号/功能位置:
                    </td>
                ...
                <td class="form_label"  >
                    ...
                    <td colspan="3">
                        <input class="nui-textarea" onvalidation="hasIllegalChar(e,4000,false,true)"  style="width: 100%" name="nextData.inspectionscope"/>
                    </td>
                </tr>
          </table>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
            ...
            function saveData(finishFirstActivityId){
				...
				data.processInstName = "十年计划(常规岛及BOP)_日常执行条目_修改";
				data.processInstDesc = "十年计划(常规岛及BOP)_日常执行条目_修改";
				data.processDefName = "com.cgn.itmp.outlineandplan.tenyearplan.editSnjhCgdRczxtm";
				data.middleEntity = "com.cgn.itmp.outlineandplan.tenyearplan.ConventionalIslandOverhaulEdit.OverhaulEdit";
				data.realEntity = "com.cgn.itmp.outlineandplan.tenyearplan.ConventionalIslandDaily.DailyEntity";
