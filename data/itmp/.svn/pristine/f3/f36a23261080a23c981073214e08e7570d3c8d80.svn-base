		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input id="sbmc"
					...
					required="required" requiredErrorText="设备名称不能为空" emptyText="选择被检部位自动回填" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">部件名称:</td>
				<td colspan="1"><input class="nui-textbox" id="bjmc" emptyText="选择被检部位自动回填" name="defectsshowdetailedinformation.componentname"
					 readOnly="readOnly" style="width: 100%" requiredErrorText="部件名称不能为空" required="required"/></td>
				<td class="form_label">被检部位:</td>
				<td colspan="1">
					<input id="bjbw" readOnly="readOnly" emptyText="请选择被检部位" name="defectsshowdetailedinformation.checklocation" class="nui-textbox" requiredErrorText="被检部位不能为空"  required="required" style="width: 50%" />
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defecttype" emptyText="请输入缺陷类型" required="required" requiredErrorText="缺陷类型不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">波型</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.wavepattern" style="width: 100%" /></td>
				<td class="form_label">折射角（°）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.refractionangle"  style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">频率（MHz)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.frequency"  style="width: 100%" /></td>
				<td class="form_label">Gr(25mm)(dB)</td>
				<td colspan="1">
				<input name="defectsshowdetailedinformation.gr"  class="nui-textbox" style="width: 100%" />
			</tr>
			<tr>
				<td class="form_label">Gc(dB)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.gc" style="width: 100%" /></td>
				<td class="form_label">Hd-Gc(dB)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hdgc"  style="width: 100%" /></td>
			</tr>
			<tr>
			<td class="form_label">缺陷长度（mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectlength"
					vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
					 emptyText="请输入缺陷长度" requiredErrorText="缺陷长度不能为空" required="required" style="width: 100%" /></td>
			<td class="form_label">缺陷方向</td>
				<td colspan="1"><input class="nui-textbox"  emptyText="请输入缺陷方向"
					name="defectsshowdetailedinformation.defectdirection" requiredErrorText="缺陷方向不能为空" required="required" style="width: 100%" /></td>
			</tr>
			</table>
				                ...
				                <tr>
				                    ...
				                    <td >
				                        <input class="nui-textbox" 
				                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
				                        style="width: 100%" name="defectsshowdetailedinformation.tty" />
				                    </td>
				                    <td class="form-label">X(mm)：</td>
				                    <td >
				                        <input class="nui-textbox" 
				                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
				                        style="width: 100%" name="defectsshowdetailedinformation.ttx"  />
				                    </td>
				                </tr>
						</table>
				</fieldset>
			...
			class="nui-form-table">
	                <tr>
	                    ...
	                    <td >
	                        <input class="nui-textbox" 
	                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
	                        style="width: 100%" name="defectsshowdetailedinformation.defecty"  />
	                    </td>
	                    <td class="form-label" >X(mm)：</td>
	                    <td >
	                        <input class="nui-textbox" 
	                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
	                         style="width: 100%" name="defectsshowdetailedinformation.defectx" />
	                    </td>
	                    </tr>
	                    <tr>
	                    ...
	                    <td >
	                        <input class="nui-textbox"  
	                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
	                        style="width: 100%" name="defectsshowdetailedinformation.defectd"/>
	                    </td>
	                    <td class="form-label" >S(mm)：</td>
	                    <td >
	                        <input class="nui-textbox" 
	                         vtype="float;range:0,99999" floatErrorText="请输入数字" rangeErrorText="请输入正数"
	                         style="width: 100%" name="defectsshowdetailedinformation.defects" />
	                    </td>
	                	</tr>
	              </table>
				</fieldset>
...
<td colspan="1"><input class='nui-dictcombobox' dictTypeId='ISORNO' nullItemText="请选择是否超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" required="required" style="width: 100%" /></td>				<td class="form_label"></td>
				<td colspan="1"></td>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"rplsdcs"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="rplsdcs";
