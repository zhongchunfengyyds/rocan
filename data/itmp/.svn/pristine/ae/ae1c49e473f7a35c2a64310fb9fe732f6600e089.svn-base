...
<%
 ...
 response.sendRedirect(request.getContextPath() + "/com.cgn.itmp.outlineandplan.annual.nuclearislandoverhauls.dailySqsqMainFlow.flow?processInstId="+processInstId
