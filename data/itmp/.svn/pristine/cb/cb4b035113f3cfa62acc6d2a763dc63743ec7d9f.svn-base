...
- Description:主泵飞轮手动超声模板信息实体录入页面
    --%>
<head>
<title>主泵飞轮手动超声</title>
...
<!-- 		<input id='sortfield' class="nui-hidden" name="defectsshowdetailedinformation.sortfield"/> -->
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<input class="nui-hidden" id="defectnum"
					...
					<td class="form_label">键槽边缘编号</td>
				<td colspan="1"><input class="nui-textbox" emptyText="请输入键槽边缘编号" 
					name="defectsshowdetailedinformation.keywayedgenumber" requiredErrorText="键槽边缘编号不能为空" required="required" style="width: 100%" /></td>
			</tr>
			<tr>
				...
				<td class="form_label">HB(dB) 12.5%FSH</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hb"  style="width: 100%" /></td>
				
			</tr>
			<tr>
				<td class="form_label">D(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.zbfld" style="width: 100%" /></td>
				<td class="form_label">W(mm)</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.zbflw" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">Hd(dB) 12.5%FSH</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hd" style="width: 100%" /></td>
	...
	<script type="text/javascript">
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"zbflsdcs"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="zbflsdcs";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "zbflsdcs") {
