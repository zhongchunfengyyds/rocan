...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" id="type" dictTypeId="ZYJCJH" value="HFBOSS" value="<b:write property='entity/type'/>" name="delete_entity.type"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-dictcombobox"  readonly="readonly" required="true" dictTypeId="protype" value="<b:write property='entity/sources'/>" name="delete_entity.sources"/>
            </td>
            <td class="form_label" align="center">
                检查项目名称:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<b:write property='entity/systemdevic'/>" name="delete_entity.systemdevice"/>
            </td>
            <td class="form_label" align="center">
                房间号:
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" value="<b:write property='entity/category'/>"dictTypeId="LB" name="delete_entity.category"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="5">
                <input class="nui-textarea"value="<b:write property='entity/ckt_dzhnumber'/>" style="width: 100%" name="delete_entity.ckt_dzhnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<b:write property='entity/gj'/>" name="delete_entity.gj"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<b:write property='entity/hfnumber'/>" name="delete_entity.hfnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-dictcombobox"value="<b:write property='entity/bw'/>" dictTypeId="BW"  name="delete_entity.bw"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <input class="nui-textarea"value="<b:write property='entity/cl'/>" style="width: 100%" name="delete_entity.cl"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function doWriteBackRealData() {
        ...
        var json = "{sourceEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit'," +
            "targetEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.BossHead'," +
