...
<div class="nui-hidden" name="entityType"  id="entityType"></div>
   <input class="nui-hidden" name="processInstId" value="<b:write property='processInstId'/>"/> 
     ...
     value="<b:write property='entity/crew'/>"
                    ...
                    <td colspan="1">
                        <input class="nui-dictcombobox" readonly="readonly" dictTypeId="protype" value="<b:write property='entity/protype'/>" name="delete_entity.protype"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" value="<b:write property='entity/site'/>" name="delete_entity.site"/>
                    </td>
                </tr>
...
<!--                  		<input  required="true" property="editor" id="jhry"  name="jhry"  requiredErrorText="请输入校核人员"  required="true" class="nui-textboxlist" dataField="list"  style="width:350px"  -->
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
		...
		//流程作废
	    	...
	    	function onSubmit(){
	            ...
	            data.entityType = "com.cgn.itmp.outlineandplan.tenyearplan.NuclearIslandOverhaulEdit.NuclearIslandEdit";
