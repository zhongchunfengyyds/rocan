...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input id="protype" class="nui-dictcombobox"  readonly="readonly" required="true" dictTypeId="protype" name="preData.system"/>
            </td>
            <td colspan="1">
            </td>
            <td class="form_label" align="center">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.itemnumber"/>
            </td>
            <td class="form_label" align="center">
                设备/部件:
            </td>
            <td colspan="1">
                <input class="nui-textbox" id="equipment" readonly="readonly" name="preData.equipment"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.equipment"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gnwz" name="preData.gnwz"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gnwz"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="jcbw" name="preData.jcbw"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.jcbw"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gxnumber" readonly="readonly" name="preData.gxnumber"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gxnumber"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="roomnumber" readonly="readonly" name="preData.roomnumber"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.roomnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textarea" readonly="readonly" id="ckt_dzhnumber" style="width: 100%"
                       name="preData.ckt_dzhnumber"/>
            </td>

            <td colspan="1">
                <input class="nui-textarea" onvalidation="hasIllegalChar(e,500,false,true)" style="width: 100%" name="nextData.ckt_dzhnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox"  onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.jcmethod"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.jcprocedure"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="gfcycle" readonly="readonly" name="preData.gfcycle"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.gfcycle"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="pmcycle" readonly="readonly" name="preData.pmcycle"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.pmcycle"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" id="pmcode" readonly="readonly" name="preData.pmcode"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.pmcode"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" id="zxunit" readonly="readonly" name="preData.zxunit"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.zxunit"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function setFormData(data) {
        ...
        if (infos.pageType == "edit") {
            ...
            nui.get('protype').setValue(json.preData.system);
    ...
    function saveData(finishFirstActivityId){
        ...
        data.processInstName = "专用检查计划(核岛部件)_日常执行条目_修改阀门";
        data.processInstDesc = "专用检查计划(核岛部件)_日常执行条目_修改阀门";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.DailyFMEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Valve";
