...
<div id="dataform1" style="padding-top:5px;">
    ...
    <input class="nui-hidden" name="data.entitytype" value="com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.PipelineSupport"/>
    <!-- hidden域 流程对应信息 -->
    <input class="nui-hidden" name="data.processDefName" value="com.cgn.itmp.outlineandplan.specialinspection.DailyHFGDZCAdd"/>
    <input class="nui-hidden" name="data.processInstName" value="专用检查计划(核岛部件)_日常执行条目_新增焊缝管道"/>
    <input class="nui-hidden" name="data.processInstDesc" value="专用检查计划(核岛部件)_日常执行条目_新增焊缝管道"/>
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  name="data.equipment"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  name="data.hfnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" name="data.number"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,1000,false,true)"  name="data.roomnumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox" required="true" requiredErrorText="请输入检查方法" name="data.jcmethod"/>
            </td>
    ...
    <table id="nd" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td id="n1991ii" colspan="1">
                <div name="data.c1991" id="combobox1991i" class="nui-combobox" style="width:100px;" popupWidth="150"
            ...
            <td id="n1992ii" colspan="1">
                <div name="data.c1992" id="combobox1992i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n1993ii" colspan="1">
                <div name="data.c1993" id="combobox1993i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n1994ii" colspan="1">
                <div name="data.c1994" id="combobox1994i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n1995ii" colspan="1">
                <div name="data.c1995" id="combobox1995i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n1996ii" colspan="1">
                <div name="data.c1996" id="combobox1996i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n1997ii" colspan="1">
                <div name="data.c1997" id="combobox1997i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n1998ii" colspan="1">
                <div name="data.c1998" id="combobox1998i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n1999ii" colspan="1">
                <div name="data.c1999" id="combobox1999i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2000ii" colspan="1">
                <div name="data.c2000" id="combobox2000i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2001ii" colspan="1">
                <div name="data.c2001" id="combobox2001i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2002ii" colspan="1">
                <div name="data.c2002" id="combobox2002i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2003ii" colspan="1">
                <div name="data.c2003" id="combobox2003i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2004ii" colspan="1">
                <div name="data.c2004" id="combobox2004i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2005ii" colspan="1">
                <div name="data.c2005" id="combobox2005i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2006ii" colspan="1">
                <div name="data.c2006" id="combobox2006i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2007ii" colspan="1">
                <div name="data.c2007" id="combobox2007i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2008ii" colspan="1">
                <div name="data.c2008" id="combobox2008i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2009ii" colspan="1">
                <div name="data.c2009" id="combobox2009i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2010ii" colspan="1">
                <div name="data.c2010" id="combobox2010i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2011ii" colspan="1">
                <div name="data.c2011" id="combobox2011i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2012ii" colspan="1">
                <div name="data.c2012" id="combobox2012i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2013ii" colspan="1">
                <div name="data.c2013" id="combobox2013i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2014ii" colspan="1">
                <div name="data.c2014" id="combobox2014i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2015ii" colspan="1">
                <div name="data.c2015" id="combobox2015i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2016ii" colspan="1">
                <div name="data.c2016" id="combobox2016i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2017ii" colspan="1">
                <div name="data.c2017" id="combobox2017i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2018ii" colspan="1">
                <div name="data.c2018" id="combobox2018i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2019ii" colspan="1">
                <div name="data.c2019" id="combobox2019i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2020ii" colspan="1">
                <div name="data.c2020" id="combobox2020i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2021ii" colspan="1">
                <div name="data.c2021" id="combobox2021i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2022ii" colspan="1">
                <div name="data.c2022" id="combobox2022i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2023ii" colspan="1">
                <div name="data.c2023" id="combobox2023i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2024ii" colspan="1">
                <div name="data.c2024" id="combobox2024i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2025ii" colspan="1">
                <div name="data.c2025" id="combobox2025i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2026ii" colspan="1">
                <div name="data.c2026" id="combobox2026i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2027ii" colspan="1">
                <div name="data.c2027" id="combobox2027i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2028ii" colspan="1">
                <div name="data.c2028" id="combobox2028i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2029ii" colspan="1">
                <div name="data.c2029" id="combobox2029i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2030ii" colspan="1">
                <div name="data.c2030" id="combobox2030i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2031ii" colspan="1">
                <div name="data.c2031" id="combobox2031i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2032ii" colspan="1">
                <div name="data.c2032" id="combobox2032i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2033ii" colspan="1">
                <div name="data.c2033" id="combobox2033i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2034ii" colspan="1">
                <div name="data.c2034" id="combobox2034i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2035ii" colspan="1">
                <div name="data.c2035" id="combobox2035i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2036ii" colspan="1">
                <div name="data.c2036" id="combobox2036i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2037ii" colspan="1">
                <div name="data.c2037" id="combobox2037i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2038ii" colspan="1">
                <div name="data.c2038" id="combobox2038i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2039ii" colspan="1">
                <div name="data.c2039" id="combobox2039i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2040ii" colspan="1">
                <div name="data.c2040" id="combobox2040i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2041ii" colspan="1">
                <div name="data.c2041" id="combobox2041i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2042ii" colspan="1">
                <div name="data.c2042" id="combobox2042i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2043ii" colspan="1">
                <div name="data.c2043" id="combobox2043i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2044ii" colspan="1">
                <div name="data.c2044" id="combobox2044i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2045ii" colspan="1">
                <div name="data.c2045" id="combobox2045i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2046ii" colspan="1">
                <div name="data.c2046" id="combobox2046i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2047ii" colspan="1">
                <div name="data.c2047" id="combobox2047i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2048ii" colspan="1">
                <div name="data.c2048" id="combobox2048i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2049ii" colspan="1">
                <div name="data.c2049" id="combobox2049i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2050ii" colspan="1">
                <div name="data.c2050" id="combobox2050i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2051ii" colspan="1">
                <div name="data.c2051" id="combobox2051i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2052ii" colspan="1">
                <div name="data.c2052" id="combobox2052i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2053ii" colspan="1">
                <div name="data.c2053" id="combobox2053i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2054ii" colspan="1">
                <div name="data.c2054" id="combobox2054i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2055ii" colspan="1">
                <div name="data.c2055" id="combobox2055i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2056ii" colspan="1">
                <div name="data.c2056" id="combobox2056i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2057ii" colspan="1">
                <div name="data.c2057" id="combobox2057i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2058ii" colspan="1">
                <div name="data.c2058" id="combobox2058i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2059ii" colspan="1">
                <div name="data.c2059" id="combobox2059i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2060ii" colspan="1">
                <div name="data.c2060" id="combobox2060i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2061ii" colspan="1">
                <div name="data.c2061" id="combobox2061i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2062ii" colspan="1">
                <div name="data.c2062" id="combobox2062i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2063ii" colspan="1">
                <div name="data.c2063" id="combobox2063i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2064ii" colspan="1">
                <div name="data.c2064" id="combobox2064i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2065ii" colspan="1">
                <div name="data.c2065" id="combobox2065i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2066ii" colspan="1">
                <div name="data.c2066" id="combobox2066i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2067ii" colspan="1">
                <div name="data.c2067" id="combobox2067i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2068ii" colspan="1">
                <div name="data.c2068" id="combobox2068i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2069ii" colspan="1">
                <div name="data.c2069" id="combobox2069i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2070ii" colspan="1">
                <div name="data.c2070" id="combobox2070i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2071ii" colspan="1">
                <div name="data.c2071" id="combobox2071i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2072ii" colspan="1">
                <div name="data.c2072" id="combobox2072i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2073ii" colspan="1">
                <div name="data.c2073" id="combobox2073i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2074ii" colspan="1">
                <div name="data.c2074" id="combobox2074i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2075ii" colspan="1">
                <div name="data.c2075" id="combobox2075i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2076ii" colspan="1">
                <div name="data.c2076" id="combobox2076i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2077ii" colspan="1">
                <div name="data.c2077" id="combobox2077i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2078ii" colspan="1">
                <div name="data.c2078" id="combobox2078i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2079ii" colspan="1">
                <div name="data.c2079" id="combobox2079i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2080ii" colspan="1">
                <div name="data.c2080" id="combobox2080i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2081ii" colspan="1">
                <div name="data.c2081" id="combobox2081i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2082ii" colspan="1">
                <div name="data.c2082" id="combobox2082i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2083ii" colspan="1">
                <div name="data.c2083" id="combobox2083i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2084ii" colspan="1">
                <div name="data.c2084" id="combobox2084i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2085ii" colspan="1">
                <div name="data.c2085" id="combobox2085i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2086ii" colspan="1">
                <div name="data.c2086" id="combobox2086i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
        ...
        <tr>
            ...
            <td id="n2087ii" colspan="1">
                <div name="data.c2087" id="combobox2087i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2088ii" colspan="1">
                <div name="data.c2088" id="combobox2088i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
            ...
            <td id="n2089ii" colspan="1">
                <div name="data.c2089" id="combobox2089i" class="nui-combobox" style="width:100px;" popupWidth="150"
                     textField="name" valueField="id"
                     url="" multiSelect="true"
                     showClose="true" oncloseclick="onCloseClick" dataField="jsonObject">
                    <div property="columns">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(nextStep) {
        ...
        if(isadmin == 'true'){
            data.data['entity'] = 'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.PipelineSupport';
        }
