		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox" id="overhaul"
					name="defectsshowdetailedinformation.overhaulsequence"  style="width: 100%" /></td>
			...
			<tr>
				...
				<td colspan="1">
					<input id="bjbw"  style="width: 100%" name="defectsshowdetailedinformation.checklocation" class="nui-textbox"  style="width: 50%" />
					</td>
			</tr>
			<tr>
				<td class="form_label">检查内容:</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.inspectioncontent"  style="width: 100%" /></td>
				<td class="form_label">检查方法:</td>
				<td colspan="1"><input class="nui-dictcombobox" dictTypeId="YJJCFF"
					name="defectsshowdetailedinformation.inspectionmethod"  style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷显示编号:</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectdisplaynumber"  style="width: 100%" /></td>
					<td class="form_label">缺陷类型</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defecttype"  style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷起始位置（mm）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectstartlocation"  style="width: 100%" /></td>
				<td class="form_label">缺陷长度（mm）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectlength"  style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">缺陷高度（mm）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defectheight"  style="width: 100%" /></td>
				<td class="form_label">波幅高度（%）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.amplitudeheight"  style="width: 100%" /></td>
			</tr>
			<tr>
