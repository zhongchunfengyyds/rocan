		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.inspectioncontent" emptyText="请输入检查内容" required="required" requiredErrorText="检查内容不能为空" style="width: 100%" /></td>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.offset" emptyText="请输入OFFSET" requiredErrorText="OFFSET不能为空" required="required" style="width: 100%" /></td>
				<td class="form_label">CODE（缺陷类型）</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.defecttype"  emptyText="请输入CODE（缺陷类型）"  requiredErrorText="CODE不能为空"  required="required" style="width: 100%" /></td>
			</tr>
			<tr>
			<td class="form_label">Length</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.length" emptyText="请输入Length" required="required" requiredErrorText="Length不能为空" style="width: 100%" /></td>
				<td class="form_label">Arc</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.arc" emptyText="请输入Arc" required="required" requiredErrorText="Arc不能为空" style="width: 100%" /></td>
			</tr>
			<tr>
				<td class="form_label">VOLTS</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.volts" style="width: 100%" /></td>
			<td class="form_label">DEG</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.deg"  style="width: 100%" /></td>
			
			</tr>
			<tr>
			<td class="form_label">CHANNEL</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.channel" style="width: 100%" /></td>
			<td class="form_label">是否超标缺陷</td>
				<td colspan="1">
					<input id="sfqx" class="nui-dictcombobox" nullItemText="请选择超标缺陷.." required="required" requiredErrorText="是否超标缺陷不能为空" name="defectsshowdetailedinformation.influence" dictTypeId="ISORNO"/>
				
<!-- 				<input class="nui-combobox" nullItemText="请选择是否超标缺陷.." requiredErrorText="是否超标缺陷不能为空"  required="required" showNullItem="true" dataField="jsonObject" id="sf" textField="name" url="" valueField="id" name="defectsshowdetailedinformation.influence" url="" required="required" style="width: 100%" /> -->
				</td>
			</tr>
			<tr>
			<td class="form_label">是否堵管</td>
				<td colspan="1">
				<input id="sfdg" class="nui-dictcombobox" required="true" nullItemText="请选择是否堵管.." requiredErrorText="是否堵管不能为空" name="defectsshowdetailedinformation.isplugging" dictTypeId="ISORNO"/>
<!-- 				<input class="nui-combobox" nullItemText="请选择是否堵管.." requiredErrorText="是否堵管不能为空" required="required" showNullItem="true" dataField="jsonObject" id="sf1" textField="name" url="" valueField="id" name="defectsshowdetailedinformation.isplugging" url="" required="required" style="width: 100%" /> -->
				</td>
...
// 		nui.get("sf1").load(sfdata);
					...
					url:"/itmp/inspectcomponentmanage/defectdisplaymanagement/defectdisplaydetails/HistoryNumCheck.jsp",
					  title: "历史编号选择", width: 516, height:300,
					   ...
					   var iframe = this.getIFrameEl();
		                    var data = {stencilplate:"crgmrpc"};//传入页面的json数据
		...
		function saveData() {
			...
			data.defectsshowdetailedinformation.stencilplate="crgmrpc";
...
// 				nui.get('sortfield').setValue(json.defectsshowdetailedinformation.sortfield);
			...
			//如果是点击编辑类型页面
			if (infos.pageType == "edit" || infos.pageType == "crgmrpc") {
