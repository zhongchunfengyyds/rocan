...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/themes/default/css/cuc.css" />
    ...
    <body style="width:98%;height:95%;margin:0 auto;">
            <div id="form1"> 
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.dailyandoverhaul.groupplant.Organization.Organization">
                <!-- 排序字段 -->
            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="ygbh" headerAlign="center" allowSort="true" >
                            员工号
                        </div>
                        <div field="gs"  renderer="gsRenderer" headerAlign="center" allowSort="true" >
                            公司
                        </div>
                        <div field="zz" renderer="zzRenderer" headerAlign="center" allowSort="true" >
                            组织
                        </div>
                        <div field="role"  renderer="jsRenderer" headerAlign="center" allowSort="true" >
                            角色
                        </div>
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    var json = nui.encode({tqcjsglzzjgs:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.Organization.hfdeleteTQcjsglZzjgs.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.Organization.deleteTQcjsglZzjgs.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
                                        success:function(text){
                                            ...
                                            if(returnJson.exception == null){
                                                grid.reload();
                                                nui.alert("彻底删除成功", "系统提示", function(action){
                                                    });
                                                }else{
                                                    grid.unmask();
                                                    nui.alert("彻底删除失败", "系统提示");
                                                }
                                            }
                                            });
                                        }
