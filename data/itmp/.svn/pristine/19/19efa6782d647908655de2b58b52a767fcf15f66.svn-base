...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        <tr>
            ...
            <td colspan="1">
                <input class="nui-combobox" readonly="readonly" url="com.cgn.itmp.basecommon.DictionaryOperation.getJdDicInfo.biz.ext"
                       textField="name"  onvaluechanged="reloadJz"   value="<b:write property='entity/base'/>"   dataField="jsonObject" id="jd" name="delete_entity.base" valueField="id"/>
            </td>
            ...
            <td colspan="1">
                <input class="nui-combobox" readonly="readonly" dataField="jsonObject" id="jz" textField="name"
                       url="" name="data.crew"value="<b:write property='entity/crew'/>"  valueField="id"/>
            </td>
            <td class="form_label"   align="center">
                类型:
            </td>
            <td colspan="1">
                <input class="nui-dictcombobox" readonly="readonly" value="<b:write property='entity/type'/>"id="type"  value="HFGDZC"  dictTypeId="ZYJCJH"    name="delete_entity.type"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" value="<b:write property='entity/number'/>"   name="delete_entity.number"/>
            </td>
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function doWriteBackRealData() {
        ...
        var json = "{sourceEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDailyEdit.NuclearIslandDailyEdit'," +
            "targetEntity:'com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.PipelineSupport'," +
