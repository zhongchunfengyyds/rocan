...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table id="hfid" style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-dictcombobox" value="<%=dataParms.get("type")==null?"":dataParms.get("type") %>"id="type"   dictTypeId="ZYJCJH"    name="preData.type"/>
            </td>
            <td>
            </td>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="tasklist"value="<%=dataParms.get("tasklist")==null?"":dataParms.get("tasklist") %>"readonly="readonly" name="preData.tasklist"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"value="<%=dataParms.get("checkprojectname")==null?"":dataParms.get("checkprojectname") %>"id="checkprojectname"readonly="readonly" name="preData.checkprojectname"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="bracenumber"readonly="readonly"value="<%=dataParms.get("bracenumber")==null?"":dataParms.get("bracenumber") %>" name="preData.bracenumber"/>
            </td>
            <td colspan="1">
                <input class="nui-textbox"value="<%=editdataParms.get("bracenumber")==null?"":editdataParms.get("bracenumber") %>" name="nextData.bracenumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label"   align="center">
            ...
            <td colspan="1">
                <input class="nui-textbox"id="gxnumber"readonly="readonly"value="<%=dataParms.get("gxnumber")==null?"":dataParms.get("gxnumber") %>" name="preData.gxnumber"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox"id="roomnumber"readonly="readonly"value="<%=dataParms.get("roomnumber")==null?"":dataParms.get("roomnumber") %>" name="preData.roomnumber"/>
            </td>
            <td colspan="1">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textarea"id="ckt_dzhnumber"readonly="readonly" value="<%=dataParms.get("ckt_dzhnumber")==null?"":dataParms.get("ckt_dzhnumber") %>"style="width: 100%" name="preData.ckt_dzhnumber"/>
            </td>
            <td colspan="1">
            ...
            <td colspan="1">
                <input class="nui-textarea"id="jjmode" readonly="readonly" style="width: 100%" value="<%=dataParms.get("jjmode")==null?"":dataParms.get("jjmode") %>" name="preData.jjmode"/>
            </td>
            <td colspan="1">
                <input class="nui-textarea"  style="width: 100%"value="<%=editdataParms.get("jjmode")==null?"":editdataParms.get("jjmode") %>"  name="nextData.jjmode"/>
            </td>
        </tr>
        <tr>
            <td class="form_label"   align="center">
...
<script type="text/javascript">
    ...
    function onSubmit(){
        ...
        jsonData.entityType = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandDaily.Support";
