                ...
                <tr>
                   ...
                   WQP编号
                    ...
                    <td class="form_label">
                      ...
                      <td colspan="1">
                        <input class="nui-textbox"  onvalidation="hasIllegalChar(e,100,true,true)" style="width:100%" name="quality.describe" required="true" requiredErrorText="描述不能为空" emptyText="请输入描述" />
                    </td>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,100,true,true)"  style="width:100%" name="quality.position" required="true" requiredErrorText="功能位置不能为空" emptyText="请输入功能位置" />
                    </td>
                   </tr>
                   <tr>
                <td class="form_label">
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,100,true,true)"  style="width:100%" name="quality.level" required="true" requiredErrorText="制造级别不能为空" emptyText="请输入制造级别" />
                    </td>
                    ...
                    <td colspan="1">
                     <input  name="quality.form" required="true" requiredErrorText="接头形式不能为空" emptyText="请选择接头形式" class="nui-dictcombobox"   dictTypeId="JTXS"  style="width:100%;" />
                    ...
                    <td colspan="1">
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,100,true,true)"  style="width:100%" name="quality.major" required="true" requiredErrorText="专业不能为空" emptyText="请输入专业" />
                    </td>
                    </tr>
               <tr>
                    <td class="form_label">
                    ...
                    <td colspan="5">
                        <input class="nui-textbox" onvalidation="hasIllegalChar(e,100,true,true)"  style="width:100%" name="quality.ndtmethod_proportions" required="true" requiredErrorText="无损检测方法及比例不能为空" emptyText="请输入无损检测方法及比例" />
                    </td>
             	</tr>
             	<tr>
                    <td class="form_label">
                    ...
                    <td colspan="5">
                     <div name="quality.prewelder" id="combobox1" class="nui-combobox" style="width:100%;"  popupWidth="150" textField="name" valueField="id" 
					     ...
					     showClose="true" oncloseclick="onCloseClick" onvalidation="hasIllegalChar(e,100,false,true)"  dataField="jsonObject" >     
             	...
             	<tr>
                    ...
                    <td colspan="5">
                    	<input class="nui-textbox" style="width:100%"  onvalidation="hasIllegalChar(e,100,false,true)"  name="quality.chargeperson"/>
                    </td>
             	</tr>
             	<%-- <tr>
                    <td class="form_label">
             	...
             	<tr id="scryTr">
                    ...
                    <td colspan="5">
                       <input id="examinant" class="nui-buttonedit" allowInput="false" required="true" requiredErrorText="焊接准备工程师不能为空" emptyText="请选择焊接准备工程师"  readonly="readonly" onclick="onButtonSelectPerson" name="quality.examinant" textName="examinant" style="width: 100%"/>    
                    </td>
             	</tr>
             	<tr id="shryTr">
                    <td class="form_label">
                    ...
                    <td colspan="5">
                        <input id="auditor" class="nui-buttonedit" allowInput="false" required="true" requiredErrorText="焊接QC1不能为空" emptyText="请选择焊接QC1"  readonly="readonly" onclick="onButtonSelectPerson" name="quality.auditor" textName="auditor" style="width: 100%"/>
                    </td>
             	</tr>
             	<tr id="fhryTr">
                    <td class="form_label">
                    ...
                    <td colspan="5">
                         <input id="reviewer" class="nui-buttonedit" allowInput="false" required="true" requiredErrorText="焊接QC2不能为空" emptyText="请选择焊接QC2"  readonly="readonly" onclick="onButtonSelectPerson" name="quality.reviewer" textName="reviewer" style="width: 100%"/>
                    </td>
             	</tr>
             	 <tr id="ccryTr">
                    <td class="form_label">
             ...
             /*    var modelSpecifications = data.quality.model_specifications;
                ...
                $.ajax({
                    ...
                    function setFormData(data){
						...
						nui.getbyName("uid").setValue(infos.uid);
						nui.getbyName("qnum").setValue(infos.qnum);
