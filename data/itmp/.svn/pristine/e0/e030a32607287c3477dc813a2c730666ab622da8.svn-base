...
<%--
- Author(s): wangyx
- Date: 2019-11-12 10:29:49
- Description:
    --%>
    <head>
        <title>
            TInExpertinterpretation查询 专家解读
        </title>
				...
				<div style="width: 100%; height: 100%;">
					...
					<div id="form1" class="nui-form displaynone" align="center"
						...
						<input class="nui-hidden" name="criteria/_entity"
							value="com.cgn.itmp.knowledgebase.Regulation.TInExpertinterpretation">
						<!-- 排序字段 -->
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[1]/papersname"/>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="criteria/_expr[2]/interpreteddocument"/>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="nui-textbox" name="criteria/_expr[3]/personorunit"/>
					...
					<tr style="display: none">
						<td>
							<input class="nui-textbox" name="criteria/_expr[4]/isdel" value="0" />
							<input class="nui-hidden" name="criteria/_expr[4]/_op" value="=">
							<input class="nui-textbox" id="jd" name="criteria/_expr[5]/jd" value="" />
	...
	<div style="width: 100%; height: 95%;border-top:0px solid #0084d2 ;" showToolbar="false"
		...
		<div class="nui-toolbar" style="border-bottom: 0; padding: 5px 0px;">
            ...
            <div class="nui-fit">
                <div 
                        id="datagrid1"
                        dataField="tinexpertinterpretations"
                        class="nui-datagrid"
                        style="width:100%;height:100%;"
                        url="com.cgn.itmp.knowledgebase.tinexpertinterpretationbiz.queryTInExpertinterpretations.biz.ext"
                    ...
                    <div property="columns">
                        ...
                        <div field="papersname" headerAlign="center" allowSort="true" renderer="renderPapersname">
                            文件名称
                        </div>
                        <div field="interpreteddocument" headerAlign="center" allowSort="true" >
                            被解读文件
                        </div>
                        <div field="personorunit" headerAlign="center" allowSort="true" >
                            解读人/单位
                        </div>
        ...
        <script type="text/javascript">
            ...
            formData["criteria/_expr[4]/isdel"] = "0";
            formData["criteria/_expr[5]/jd"] = getCookie("jdid");
            grid.load(formData);
			...
			function renderPapersname(e){
				return '<a style="cursor: pointer" onclick=show("'+e.record._uid+'")>'+e.record.papersname+'</a>';
			}
			...
			function show(uid){
				...
				nui.open({
					showMaxButton : true,
                    url: "/itmp/knowledgebase/knowledgebase/expertinterpretation/TInExpertinterpretationForm.jsp",
                    title: "查看记录", width: 600, height: 180,
                    onload: function () {//弹出页面加载完成
                    var iframe = this.getIFrameEl();
                    var data = {pageType:"show",record:{tinexpertinterpretation:record}};
            ...
            //新增
            function add() {
                nui.open({//knowledgebase/knowledgebase/expertinterpretation/TInExpertinterpretationForm.jsp
                  showMaxButton : true,
                    url: "/itmp/knowledgebase/knowledgebase/expertinterpretation/TInExpertinterpretationForm.jsp",
                ...
                if (row) {
                    nui.open({
                      showMaxButton : true,
                        ...
                        onload: function () {
                            var iframe = this.getIFrameEl();
                            var data = {pageType:"edit",record:{tinexpertinterpretation:row}};
                            //直接从页面获取，不用去后台获取
                            iframe.contentWindow.setFormData(data);
                            },
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({
													data : rows,
													entity : "com.cgn.itmp.knowledgebase.Regulation.TInExpertinterpretation",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
												});
...
function output() {
	...
	nui.open({
				...
				onload : function() {//弹出页面加载完成
					var iframe = this.getIFrameEl();
					var data = {
						entityName : "com.cgn.itmp.knowledgebase.Regulation.TInExpertinterpretation",
						queryParam : json, //查询数据
						queryKey : 'criteria', //查询实体名
						query : [ 'papersname', 'interpreteddocument', 'personorunit','isdel','jd'], //按顺序放置
						filterField : [ 'uuid', 'isdel', 'jd', 'addperson','fileid','createtime','addtime','processInstId','processStatus','deletetime','deleteperson'],
						expTitle : "专家解读",
						dicFieds : "",
						jdFieds : "jd",
						order : "addtime@desc",
						...
						mode:"ftp",
						defaultCheck : ['papersname', 'interpreteddocument', 'personorunit']
					};//传入页面的json数据
					iframe.contentWindow.setFormData(data);
				},
				ondestroy : function(action) {//弹出页面关闭前
								...
								.open({
								   showMaxButton : true,
									...
									onload : function() {//弹出页面加载完成
										...
										var data = {
											pageType : "recyclebin",
											urlName : "com.cgn.itmp.knowledgebase.tinexpertinterpretationbiz.queryTInExpertinterpretations.biz.ext",//回收
											entityVal : "com.cgn.itmp.knowledgebase.Regulation.TInExpertinterpretation",
                                 ...
                                 function batchAdd(){
										 ...
										 showMaxButton : true,
							                    ...
							                    onload: function () {//弹出页面加载完成
								                    ...
								                    var data = {
								                    	pageType:"knowledge",
								                    	tempFileName:"expertinterpretation.xlsx",
								                    	tempLoadName :"专家解读新增模板",
								                    	entitfName:"com.cgn.itmp.knowledgebase.Regulation.TInExpertinterpretation"
								                    };//传入页面的json数据
	 ...
	 elemIF.style.display = "none";
											  ...
											  //模糊查询
												...
												if (gjz == "") {
													...
													var data = {
														matchFied : "isdel,papersname,interpreteddocument,personorunit",
														dicFied : "papersname@PAPERSNAME，interpreteddocument@INTERPRETEDDOCUMENT,personorunit@PERSONORUNIT",
														wordVal : $("#cond").val(),
