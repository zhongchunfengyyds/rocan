                ...
                <table id="table1" class="table" style="height:100%">
                    <tr> 
                        <td colspan="1">
                            ...
                            <input class="nui-hidden" id="con_jdid"  name="criteria/_expr[2]/dzid" value=""/>
                 ...
                 <div class="nui-fit">
                <div id="datagrid1" dataField="tcgndgglcxgls" class="nui-datagrid" style="width:100%;height:100%;" url="com.cgn.itmp.outlineandplan.base.ProgramManagement.queryTCgnDgglCxgls.biz.ext" pageSize="20" sizeList="[20,100,1000]" showPageInfo="true" multiSelect="true"  allowSortColumn="true"  sortMode="client">
                    <div property="columns">
                        ...
                        <div field="dzid" headerAlign="center" allowSort="true" visible="false">
                            电站
                        </div>
                        <div  field="jzid"  width="120" headerAlign="center" allowSort="true" renderer="JZRenderer" visible="false">
		机组
						 </div>
                        ...
                        <div field="lx" headerAlign="center" renderer="lxRenderer" allowSort="true" >
                            类型
                        </div>
                        ...
                        <div field="xcsbsj" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd HH:mm:ss" visible="false" >
                           下次升版时间
                        </div>
             ...
             function back(){
               ...
               var rows = grid.getSelecteds();
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tcgndgglcxgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.outlineandplan.base.ProgramManagement.hfDeleteTCgnDgglCxgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.outlineandplan.base.ProgramManagement.deleteTCgnDgglCxgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
