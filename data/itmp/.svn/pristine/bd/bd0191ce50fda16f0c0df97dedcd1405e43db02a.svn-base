            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="bh" headerAlign="center" allowSort="true" >
                            编号
                        </div>
                        <div field="type" renderer="lxRenderer" headerAlign="center" allowSort="true" >
                            类型	
                        </div>
                        <div field="zt" headerAlign="center" allowSort="true" >
                            主题
                        </div>
                        <div field="ly" renderer="lyRenderer" headerAlign="center" allowSort="true" >
                            领域
                        </div>
                        <div field="quarry"  renderer="quarryRenderer" headerAlign="center" allowSort="true" >
                            来源
                        </div>
                        <div field="fj" renderer="setFile" headerAlign="center" allowSort="true" >
                            附件
                        </div>
                        <div field="fkr" headerAlign="center" allowSort="true" >
                            反馈人
                        </div>
                        <div field="rq" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd" >
                            日期
                        </div>
			...
			//恢复
			  function hf(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tqcjsgljyfkhsjgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.EmpiricalFeedback.hfdeleteTQcjsglJyfkhsjgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.groupplant.EmpiricalFeedback.deleteTQcjsglJyfkhsjgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
