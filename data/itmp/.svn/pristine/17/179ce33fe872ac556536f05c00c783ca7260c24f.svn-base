            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div field="sex" headerAlign="center" allowSort="true" renderer="xbRenderer" width="50">
                            性别
                        </div>
                        ...
                        <div field="zzdj" headerAlign="center" allowSort="true" renderer="zzdjRenderer">
                            等级
                        </div>
                        ...
                        <div field="yxq" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd"  renderer="yxqRenderer">
                            有效期至
                        </div>
                        <div field="zmwj" renderer="setFile" headerAlign="center" allowSort="true" >
                            证明文件
                        </div>
                        <div field="zt" headerAlign="center" allowSort="true" renderer="wsztRenderer" visible="false" >
                            状态
                        </div>
            	...
            	if(data.isJdgly){
                    ...
                    function remove(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tdxglzzsqglwsjczzgls:rows});
                                    grid.loading("正在删除中,请稍等...");
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.authorization.NdtQualificationMgt.deleteTDxglZzsqglWsjczzgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({  
                                        url:"com.cgn.itmp.dailyandoverhaul.authorization.NdtQualificationMgt.hfdeleteTDxglZzsqglWsjczzgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
