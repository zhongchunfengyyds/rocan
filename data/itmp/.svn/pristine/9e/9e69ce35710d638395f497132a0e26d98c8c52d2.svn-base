 ...
 * <ul>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.pipelayout.impl.PipeBaseInfoImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link com.cgn.itmp.inspectcomponentmanage.pipelayout.impl.PipeBaseInfoImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements PipeBaseInfo;
 */

public class PipeBaseInfoImpl extends ExtendedDataObjectImpl implements PipeBaseInfo {
	/**
	 * Comment for <code>serialVersionUID</code>
	 */
	private static final long serialVersionUID = 1L;
	public final static int INDEX_UUID = 0;
	public final static int INDEX_MODEL = 1;
	 ...
	 * <!-- end-user-doc -->
	 */
	public PipeBaseInfoImpl(Type type) {
		super(type);
	}
