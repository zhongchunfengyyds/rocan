...
<body>
	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				<td style="width:25%;" class="form_label">大修轮次:</td>
				<td style="width:25%;" colspan="1"><input class="nui-textbox" id="overhaul"
					name="defectsshowdetailedinformation.overhaulsequence" readOnly="readOnly" style="width: 100%" /></td>

				<td style="width:25%;" class="form_label">设备名称:</td>
				<td style="width:25%;" colspan="1"><input id="sbmc"
			...
			<tr>	
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.plate" readOnly="readOnly" style="width: 100%" /></td>
				</tr>
			<tr>
				<td class="form_label">OFFSET</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.offset" readOnly="readOnly" style="width: 100%" /></td>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.length" readOnly="readOnly" style="width: 100%" /></td>
			
				<td class="form_label">Arc</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.arc" readOnly="readOnly" style="width: 100%" /></td>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.volts" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">DEG</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.deg" readOnly="readOnly" style="width: 100%" /></td>
				</tr>	
			<tr>
				<td class="form_label">CHANNEL	</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.channel" readOnly="readOnly" style="width: 100%" /></td>
