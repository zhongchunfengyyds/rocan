                ...
                <div 
                    ...
                    <div property="columns">
                      ...
                      <!--   <div field="jdid" headerAlign="center" allowSort="true" >
                        ...
                        <div field="jzid" headerAlign="center" allowSort="true" >
                            机组
                        </div> -->
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){//tdxgldxglzzgls
                                    var json = nui.encode({tdxgldxglzzgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({//com.cgn.itmp.dailyandoverhaul.overhaul.OrganizationMgt.LogicBackDeleteTDxglDxglZzgls
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.OrganizationMgt.LogicBackDeleteTDxglDxglZzgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.OrganizationMgt.deleteTDxglDxglZzgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
