	...
	<div id="form1" style="padding-top: 5px;">
		...
		<table style="width: 100%; height: 100%; table-layout: fixed;"
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.boltidentificationnumber" readOnly="readOnly" style="width: 100%" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.hdhr" readOnly="readOnly" style="width: 100%" /></td>
				<td class="form_label">深度位置</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.depthposition" readOnly="readOnly" style="width: 100%" /></td>
			</tr>	
			<tr>
				<td class="form_label">周向位置</td>
				<td colspan="1"><input class="nui-textbox"
					name="defectsshowdetailedinformation.circumferentialposition" readOnly="readOnly" style="width: 100%" /></td>
