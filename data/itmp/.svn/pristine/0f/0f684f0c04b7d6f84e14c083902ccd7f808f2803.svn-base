...
<!--             <input class="nui-hidden" name="tdgglentryedit.id"/> -->
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-combobox" dataField="jsonObject" value="<b:write property='entity/crew'/>" id="jz" textField="name" 
                     			 url="com.cgn.itmp.basecommon.DictionaryOperation.getJzDicInfoByjdid.biz.ext?jdid=<b:write property='entity/base'/>"  name="tdgglentryedit.crew"  valueField="id"/>
                    </td>
                    <td class="form_label"  align="center">
                        项目类型:
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input class="nui-textbox"  value="<b:write property='entity/detailed'/>" requiredErrorText="请输入维护项目" name="tdgglentryedit.detailed"/>
                    </td>      
                </tr>
        ...
        <script type="text/javascript">
            ...
            function onOk() {
	            ...
	            var jsondata = nui.encode({"processInstId":data.processInstId,"entityType":"com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulEdit","workItemId":data.workItemId,"data":data.tdgglentryedit,"spyj":data.spyj,"entity":"com.cgn.itmp.outlineandplan.outline.StaturoryDaily.DailyEntity","ident":"规范法定大纲_日常"});
