...
<div id="dataform1" style="padding-top:5px;">
    ...
    <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
        ...
        <tr>
            ...
            <td colspan="1">
                <input class="nui-textbox" onvalidation="hasIllegalChar(e,500,false,true)" name="nextData.bracenumber"/>
            </td>
        </tr>
        <tr>
            <td class="form_label" align="center">
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    ...
    function saveData(finishFirstActivityId) {
        ...
        data.processInstName = "专用检查计划(核岛部件)_大修执行条目_修改支撑支架";
        data.processInstDesc = "专用检查计划(核岛部件)_大修执行条目_修改支撑支架";
        data.processDefName = "com.cgn.itmp.outlineandplan.specialinspection.OverhaulZCZJEdit";
        data.middleEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaulEdit.NuclearIslandEdit";
        data.realEntity = "com.cgn.itmp.outlineandplan.specialinspection.NuclearIslandOverhaul.Support";
