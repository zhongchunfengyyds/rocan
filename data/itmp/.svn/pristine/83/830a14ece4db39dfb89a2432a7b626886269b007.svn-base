...
- Description:
    ...
    <body style="width:98%;height:95%;margin:0 auto;">
          <div id="form1"> 
                ...
                <!-- 数据实体的名称 -->
                <input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.OverhaulRecycle">
                <!-- 排序字段 -->
            ...
            <div class="nui-fit">
                <div 
                    ...
                    <div property="columns">
                        ...
                        <div id="parts" name="parts" field="parts" visible="false" headerAlign="center" allowSort="true" >
                            部件
                        </div>
                        <div field="template" headerAlign="center" visible="false" allowSort="true" visible="false">
                            模板
                        </div>
                        ...
                        <div field="inspectionscope" headerAlign="center" allowSort="true" width="120">
                            检查内容/检查范围
                        </div>
                        <div field="mapno" headerAlign="center" allowSort="true"  width="180">
                            流程图号/参考设备图/等轴图号
                        </div>
                        ...
                        <div field="operatingpressure" headerAlign="center" allowSort="true" width="120">
                            运行压力（Bar）
                        </div>
                        <div field="designpressure" headerAlign="center" allowSort="true"  width="120">
                            设计压力（Bar)
                        </div>
                        <div field="testpressure" headerAlign="center" allowSort="true"  width="120">
                            试验压力（Bar）
                        </div>
                        <div field="site" headerAlign="center" allowSort="true" >
                            试验部位
                        </div>
                        <div field="firsttesttime" headerAlign="center" allowSort="true"  width="120">
                            首次水压试验时间
                        </div>
                        <div field="beforetesttime" headerAlign="center" allowSort="true"  width="120">
                            前次试验日期
                        </div>
                        <div field="nexttesttime" headerAlign="center" allowSort="true"  width="120">
                            下次试验最晚日期
                        </div>
                        ...
                        <div field="edition"  Align="center" headerAlign="center" allowSort="true" >
                           版次
                        </div>
...
function remove(){
    ...
    if(rows.length > 0){
        ...
        function(action){
            if(action=="ok"){
                ...
                $.ajax({
                    url:"com.cgn.itmp.outlineandplan.outline.RecoverMgt.deleteRecoversData.biz.ext",
                    type:'POST',
                    data:jsondata,
                    cache: false,
	...
	function setDel(){
	    ...
	    if(rows.length > 0){
	        ...
	        function(action){
	            if(action=="ok"){
	                var json = {tdgglentrys:rows};
	                grid.loading("正在恢复,请稍等...");
	                var success = true;
	                for(var i = 0;i< json.tdgglentrys.length;i++){
	                	var jsondata = "{'tdgglentry':{'id':'"+json.tdgglentrys[i].uuid+"','isdelete':'0'}}";
	                	$.ajax({
		                    url:"com.cgn.itmp.outlineandplan.outline.StaturoryOverhaul.updateTdgglentry.biz.ext",
		                    type:'POST',
		                    data:jsondata,
		                    cache:false,
		                    contentType:'text/json',
