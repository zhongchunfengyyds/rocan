...
function setFormData(data) {
    ...
    if(data.recyclebinFlag){
    	if(data.recyclebinFlag=="inspe"||data.recyclebinFlag=="weld"){//recyclebinFlag : "inspe",
...
//给grid2增加两个列，一个是结果，一个是备注
    columnsVal.push({field:'deletetime',header:'删除时间', width:100, headerAlign:"center", allowSort:true, dateFormat:"yyyy-MM-dd HH:mm:ss"});
 	
	columnsVal.push({field:'deleteperson',header:'删除人', width:100, headerAlign:"center", allowSort:true});
