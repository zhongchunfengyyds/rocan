            ...
            //恢复
                    function back(){
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({tdxgldxglaqgls:rows});
                                    grid.loading("正在恢复中,请稍等...");
                                    $.ajax({//com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.LogicBackDeleteTDxglDxglAqgls
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.LogicBackDeleteTDxglDxglAqgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    ...
                                    $.ajax({
                                        url:"com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.deleteTDxglDxglAqgls.biz.ext",
                                        type:'POST',
                                        data:json,
                                        cache: false,
                                        contentType:'text/json',
