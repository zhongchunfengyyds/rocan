		...
		<div class="search-container folding-menu" id="queryForm">
			<div style="width: 100%; height: 100%;">
				...
				<div id="form1" class="nui-form display" align="center" style="height: 27px">
					<!-- 数据实体的名称 -->
					<input class="nui-hidden" name="criteria/_entity" value="com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.SecurityMgtSearch">
					<!-- 排序字段 -->
...
<!-- 						<a class="nui-menubutton btn btn-default btn-xs" id="menuButton"  menu="#popupMenu" name="ITMP_btnAdd">新增</a> -->
...
<!-- 						</ul> -->
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="tdxgldxglaqgls" class="nui-datagrid"
				style="width: 100%; height: 100%;"
				url="com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.queryTDxglDxglAqgls.biz.ext"
				...
				<div property="columns">
					...
					<div field="zzlx" width="100" headerAlign="center"
						...
						类型 <input property="editor" class="nui-dictcombobox"
							style="width: 100%;" dictTypeId="DXGL_ANGL" />
					</div>
					...
					<div field="bc" allowResize="false" width="120"
						...
						onvalidation="hasIllegalChar(e,50,true,true)"
							style="width: 100%;" />
					</div>
		  ...
		  function onUploadSuccess(e,row){
           ...
           function setFile(e){
	            var fileRealName = e.record.fileRealName;
	 			var filepath = e.record.file_Path;
           ...
           //点击附件下载
			 ...
			 function output(){
                ...
                nui.open({showMaxButton : true,
                    ...
                    var data = {
                            entityName:"com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.SecurityMgtSearch",
                            queryParam:json,								    //查询数据
                            queryKey:'criteria',                              //查询实体名
                            query:['xh','isdelete','jdid','addtime'],  //按顺序放置
                            filterField:['fileRelativePath','jdid','jzid','orderindex','uuid','isdelete','fj','updtime','upduser','yjjsr','dxlc','fildid','fileId','fileRealName','filePath','fileSize','fileType','fileUploadTime','fileUploadUser','fileNewName'],
                            expTitle:"安全管理",
                            dicFieds : "zzlx@DXGL_ANGL",
                            jdFieds:"jdid",
                        	jzFieds:"jzid",
...
//                     grid.beginEditRow(e.row); 
			...
			function saveData(){
			   ...
			   grid.validateRow(editRow);
	            ...
	            nui.ajax({
	                url: "com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.newAddEdit.biz.ext",
	                type: 'POST',
	                data: json,
			...
			function batchAdd(){
			 nui.open({showMaxButton : true,
                    ...
                    onload: function () {//弹出页面加载完成
	                    ...
	                    var data = {
	                    	pageType:"batchAdd",
	                    	tempFileName:"dxaqglImport.xlsx",
	                    	tempLoadName :"安全管理导入模板",
	                    	entitfName:"com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.SecurityMgt"
	                    };//传入页面的json数据
         ...
         //类型
            function zzlxRenderer(e){
				return nui.getDictText("DXGL_ANGL",e.value);
			}
    		//回收站页面
            function recycle() {
                nui.open({showMaxButton : true,///itmp/dxgcgl/securitycontroller/HuiShouTDxglDxglAqglList.jsp
                    url: "/itmp/overhaul/SecurityMgt/SecurityMgtRecycle.jsp",
                        ...
                        if(rows.length > 0){
                            ...
                            function(action){
                                if(action=="ok"){
                                    var json = nui.encode({
							data : rows,
							entity : "com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.SecurityMgt",token:"<%=TokenUtil.getTokenString(request.getSession())%>"
						});
						
						
						 
                                    grid.loading("正在删除中,请稍等...");
                                    $.ajax({//com.cgn.itmp.dailyandoverhaul.overhaul.SecurityMgt.LogicDeleteTDxglDxglAqgls
