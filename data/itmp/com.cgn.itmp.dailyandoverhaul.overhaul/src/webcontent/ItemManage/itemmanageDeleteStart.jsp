        ...
        <div id="deletefrom" style="padding-top:5px;">
            ...
            <table style="width:100%;height:100%;table-layout:fixed;" class="nui-form-table">
                ...
                <tr style="wdith:100%">
                    ...
                    <td colspan="2">
                        <input class="nui-textbox" style="wdith:100%" enabled="false"  name="delete_entity.deleteuser" value="<%=username %>"/>
                    </td>
                       <td class="form_label">
                        删除日期:
                    </td>
                    <td colspan="2" >
                        <input class="nui-textbox" wdith="100" enabled="false" name="delete_entity.deletedate" value="<%=dataTime %>"/>
                    </td>
				...
				<td class="form_label" style="width: 10%">校核人员</td>
				 <td colspan="5">
                        <input  class="nui-buttonedit" readonly="readonly" onclick="onButtonSelectPerson"  required="true" id="jhry"  name="jhry"  textField="empname" style="width:50%" url=""  required="true" requiredErrorText="请选择校核人员"  valueField="empid"/>
                    </td>
<!-- 				<td colspan="5"> -->
...
//  	nui.get('jhry').load(encodeURI("com.cgn.components.coframe.RoleService.getEmpListByRoleInfo.biz.ext?roleCode=ITMP_SPRY_" +  getCookie('jdname')));
    				...
    				//发起删除流程
    				  function onOk(){
			                ...
			                //保存
			                var urlStr = "com.cgn.itmp.dailyandoverhaul.overhaul.ItemManage.deletework.biz.ext";
			                form.validate();
		...
		function updateprocessStatus(){
			...
			for(var i=0;i<datas.length;i++){
				list.push({uuid:datas[i].uuid,processStatus:"2"});
			}
