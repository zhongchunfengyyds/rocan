...
<table align="center" border="0" width="100%" class="form_table">
    <tr>
        <!--<td><label>附件:</label>
         <input type="file" id="fileName" name="file" multiple onchange="uploadFile(event,id)" /> 
            <input class="nui-hidden" id="fpath" name="filepath"/> <input class="nui-hidden" id="fname"
                                                                          name="filename"/>-->
          <label>附件:</label> 
						...
						<div style="display: flex;">	
							<input id="fname" class="nui-textbox" name= "filename" style="width: 100%" readonly="readonly" name="" requiredErrorText="附件不能为空"  required="true" />
							<input id="fpath" style="display: none" class="nui-textbox" name="filepath" />
							<form id="uploadform" enctype="multipart/form-data">
								<input style="width:70px" type="file" name="file" id="selectInput" accept="*" onchange="fileSub1(this)"> 
							</form>
						</div> 
        </td>
    </tr>
    <tr>
        <td align="left">
            ...
            <span style="color:red;font-size:10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、压缩文件中不可存在文件夹，否则将会导致附件解析失败</span><br/>
