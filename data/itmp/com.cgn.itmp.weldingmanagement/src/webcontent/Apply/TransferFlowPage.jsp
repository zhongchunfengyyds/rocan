...
<%
 ...
 response.sendRedirect(request.getContextPath() + "/com.cgn.itmp.weldingmanagement.Weldingapply.impl.WeldingPlanTransferFlow.flow?processInstId="+processInstId
