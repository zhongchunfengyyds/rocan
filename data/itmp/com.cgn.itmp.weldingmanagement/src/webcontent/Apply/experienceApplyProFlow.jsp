...
<input class="nui-hidden" name="actInstId" id="actInstId" value="<b:write property='actInstId'/>"/>
...
<%
 ...
 String actInstId = request.getParameter("actInstId"); //流程ID字段
 response.sendRedirect(request.getContextPath() + "/com.cgn.itmp.dailyandoverhaul.overhaul.itemmanagetz.flow?processInstId="+processInstId
