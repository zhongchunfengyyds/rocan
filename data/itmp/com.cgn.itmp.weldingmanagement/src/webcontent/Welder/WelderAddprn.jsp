...
<!--                         textField="name" onvalidation="onCheck" style="width:100%;" readonly="readonly" dataField="jsonObject" id="jd" valueField="id" onvaluechanged="reloadJz" /> -->
<!--                     </td> -->
<!--                      <td class="form_label"> -->
...
<!--                     </tr> -->
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.name"  readOnly="readOnly"   required="true" requiredErrorText="姓名不能为空" emptyText="请输入姓名" onvalidation="onCheck" style="width:100%"/>
                        </td>
                        <td class="form_label">
                            所属公司:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.company" readOnly="readOnly"   required="true" requiredErrorText="所属公司不能为空" emptyText="请输入所属公司" onvalidation="onCheck" style="width:100%"/>
                        </td>
                        <td class="form_label">
                            员工号:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.empnumber" readOnly="readOnly"   required="true" requiredErrorText="员工号不能为空" emptyText="请输入员工号" onvalidation="onCheck" style="width:100%"/>
                        </td>
                    </tr>
                     <tr>
                    ...
                    <td colspan="1">                        
                       <input class="nui-textbox" name="welder.code" required="true"  readOnly="readOnly"  requiredErrorText="焊工代码不能为空" emptyText="请输入焊工代码" onvalidation="onCheck" style="width:100%"/>
                    </td>
                    <td class="form_label">
                            特种作业名称:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.special" value="焊接"  readOnly="readOnly"  required="true" requiredErrorText="特种作业名称不能为空" emptyText="请输入特种作业名称" onvalidation="onCheck" style="width:100%"/>
                        </td>
                        <td class="form_label">
                            作业类别:
                        </td>
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.job" value="焊接与热切割作业" readOnly="readOnly"   required="true" requiredErrorText="作业类别不能为空" emptyText="请输入作业类别" onvalidation="onCheck" style="width:100%"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.authority" required="true" readOnly="readOnly"   requiredErrorText="发证机关不能为空" emptyText="请输入发证机关" onvalidation="onCheck" style="width:100%"/>
                        </td>
                         <td class="form_label">
                            操作项目:
                        </td>
                        ...
                        <td colspan="1">
                    <input  name="welder.items" class="nui-dictcombobox"   dictTypeId="CZXM" readOnly="readOnly"   required="true" requiredErrorText="操作项目不能为空" emptyText="请选择操作项目" style="width:100%;" />
	    	   		</td>
                        ...
                        <td colspan="1">
                            <input class="nui-textbox" name="welder.operatingnumber" required="true" readOnly="readOnly"   requiredErrorText="操作证编号不能为空" emptyText="请输入操作证编号" id="welder_operatingnumber" onvalidation="onCheck" style="width:100%"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="1">
                        <input property="editor" class="nui-datepicker" required="true"  readOnly="readOnly"  
...
<!--                             <input class="nui-textbox" name="welder.validity"/> -->
                        ...
                        <td colspan="1">
                        <input class="nui-textbox"  readOnly="readOnly"   style="width:100%" required="true" requiredErrorText="复审日期不能为空" emptyText="请输入复审日期" name="welder.review"/>
                        ...
                        <input property="editor" class="nui-datepicker"
							 onvalidation="onCheck" style="width:100%" id="Initial" required="true" showClose="true"
									oncloseclick="this.setValue(null);" allowInput="false"  requiredErrorText="初领日期不能为空"  emptyText="请输入初领日期"
							 name="welder.initial" readOnly="readOnly"  />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <input class="nui-dictcombobox" readOnly="readOnly"   onclike="zt()" required="true" requiredErrorText="状态不能为空" emptyText="请输入姓名" dictTypeId="WSZT" name="welder.status" id="status" onvalidation="onCheck" style="width:100%"/>
                        </td>
                        <td class="form_label">
                            附件:
                        </td>
                   ...
                   <td colspan="1" id="fileNoHref">
                  		<div style="display: flex;">
							<input class="nui-textbox" style="width:100%"  id="zfj" name="welder.fj" />
                        ...
                        <td colspan="1">
                            <input class="nui-textbox"  readOnly="readOnly"  name="welder.remarks" style="width:100%;height:100%;"/>
                        </td>
                    </tr>
                    ...
                    <div 
                        ...
                        <div property="columns">
                           ...
                           <div field="cernumber" allowSort="false" align="center" width="50px;" headerAlign="center"  >
                                证书编号
                                <input class="nui-textbox" enabled="true" name="cernumber" property="editor" required="false" visible="true" onvalidation="onCheck" style="width:50%"/>
                            </div>
                            <div field="projcode" allowSort=""false""  width="200px;" align="left" headerAlign="center" >
                                项目代号
                                <input class="nui-textbox" enabled="true" name="projcode" property="editor" required="false" visible="true" onvalidation="onCheck" style="width:100%"/>
                            </div>
                            <div field="validdate"  allowSort="false" align="center" headerAlign="center" width="" dateFormat="yyyy-MM-dd">
                                有效时间 			<input property="editor" onvaluechanged="yxrq" class="nui-datepicker"
									...
									oncloseclick="this.setValue(null);" allowInput="false"  requiredErrorText="有效日期不能为空"
									   name="validdate"   onvalidation="onCheck" style="width:100%"/>
<!--                                 <input class="nui-textbox" enabled="true" name="validdate" property="editor" required="false" visible="true"/> -->
                            ...
                            <div field="office" allowSort="false" align="center" headerAlign="center" width="">
                                发证机关
                                <input class="nui-textbox" enabled="true" name="office" property="editor" required="false" visible="true" onvalidation="onCheck" style="width:100%"/>
                            </div>
            	   ...
            	   $.ajax({
                    ...
                    function setFormData(data){
                        ...
                        if (infos.pageType == "edit") {
                            ...
                            form.setChanged(false);
                            nui.get("grid_0").load({welder:data},function(e){
                            	nui.get("grid_0").sortBy("orderno","desc");
						    });
                            $.ajax({
                                url:"com.cgn.itmp.weldingmanagement.welderbiz.getWelder.biz.ext",
                                type:'POST',
                   ...
                   function fileSub(file){
   					...
   					success : function(data) {
   						...
   						if (data.code == 1) {
   							...
   							nui.get("zfj").setValue(data.list[0].uri);
